...
food:
  id: food:tw:menu:dailydietitian:9b0c2ccd972a9aba4380
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 無敵豬肉滿福堡加蛋
  aliases:
    ...
    - 麥當勞 無敵豬肉滿福堡加蛋
revision:
  revision_id: dailydietitian-2026-08-03-9b0c2ccd972a
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 512.79
...
extraction:
  ...
  candidate_id: dd:9b0c2ccd972a9aba4380
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:mega-mcmuffin
  existing_title: 麥當勞 無敵豬肉滿福堡加蛋
  existing_file_path: knowledge/menu-items/mcdonalds/mega-mcmuffin.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 512.79
        official_value: 512.79
        delta: 0
        tolerance: 5.1278999999999995
      - &a2
        field: protein_g
        candidate_value: 30
        official_value: 30
      ...
      - &a8
        field: sodium_mg
        candidate_value: 916.9
        official_value: 916.9
        delta: 0
        tolerance: 18.338
    matched:
      - *a1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 無敵豬肉滿福堡加蛋 | 82 | 512.79 | 30 | 30 | 13 | 0.2 | 31 | 1.9 | 916.9 |
