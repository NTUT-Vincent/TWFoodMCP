...
food:
  id: food:tw:menu:dailydietitian:2e1341159d3389e9e622
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 麥香魚
  aliases:
    ...
    - 麥當勞 麥香魚
revision:
  revision_id: dailydietitian-2026-08-03-2e1341159d33
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 342.92
...
extraction:
  ...
  candidate_id: dd:2e1341159d3389e9e622
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:filet-o-fish
  existing_title: 麥當勞 麥香魚®
  existing_file_path: knowledge/menu-items/mcdonalds/filet-o-fish.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 342.92
        official_value: 342.92
        delta: 0
        tolerance: 3.4292000000000002
      - &a2
        field: protein_g
        candidate_value: 15
        official_value: 15
      ...
      - &a8
        field: sodium_mg
        candidate_value: 602.5
        official_value: 602.5
        delta: 0
        tolerance: 12.05
    matched:
      - *a1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 麥香魚 | 60 | 342.92 | 15 | 15 | 3.2 | 0.1 | 36 | 4.3 | 602.5 |
