...
food:
  id: food:tw:menu:dailydietitian:d85c1b52a689c8947c1b
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 經典那堤(熱)
  aliases:
    ...
    - 麥當勞 經典那堤(熱)
revision:
  revision_id: dailydietitian-2026-08-02-d85c1b52a689
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 123.48
...
extraction:
  ...
  candidate_id: dd:d85c1b52a689c8947c1b
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:latte
  existing_title: 麥當勞 經典那堤(熱)
  existing_file_path: knowledge/menu-items/mcdonalds/latte.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 123.48
        official_value: 123.48
        delta: 0
        tolerance: 1.2348000000000001
      - &a2
        field: protein_g
        candidate_value: 6.4
        official_value: 6.4
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 經典那堤(熱) | 78 | 123.48 | 6.4 | 6.5 | 3.9 | 0.1 | 9.9 | 8.1 | 66.2 |
