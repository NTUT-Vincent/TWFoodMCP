...
food:
  id: food:tw:menu:dailydietitian:477d347c35cccd22d03a
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 金選美式咖啡(熱)
  aliases:
    ...
    - 麥當勞 金選美式咖啡(熱)
revision:
  revision_id: dailydietitian-2026-08-02-477d347c35cc
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 15.01
...
extraction:
  ...
  candidate_id: dd:477d347c35cccd22d03a
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:200332
  existing_title: 麥當勞 金選美式咖啡(熱)
  existing_file_path: knowledge/menu-items/mcdonalds/200332.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 金選美式咖啡(熱) | 60 | 15.01 | 0.9 | 0.3 | 0.1 | 0 | 2.2 | 0 | 1.3 |
