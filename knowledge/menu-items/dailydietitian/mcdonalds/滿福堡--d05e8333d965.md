...
food:
  id: food:tw:menu:dailydietitian:d05e8333d965c71bddbe
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 滿福堡
  aliases:
    ...
    - 麥當勞 滿福堡
revision:
  revision_id: dailydietitian-2026-08-02-d05e8333d965
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 286.37
...
extraction:
  ...
  candidate_id: dd:d05e8333d965c71bddbe
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:egg-mcmuffin
  existing_title: 麥當勞 滿福堡
  existing_file_path: knowledge/menu-items/mcdonalds/egg-mcmuffin.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 286.37
        official_value: 286.37
        delta: 0
        tolerance: 2.8637
      - &a2
        field: protein_g
      ...
      - &a8
        field: sodium_mg
        candidate_value: 689.8
        official_value: 689.8
        delta: 0
        tolerance: 13.796
    matched:
      - *a1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 滿福堡 | 54 | 286.37 | 17 | 11 | 5.5 | 0.2 | 30 | 2.2 | 689.8 |
