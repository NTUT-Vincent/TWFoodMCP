...
food:
  id: food:tw:menu:dailydietitian:b02929d826c683d63fb3
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 金選美式咖啡(冰)
  aliases:
    ...
    - 麥當勞 金選美式咖啡(冰)
revision:
  revision_id: dailydietitian-2026-08-02-b02929d826c6
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 20.16
...
extraction:
  ...
  candidate_id: dd:b02929d826c683d63fb3
...
official_review_hint:
  ...
  existing_file_path: knowledge/menu-items/mcdonalds/200334.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 金選美式咖啡(冰) | 60 | 20.16 | 1.2 | 0.4 | 0.1 | 0 | 2.9 | 0 | 1.7 |
