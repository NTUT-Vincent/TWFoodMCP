...
food:
  id: food:tw:menu:dailydietitian:1cfe33d16efb03ca28c3
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 可口可樂 zero (M)
  aliases:
    ...
    - 麥當勞 可口可樂 zero (M)
revision:
  revision_id: dailydietitian-2026-08-03-1cfe33d16efb
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 0
...
extraction:
  ...
  candidate_id: dd:1cfe33d16efb03ca28c3
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:coke-zero
  existing_title: 麥當勞 可口可樂zero
  existing_file_path: knowledge/menu-items/mcdonalds/coke-zero.md
  comparison:
    corroborated: false
    compared:
      - &a1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 可口可樂 zero (M) | 38 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 52 |
