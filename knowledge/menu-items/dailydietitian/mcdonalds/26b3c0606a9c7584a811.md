...
food:
  id: food:tw:menu:dailydietitian:26b3c0606a9c7584a811
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 金選那堤(冰)
  aliases:
    ...
    - 麥當勞 金選那堤(冰)
revision:
  revision_id: dailydietitian-2026-08-02-26b3c0606a9c
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 117.48
...
extraction:
  ...
  candidate_id: dd:26b3c0606a9c7584a811
...
official_review_hint:
  ...
  existing_file_path: knowledge/menu-items/mcdonalds/200335.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 金選那堤(冰) | 87 | 117.48 | 6.1 | 6.1 | 3.7 | 0.1 | 9.5 | 7.6 | 62.4 |
