...
food:
  id: food:tw:menu:dailydietitian:23af44e32b1dfbb570dc
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 紅茶 (熱)
  aliases:
    ...
    - 麥當勞 紅茶 (熱)
revision:
  revision_id: dailydietitian-2026-08-02-23af44e32b1d
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 0
...
extraction:
  ...
  candidate_id: dd:23af44e32b1dfbb570dc
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:hot-black-tea
  existing_title: 麥當勞 紅茶(熱)
  existing_file_path: knowledge/menu-items/mcdonalds/hot-black-tea.md
  comparison:
    corroborated: true
    compared:
      - &a1
