...
food:
  id: food:tw:menu:dailydietitian:fd43e3f4e3ac6815b5cb
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 可口可樂 (M)
  aliases:
    ...
    - 麥當勞 可口可樂 (M)
revision:
  revision_id: dailydietitian-2026-08-03-fd43e3f4e3ac
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 210.3
...
extraction:
  ...
  candidate_id: dd:fd43e3f4e3ac6815b5cb
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:coke
  existing_title: 麥當勞 可口可樂
  existing_file_path: knowledge/menu-items/mcdonalds/coke.md
  comparison:
    corroborated: false
    compared:
      - &a6
        field: energy_kcal
        candidate_value: 210.3
        official_value: 157.94
        delta: 52.360000000000014
        tolerance: 1.5794
      - &a1
        field: protein_g
        candidate_value: 0
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 可口可樂 (M) | 38 | 210.3 | 0 | 0 | 0 | 0 | 53 | 53 | 9.9 |
