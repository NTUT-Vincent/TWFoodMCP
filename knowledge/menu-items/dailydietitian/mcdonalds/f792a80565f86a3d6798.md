...
food:
  id: food:tw:menu:dailydietitian:f792a80565f86a3d6798
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 原味可頌
  aliases:
    ...
    - 麥當勞 原味可頌
revision:
  revision_id: dailydietitian-2026-08-02-f792a80565f8
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 255.99
...
extraction:
  ...
  candidate_id: dd:f792a80565f86a3d6798
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:croissant
  existing_title: 麥當勞 原味可頌
  existing_file_path: knowledge/menu-items/mcdonalds/croissant.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 255.99
        official_value: 255.99
        delta: 0
        tolerance: 2.5599000000000003
      - &a2
        field: protein_g
        candidate_value: 4.8
        official_value: 4.8
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 原味可頌 | 50 | 255.99 | 4.8 | 13 | 9 | 0 | 30 | 4.6 | 273.2 |
