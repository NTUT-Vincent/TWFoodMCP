...
food:
  id: food:tw:menu:dailydietitian:f03382cced09b2474493
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 現烤焙果
  aliases:
    ...
    - 麥當勞 現烤焙果
revision:
  revision_id: dailydietitian-2026-08-02-f03382cced09
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 248.89
...
extraction:
  ...
  candidate_id: dd:f03382cced09b2474493
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:plain-bagel
  existing_title: 麥當勞 現烤焙果
  existing_file_path: knowledge/menu-items/mcdonalds/plain-bagel.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 248.89
        official_value: 248.89
        delta: 0
        tolerance: 2.4889
      - &a2
        field: protein_g
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 現烤焙果 | 59 | 248.89 | 7.9 | 1.2 | 0.4 | 0 | 52 | 5.9 | 402 |
