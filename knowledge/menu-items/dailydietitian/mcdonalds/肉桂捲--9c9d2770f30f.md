...
food:
  id: food:tw:menu:dailydietitian:9c9d2770f30f395dea0b
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 肉桂捲
  aliases:
    ...
    - 麥當勞 肉桂捲
revision:
  revision_id: dailydietitian-2026-08-03-9c9d2770f30f
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 350
...
extraction:
  ...
  candidate_id: dd:9c9d2770f30f395dea0b
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:cinnamon-swirl
  existing_title: 麥當勞 肉桂捲
  existing_file_path: knowledge/menu-items/mcdonalds/cinnamon-swirl.md
  comparison:
    corroborated: true
    compared:
      - &a1
      ...
      - &a8
        field: sodium_mg
        candidate_value: 328.5
        official_value: 328.5
        delta: 0
        tolerance: 6.57
    matched:
      - *a1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 肉桂捲 | 50 | 350 | 5.5 | 19 | 13 | 0.2 | 41 | 14 | 328.5 |
