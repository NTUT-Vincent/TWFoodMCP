...
food:
  id: food:tw:menu:dailydietitian:67a7121a3cd3fbddd261
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 義式濃縮咖啡(熱)
  aliases:
    ...
    - 麥當勞 義式濃縮咖啡(熱)
revision:
  revision_id: dailydietitian-2026-08-02-67a7121a3cd3
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 6.26
...
extraction:
  ...
  candidate_id: dd:67a7121a3cd3fbddd261
...
official_review_hint:
  ...
  existing_file_path: knowledge/menu-items/mcdonalds/espresso.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 義式濃縮咖啡(熱) | 56 | 6.26 | 0.4 | 0.1 | 0 | 0 | 0.9 | 0 | 0.54 |
