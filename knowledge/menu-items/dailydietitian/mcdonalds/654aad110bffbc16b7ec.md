...
food:
  id: food:tw:menu:dailydietitian:654aad110bffbc16b7ec
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 蜂蜜奶茶(冰)
  aliases:
    ...
    - 麥當勞 蜂蜜奶茶(冰)
revision:
  revision_id: dailydietitian-2026-08-02-654aad110bff
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 212.46
...
extraction:
  ...
  candidate_id: dd:654aad110bffbc16b7ec
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:honey-milk-tea-iced
  existing_title: 麥當勞 蜂蜜奶茶(冰)
  existing_file_path: knowledge/menu-items/mcdonalds/honey-milk-tea-iced.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 212.46
        official_value: 212.46
        delta: 0
        tolerance: 2.1246
      - &a2
        field: protein_g
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 蜂蜜奶茶(冰) | 59 | 212.46 | 2.6 | 4.7 | 3.2 | 0.1 | 39 | 36 | 44.4 |
