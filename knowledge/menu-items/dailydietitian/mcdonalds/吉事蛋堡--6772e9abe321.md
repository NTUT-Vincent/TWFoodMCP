...
food:
  id: food:tw:menu:dailydietitian:6772e9abe321372f2298
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 吉事蛋堡
  aliases:
    ...
    - 麥當勞 吉事蛋堡
revision:
  revision_id: dailydietitian-2026-08-02-6772e9abe321
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 281.34
...
extraction:
  ...
  candidate_id: dd:6772e9abe321372f2298
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:egg-burger
  existing_title: 麥當勞 吉事蛋堡
  existing_file_path: knowledge/menu-items/mcdonalds/egg-burger.md
  comparison:
    corroborated: false
    compared:
      - &a3
        field: energy_kcal
        candidate_value: 281.34
        official_value: 305.19
        delta: 23.850000000000023
        tolerance: 3.0519
      - &a1
        field: protein_g
        candidate_value: 12
      ...
      - &a8
        field: sodium_mg
        candidate_value: 487.4
        official_value: 538.6
        delta: 51.200000000000045
        tolerance: 10.772
    matched:
      - *a1
      - *a2
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 吉事蛋堡 | 38 | 281.34 | 12 | 12 | 3.6 | 0.1 | 30 | 5.8 | 487.4 |
