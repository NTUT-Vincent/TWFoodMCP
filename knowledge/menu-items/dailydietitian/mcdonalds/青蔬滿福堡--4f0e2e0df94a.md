...
food:
  id: food:tw:menu:dailydietitian:4f0e2e0df94a79cf6d66
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 青蔬滿福堡
  aliases:
    ...
    - 麥當勞 青蔬滿福堡
revision:
  revision_id: dailydietitian-2026-08-03-4f0e2e0df94a
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 288.07
...
extraction:
  ...
  candidate_id: dd:4f0e2e0df94a79cf6d66
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:muffin-with-vegetables
  existing_title: 麥當勞 青蔬滿福堡
  existing_file_path: knowledge/menu-items/mcdonalds/muffin-with-vegetables.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 288.07
        official_value: 288.07
        delta: 0
        tolerance: 2.8807
      - &a2
        field: protein_g
      ...
      - &a8
        field: sodium_mg
        candidate_value: 690.8
        official_value: 690.8
        delta: 0
        tolerance: 13.815999999999999
    matched:
      - *a1
      - *a2
      - *a3
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 青蔬滿福堡 | 60 | 288.07 | 17 | 11 | 5.5 | 0.2 | 30 | 2.4 | 690.8 |
