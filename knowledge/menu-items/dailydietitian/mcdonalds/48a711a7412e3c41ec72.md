...
food:
  id: food:tw:menu:dailydietitian:48a711a7412e3c41ec72
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 薯餅
  aliases:
    ...
    - 麥當勞 薯餅
revision:
  revision_id: dailydietitian-2026-08-02-48a711a7412e
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 168.49
...
extraction:
  ...
  candidate_id: dd:48a711a7412e3c41ec72
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:hash-browns
  existing_title: 麥當勞 薯餅
  existing_file_path: knowledge/menu-items/mcdonalds/hash-browns.md
  comparison:
    corroborated: false
    compared:
      - &a3
        field: energy_kcal
        candidate_value: 168.49
        official_value: 177.42
        delta: 8.929999999999978
        tolerance: 1.7742
      - &a4
        field: protein_g
        candidate_value: 1.5
      ...
      - &a8
        field: sodium_mg
        candidate_value: 264.3
        official_value: 320.2
        delta: 55.89999999999998
        tolerance: 6.404
    matched:
      - *a1
      - *a2
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 薯餅 | 50 | 168.49 | 1.5 | 11 | 1.6 | 0 | 15 | 0 | 264.3 |
