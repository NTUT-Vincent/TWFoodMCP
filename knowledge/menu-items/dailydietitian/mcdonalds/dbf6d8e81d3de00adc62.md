...
food:
  id: food:tw:menu:dailydietitian:dbf6d8e81d3de00adc62
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 可口可樂 zero (S)
  aliases:
    ...
    - 麥當勞 可口可樂 zero (S)
revision:
  revision_id: dailydietitian-2026-08-02-dbf6d8e81d3d
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 0
...
extraction:
  ...
  candidate_id: dd:dbf6d8e81d3de00adc62
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 可口可樂 zero (S) | – | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 39.1 |
