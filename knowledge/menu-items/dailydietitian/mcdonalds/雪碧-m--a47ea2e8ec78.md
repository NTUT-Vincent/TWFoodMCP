...
food:
  id: food:tw:menu:dailydietitian:a47ea2e8ec787add3fe9
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 雪碧 (M)
  aliases:
    ...
    - 麥當勞 雪碧 (M)
revision:
  revision_id: dailydietitian-2026-08-02-a47ea2e8ec78
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 170.8
...
extraction:
  ...
  candidate_id: dd:a47ea2e8ec787add3fe9
...
official_review_hint:
  ...
  comparison:
    ...
    compared:
      ...
      - &a8
        field: sodium_mg
        candidate_value: 54.6
        official_value: 41
        delta: 13.600000000000001
        tolerance: 5
    matched:
      - *a1
      - *a2
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 雪碧 (M) | 38 | 170.8 | 0 | 0 | 0 | 0 | 43 | 43 | 54.6 |
