...
food:
  id: food:tw:menu:dailydietitian:3dd987ebbdc44842474f
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 經典美式咖啡(冰)
  aliases:
    ...
    - 麥當勞 經典美式咖啡(冰)
revision:
  revision_id: dailydietitian-2026-08-02-3dd987ebbdc4
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 20.16
...
extraction:
  ...
  candidate_id: dd:3dd987ebbdc44842474f
...
official_review_hint:
  ...
  existing_file_path: knowledge/menu-items/mcdonalds/iced-americano.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 經典美式咖啡(冰) | 65 | 20.16 | 1.2 | 0.4 | 0.1 | 0 | 2.9 | 0 | 1.7 |
