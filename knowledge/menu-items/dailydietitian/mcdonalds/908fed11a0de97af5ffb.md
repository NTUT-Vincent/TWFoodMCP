...
food:
  id: food:tw:menu:dailydietitian:908fed11a0de97af5ffb
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 經典卡布奇諾(熱)
  aliases:
    ...
    - 麥當勞 經典卡布奇諾(熱)
revision:
  revision_id: dailydietitian-2026-08-02-908fed11a0de
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 148.25
...
extraction:
  ...
  candidate_id: dd:908fed11a0de97af5ffb
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:cappuccino
  existing_title: 麥當勞 經典卡布奇諾(熱)
  existing_file_path: knowledge/menu-items/mcdonalds/cappuccino.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 148.25
        official_value: 148.25
        delta: 0
        tolerance: 1.4825
      - &a2
        field: protein_g
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 經典卡布奇諾(熱) | 56 | 148.25 | 7.6 | 7.9 | 4.8 | 0.1 | 12 | 9.9 | 80.6 |
