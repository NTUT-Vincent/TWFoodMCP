...
food:
  id: food:tw:menu:dailydietitian:81b06111a399333b3490
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 巧克力榛果可頌
  aliases:
    ...
    - 麥當勞 巧克力榛果可頌
revision:
  revision_id: dailydietitian-2026-08-02-81b06111a399
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 264.12
...
extraction:
  ...
  candidate_id: dd:81b06111a399333b3490
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:croissant-chocolate
  existing_title: 麥當勞 巧克力榛果可頌
  existing_file_path: knowledge/menu-items/mcdonalds/croissant-chocolate.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 264.12
        official_value: 264.12
        delta: 0
        tolerance: 2.6412
      - &a2
        field: protein_g
      ...
      - &a8
        field: sodium_mg
        candidate_value: 215.8
        official_value: 215.8
        delta: 0
        tolerance: 5
    matched:
      - *a1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 巧克力榛果可頌 | 50 | 264.12 | 4.3 | 14 | 7.4 | 0 | 31 | 11 | 215.8 |
