...
food:
  id: food:tw:menu:dailydietitian:03b70ea68a4649e8b26c
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 經典那堤(冰)
  aliases:
    ...
    - 麥當勞 經典那堤(冰)
revision:
  revision_id: dailydietitian-2026-08-03-03b70ea68a46
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 117.45
...
extraction:
  ...
  candidate_id: dd:03b70ea68a4649e8b26c
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:iced-latte
  existing_title: 麥當勞 經典那堤(冰)
  existing_file_path: knowledge/menu-items/mcdonalds/iced-latte.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 117.45
        official_value: 117.45
        delta: 0
        tolerance: 1.1745
      - &a2
        field: protein_g
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 經典那堤(冰) | 78 | 117.45 | 6.1 | 6.1 | 3.7 | 0.1 | 9.5 | 7.6 | 62.4 |
