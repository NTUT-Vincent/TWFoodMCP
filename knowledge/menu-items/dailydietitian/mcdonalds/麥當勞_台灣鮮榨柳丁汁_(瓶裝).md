...
food:
  id: food:tw:menu:dailydietitian:3437d8f6bcf533af21e6
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 台灣鮮榨柳丁汁 (瓶裝)
  aliases:
    ...
    - 麥當勞 台灣鮮榨柳丁汁 (瓶裝)
revision:
  revision_id: dailydietitian-2026-08-02-3437d8f6bcf5
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 118.72
...
extraction:
  ...
  candidate_id: dd:3437d8f6bcf533af21e6
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:taiwan-fresh-orange-juice
  existing_title: 麥當勞 台灣鮮榨柳丁汁(瓶裝)
  existing_file_path: knowledge/menu-items/mcdonalds/taiwan-fresh-orange-juice.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 118.72
        official_value: 118.72
        delta: 0
        tolerance: 1.1872
      - &a2
        field: protein_g
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 台灣鮮榨柳丁汁 (瓶裝) | 69 | 118.72 | 2.1 | 0 | 0 | 0 | 28 | 25 | 3.7 |
