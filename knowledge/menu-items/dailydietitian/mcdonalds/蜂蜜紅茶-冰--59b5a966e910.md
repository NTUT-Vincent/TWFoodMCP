...
food:
  id: food:tw:menu:dailydietitian:59b5a966e9105bc6d1ac
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 蜂蜜紅茶(冰)
  aliases:
    ...
    - 麥當勞 蜂蜜紅茶(冰)
revision:
  revision_id: dailydietitian-2026-08-02-59b5a966e910
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 138.39
...
extraction:
  ...
  candidate_id: dd:59b5a966e9105bc6d1ac
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:honey-black-tea-iced
  existing_title: 麥當勞 蜂蜜紅茶(冰)
  existing_file_path: knowledge/menu-items/mcdonalds/honey-black-tea-iced.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 138.39
        official_value: 138.39
        delta: 0
        tolerance: 1.3839
      - &a2
        field: protein_g
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 蜂蜜紅茶(冰) | 59 | 138.39 | 0 | 0 | 0 | 0 | 34 | 31 | 9.1 |
