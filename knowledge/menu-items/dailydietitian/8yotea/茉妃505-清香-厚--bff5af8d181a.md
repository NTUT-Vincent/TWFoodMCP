...
sources:
  - id: dailydietitian-41d5a663c3d7
    resource: https://dailydietitian.com.tw/%e5%85%ab%e6%9b%9c%e5%92%8c%e8%8c%b6%e8%8f%9c%e5%96%ae-%e7%86%b1%e9%87%8f-%e5%83%b9%e6%a0%bc-%e7%b3%96%e9%87%8f/
    title: 2026 最新》八曜和茶菜單：熱量、價格、糖量＋營養師點餐建議
...
food:
  id: food:tw:menu:dailydietitian:bff5af8d181a6886c799
  kind: menu_item
  market: TW
  brand: 八曜和茶
  name: |-
  ...
  aliases:
    ...
    - |-
      ...
      (清香/厚)
revision:
  revision_id: dailydietitian-2026-08-02-bff5af8d181a
nutrition:
  - basis: per_serving
    values:
      sugar_g: 41
...
extraction:
  ...
  candidate_id: dd:bff5af8d181a6886c799
...
此文件逐列保存日日營養文章中的食品名稱與營養表格數值。[^dailydietitian-41d5a663c3d7] 它是未驗證 draft，不代表官方標示或 TWFoodMCP 的正式判定。

# Source Row

| 飲品名稱 | 價格 (NT$) | 總糖量 (g) | 總熱量 (kcal) |
| --- | --- | --- | --- |
| 茉妃505<br>(清香/厚) | 40 | 41 / 42 | 191 / 197 |

# Review Required

升為 stable 前，真人 reviewer 必須確認精確產品、規格、份量基準、營養欄位、文章版本及可追溯證據。此 draft 的 `quality.calculation_allowed` 固定為 `false`。

[^dailydietitian-41d5a663c3d7]: 2026 最新》八曜和茶菜單：熱量、價格、糖量＋營養師點餐建議
