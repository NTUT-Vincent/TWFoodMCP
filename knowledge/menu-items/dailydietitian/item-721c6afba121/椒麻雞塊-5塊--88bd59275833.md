...
food:
  id: food:tw:menu:dailydietitian:88bd5927583366a60e4b
  kind: menu_item
  market: TW
  brand: 麥味登熱量表單
  name: 椒麻雞塊(5塊)
  aliases:
    ...
    - 麥味登熱量表單 椒麻雞塊(5塊)
revision:
  revision_id: dailydietitian-2026-08-02-88bd59275833
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 270
...
extraction:
  ...
  candidate_id: dd:88bd5927583366a60e4b
