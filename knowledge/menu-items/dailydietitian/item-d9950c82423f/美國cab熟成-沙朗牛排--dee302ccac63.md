...
food:
  id: food:tw:menu:dailydietitian:dee302ccac63e787c02c
  kind: menu_item
  market: TW
  brand: 我家牛排最新菜單
  name: |-
  ...
  aliases:
    ...
    - |-
      ...
      沙朗牛排
revision:
  revision_id: dailydietitian-2026-08-03-dee302ccac63
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 550
...
extraction:
  ...
  candidate_id: dd:dee302ccac63e787c02c
...
| 品項<br>名稱 | 重量<br>(Oz/盎司) | 價格<br>(NT$) | 熱量預估 (kcal)<br>純肉估算<br>*不含醬料與配餐 | 蛋白質<br>推估 (g) |
| --- | --- | --- | --- | --- |
| 美國CAB熟成<br>沙朗牛排 | 10 | 640 | 550 – 750 | 55 – 75 |
