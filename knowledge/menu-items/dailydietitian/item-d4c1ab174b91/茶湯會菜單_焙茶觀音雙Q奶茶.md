...
sources:
  - id: dailydietitian-516c91db03b4
    resource: https://dailydietitian.com.tw/%e6%9c%80%e6%96%b0%e8%8c%b6%e6%b9%af%e6%9c%83%e8%8f%9c%e5%96%ae%e5%83%b9%e6%a0%bc-%e7%86%b1%e9%87%8f-%e7%b3%96%e9%87%8f/
    title: 2026 最新茶湯會菜單｜熱量／糖量／價格一次看＋營養師點餐推薦＆建議
...
food:
  id: food:tw:menu:dailydietitian:23ff3d94fe10a1d8e424
  kind: menu_item
  market: TW
  brand: 茶湯會菜單
  name: 焙茶觀音雙Q奶茶
  aliases:
    ...
    - 茶湯會菜單 焙茶觀音雙Q奶茶
revision:
  revision_id: dailydietitian-2026-08-02-23ff3d94fe10
nutrition:
  - basis: per_serving
    values:
      sugar_g: 50
...
extraction:
  ...
  candidate_id: dd:23ff3d94fe10a1d8e424
...
此文件逐列保存日日營養文章中的食品名稱與營養表格數值。[^dailydietitian-516c91db03b4] 它是未驗證 draft，不代表官方標示或 TWFoodMCP 的正式判定。

# Source Row

| 品項 | 溫度 | 總糖量 (g) | 總熱量 (kcal) | 總咖啡因 (mg) | 價格 (元) |
| --- | --- | --- | --- | --- | --- |
| 焙茶觀音雙Q奶茶 | Ⓘ | 50 | 797 | 197 | 80 |

# Review Required

升為 stable 前，真人 reviewer 必須確認精確產品、規格、份量基準、營養欄位、文章版本及可追溯證據。此 draft 的 `quality.calculation_allowed` 固定為 `false`。

[^dailydietitian-516c91db03b4]: 2026 最新茶湯會菜單｜熱量／糖量／價格一次看＋營養師點餐推薦＆建議
