...
food:
  id: food:tw:menu:dailydietitian:db17fa01a0d7ea5dac09
  kind: menu_item
  market: TW
  brand: 路易莎咖啡
  name: 泰奶咖啡 (中/冰)
  aliases:
    ...
    - 路易莎咖啡 泰奶咖啡 (中/冰)
revision:
  revision_id: dailydietitian-2026-08-02-db17fa01a0d7
nutrition:
  - basis: per_serving
    values:
      sugar_g: 16.1
...
extraction:
  ...
  candidate_id: dd:db17fa01a0d7ea5dac09
