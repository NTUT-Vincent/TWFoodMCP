...
food:
  id: food:tw:menu:dailydietitian:34ddf36f14da7fc28ac4
  kind: menu_item
  market: TW
  brand: 路易莎咖啡
  name: 法式培根蔬菜三明治
  aliases:
    ...
    - 路易莎咖啡 法式培根蔬菜三明治
revision:
  revision_id: dailydietitian-2026-08-02-34ddf36f14da
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 393.4
...
extraction:
  ...
  candidate_id: dd:34ddf36f14da7fc28ac4
...
| 品項名稱 | 熱量<br>kcal | 蛋白質<br>g | 脂肪<br>g | 碳水化合物<br>g |
| --- | --- | --- | --- | --- |
| 法式培根蔬菜三明治 | 393.4 | 12.4 | 19.6 | 41.8 |
