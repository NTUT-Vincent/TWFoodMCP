...
food:
  id: food:tw:menu:dailydietitian:add34db89e0e52cd04c6
  kind: menu_item
  market: TW
  brand: 路易莎咖啡
  name: |-
  ...
  aliases:
    ...
    - |-
      ...
      (燕麥奶) (中/冰)
revision:
  revision_id: dailydietitian-2026-08-02-add34db89e0e
nutrition:
  - basis: per_serving
    values:
      sugar_g: 45.5
...
extraction:
  ...
  candidate_id: dd:add34db89e0e52cd04c6
...
| --- | --- | --- | --- |
| 義式巧克力<br>(燕麥奶) (中/冰) | 45.5 | 314.8 | 18 |
