...
food:
  id: food:tw:menu:dailydietitian:6ec56b4abff6a9317de6
  kind: menu_item
  market: TW
  brand: 未分類
  name: 統一鮮蝦麵（83g）
  aliases:
    ...
    - 未分類 統一鮮蝦麵（83g）
revision:
  revision_id: dailydietitian-2026-08-02-6ec56b4abff6
serving:
  amount: 83
  unit: g
  description: 統一鮮蝦麵(83g)
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 398
...
extraction:
  ...
  candidate_id: dd:6ec56b4abff6a9317de6
...
| --- | --- | --- | --- | --- | --- |
| 統一鮮蝦麵（83g） | 398 | 17.6 | 9.5 | 50.4 | 1668 |
