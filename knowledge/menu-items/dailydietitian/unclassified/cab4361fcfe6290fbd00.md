...
food:
  id: food:tw:menu:dailydietitian:cab4361fcfe6290fbd00
  kind: menu_item
  market: TW
  brand: 未分類
  name: 台酒花雕雞麵 （200g）
  aliases:
    ...
    - 未分類 台酒花雕雞麵 （200g）
revision:
  revision_id: dailydietitian-2026-08-02-cab4361fcfe6
serving:
  amount: 200
  unit: g
  description: 台酒花雕雞麵 (200g)
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 536.8
...
extraction:
  ...
  candidate_id: dd:cab4361fcfe6290fbd00
...
| --- | --- | --- | --- | --- | --- |
| 台酒花雕雞麵 （200g） | 536.8 | 24.8 | 19.8 | 58.6 | 2536 |
