...
food:
  id: food:tw:menu:dailydietitian:da79c6d9f17729661c7f
  kind: menu_item
  market: TW
  brand: 未分類
  name: 維力炸醬麵（90g）
  aliases:
    ...
    - 未分類 維力炸醬麵（90g）
revision:
  revision_id: dailydietitian-2026-08-03-da79c6d9f177
serving:
  amount: 90
  unit: g
  description: 維力炸醬麵(90g)
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 418
...
extraction:
  ...
  candidate_id: dd:da79c6d9f17729661c7f
...
| --- | --- | --- | --- | --- | --- |
| 維力炸醬麵（90g） | 418 | 20.4 | 9.6 | 49.1 | 1845 |
