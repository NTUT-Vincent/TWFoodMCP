...
food:
  id: food:tw:menu:dailydietitian:168d7e928393177c939a
  kind: menu_item
  market: TW
  brand: 未分類
  name: 統一辣味蔥燒牛肉（90g）
  aliases:
    ...
    - 未分類 統一辣味蔥燒牛肉（90g）
revision:
  revision_id: dailydietitian-2026-08-03-168d7e928393
serving:
  amount: 90
  unit: g
  description: 統一辣味蔥燒牛肉(90g)
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 423
...
extraction:
  ...
  candidate_id: dd:168d7e928393177c939a
...
| --- | --- | --- | --- | --- | --- |
| 統一辣味蔥燒牛肉（90g） | 423 | 19.4 | 10.1 | 51.8 | 1962 |
