---
type: Food Product
title: 拉亞漢堡菜單 Nutella榛果可可×開心果雙醬貝果
...
food:
  id: food:tw:menu:dailydietitian:fb792f87d9bc8192641c
  kind: menu_item
  market: TW
  brand: 拉亞漢堡菜單
  name: Nutella榛果可可×開心果雙醬貝果
  aliases:
    - Nutella榛果可可×開心果雙醬貝果
    - 拉亞漢堡菜單Nutella榛果可可×開心果雙醬貝果
    - 拉亞漢堡菜單 Nutella榛果可可×開心果雙醬貝果
revision:
  revision_id: dailydietitian-2026-08-03-fb792f87d9bc
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 383.2
...
extraction:
  ...
  candidate_id: dd:fb792f87d9bc8192641c
