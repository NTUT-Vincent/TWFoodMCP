---
type: Food Product
title: 拉亞漢堡菜單 Nutella榛果可可×開心果雙醬皇后奶油吐司
...
sources:
  - id: dailydietitian-6a5f37ead981
    resource: https://dailydietitian.com.tw/%e6%8b%89%e4%ba%9e%e6%bc%a2%e5%a0%a1%e8%8f%9c%e5%96%ae-%e7%86%b1%e9%87%8f-%e5%83%b9%e6%a0%bc/
    title: 2026 最新拉亞漢堡菜單｜新品、價格、熱量、糖量＆咖啡因、建議吃法
...
food:
  id: food:tw:menu:dailydietitian:f79912c884d446cb8ca9
  kind: menu_item
  market: TW
  brand: 拉亞漢堡菜單
  name: Nutella榛果可可×開心果雙醬皇后奶油吐司
  aliases:
    - Nutella榛果可可×開心果雙醬皇后奶油吐司
    - 拉亞漢堡菜單Nutella榛果可可×開心果雙醬皇后奶油吐司
    - 拉亞漢堡菜單 Nutella榛果可可×開心果雙醬皇后奶油吐司
revision:
  revision_id: dailydietitian-2026-08-02-f79912c884d4
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 350.6
...
extraction:
  ...
  candidate_id: dd:f79912c884d446cb8ca9
...
此文件逐列保存日日營養文章中的食品名稱與營養表格數值。[^dailydietitian-6a5f37ead981] 它是未驗證 draft，不代表官方標示或 TWFoodMCP 的正式判定。

# Source Row

| 品項名稱 | 熱量 (kcal) |
| --- | --- |
| Nutella榛果可可×開心果雙醬皇后奶油吐司 | 350.6 |

# Review Required

升為 stable 前，真人 reviewer 必須確認精確產品、規格、份量基準、營養欄位、文章版本及可追溯證據。此 draft 的 `quality.calculation_allowed` 固定為 `false`。

[^dailydietitian-6a5f37ead981]: 2026 最新拉亞漢堡菜單｜新品、價格、熱量、糖量＆咖啡因、建議吃法
