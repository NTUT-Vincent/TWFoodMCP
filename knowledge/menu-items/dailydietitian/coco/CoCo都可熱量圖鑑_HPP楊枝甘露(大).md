...
food:
  id: food:tw:menu:dailydietitian:7d5e1508087e2c5df99a
  kind: menu_item
  market: TW
  brand: CoCo都可熱量圖鑑
  name: HPP楊枝甘露(大)
  aliases:
    - HPP楊枝甘露(大)
    - CoCo都可熱量圖鑑HPP楊枝甘露(大)
    - CoCo都可熱量圖鑑 HPP楊枝甘露(大)
revision:
  revision_id: dailydietitian-2026-08-02-7d5e1508087e
nutrition:
  - basis: per_serving
    values:
      sugar_g: 105
...
extraction:
  ...
  candidate_id: dd:7d5e1508087e2c5df99a
