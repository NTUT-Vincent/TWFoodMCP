...
food:
  id: food:tw:menu:dailydietitian:68d54840d1fb149da053
  kind: menu_item
  market: TW
  brand: CoCo都可熱量圖鑑
  name: 紅柚香檸美式（大）
  aliases:
    ...
    - CoCo都可熱量圖鑑 紅柚香檸美式（大）
revision:
  revision_id: dailydietitian-2026-08-02-68d54840d1fb
nutrition:
  - basis: per_serving
    values:
      sugar_g: 51
...
extraction:
  ...
  candidate_id: dd:68d54840d1fb149da053
