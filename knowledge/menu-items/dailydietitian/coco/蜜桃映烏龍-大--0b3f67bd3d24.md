...
food:
  id: food:tw:menu:dailydietitian:0b3f67bd3d249e0999d2
  kind: menu_item
  market: TW
  brand: CoCo都可熱量圖鑑
  name: 蜜桃映烏龍（大）
  aliases:
    ...
    - CoCo都可熱量圖鑑 蜜桃映烏龍（大）
revision:
  revision_id: dailydietitian-2026-08-02-0b3f67bd3d24
nutrition:
  - basis: per_serving
    values:
      sugar_g: 75
...
extraction:
  ...
  candidate_id: dd:0b3f67bd3d249e0999d2
