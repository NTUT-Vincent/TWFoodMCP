...
food:
  id: food:tw:menu:dailydietitian:288bdd4cdcff8ea7dd76
  kind: menu_item
  market: TW
  brand: CoCo都可熱量圖鑑
  name: 四季珍椰青（中）
  aliases:
    ...
    - CoCo都可熱量圖鑑 四季珍椰青（中）
revision:
  revision_id: dailydietitian-2026-08-02-288bdd4cdcff
nutrition:
  - basis: per_serving
    values:
      sugar_g: 30
...
extraction:
  ...
  candidate_id: dd:288bdd4cdcff8ea7dd76
