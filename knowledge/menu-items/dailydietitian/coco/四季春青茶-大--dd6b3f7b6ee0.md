...
food:
  id: food:tw:menu:dailydietitian:dd6b3f7b6ee0eb6a40fa
  kind: menu_item
  market: TW
  brand: CoCo都可熱量圖鑑
  name: 四季春青茶（大）
  aliases:
    ...
    - CoCo都可熱量圖鑑 四季春青茶（大）
revision:
  revision_id: dailydietitian-2026-08-02-dd6b3f7b6ee0
nutrition:
  - basis: per_serving
    values:
      sugar_g: 33
...
extraction:
  ...
  candidate_id: dd:dd6b3f7b6ee0eb6a40fa
