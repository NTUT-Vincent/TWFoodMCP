...
food:
  id: food:tw:menu:dailydietitian:5bc47544e1f81a7d9810
  kind: menu_item
  market: TW
  brand: 星巴克
  name: 長條蜂蜜蛋糕（每100g）
  aliases:
    ...
    - 星巴克 長條蜂蜜蛋糕（每100g）
revision:
  revision_id: dailydietitian-2026-08-03-5bc47544e1f8
serving:
  amount: 100
  unit: g
  description: 長條蜂蜜蛋糕(每100g)
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 297
...
extraction:
  ...
  candidate_id: dd:5bc47544e1f81a7d9810
...
| 品項名稱 | 價格 | 熱量 | 蛋白質 | 脂肪 |
| --- | --- | --- | --- | --- |
| 長條蜂蜜蛋糕（每100g） | 300元 | 297大卡 | 6.6g | 3.8g |
