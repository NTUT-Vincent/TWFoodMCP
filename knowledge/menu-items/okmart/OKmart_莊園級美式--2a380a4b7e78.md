...
food:
  id: food:tw:menu:okmart:莊園級美式-2a380a4b7e78
  kind: menu_item
  market: TW
  brand: OKmart
  name: 莊園級美式
  aliases:
    ...
    - OKmart 莊園級美式
revision:
  revision_id: google-sheet-2026-08-22-nut-01193
serving:
  description: 中杯冰（約360ml）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
此文件保存試算表記錄 NUT-01193 的營養觀測。[^sheet-source-16ac28934a1e] 它是未驗證 draft，不能直接用於營養計算。
