...
food:
  id: food:tw:menu:okmart:極淬莊園級美式-eecafbbb2cc3
  kind: menu_item
  market: TW
  brand: OKmart
  name: 極淬莊園級美式
  aliases:
    ...
    - OKmart 極淬莊園級美式
revision:
  revision_id: google-sheet-2026-08-22-nut-01166
serving:
...
此文件保存試算表記錄 NUT-01166 的營養觀測。[^sheet-source-24bfe74368ce] 它是未驗證 draft，不能直接用於營養計算。
