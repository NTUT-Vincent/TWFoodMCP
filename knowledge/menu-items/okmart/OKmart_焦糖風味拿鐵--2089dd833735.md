...
food:
  id: food:tw:menu:okmart:焦糖風味拿鐵-2089dd833735
  kind: menu_item
  market: TW
  brand: OKmart
  name: 焦糖風味拿鐵
  aliases:
    ...
    - OKmart 焦糖風味拿鐵
revision:
  revision_id: google-sheet-2026-08-22-nut-01173
serving:
...
此文件保存試算表記錄 NUT-01173 的營養觀測。[^sheet-source-948db255b784] 它是未驗證 draft，不能直接用於營養計算。
