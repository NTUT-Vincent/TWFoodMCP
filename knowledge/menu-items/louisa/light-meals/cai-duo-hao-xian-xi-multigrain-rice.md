...
sources:
  ...
  - id: louisa-official-nutrition-page
    ...
    source_class: primary_official
food:
  id: louisa-menu-cai-duo-hao-xian-xi-multigrain-rice-2025-08
  kind: menu_item
  market: TW
...
```text
菜多好纖細-多穀米        508.4      12      5.8        0.9           0           102.1        4         916.9
```

# Review Notes

- No automatic correction note beyond OCR transcription.
