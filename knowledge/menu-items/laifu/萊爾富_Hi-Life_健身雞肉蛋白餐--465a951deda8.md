...
resource: https://www.instagram.com/reel/C7OePJHheWF/
tags:
  - 萊爾富 Hi-Life
  - 蛋白餐盒
  - TWFood 共筆
...
food:
  id: food:tw:menu:laifu:hi-life_健身雞肉蛋白餐-465a951deda8
  kind: menu_item
  market: TW
  brand: 萊爾富 Hi-Life
  name: 健身雞肉蛋白餐
  aliases:
    ...
    - 萊爾富 Hi-Life 健身雞肉蛋白餐
revision:
  revision_id: google-sheet-2026-08-22-nut-01063
serving:
...
extraction:
  ...
  source_row:
    ...
    source_url: https://www.instagram.com/reel/C7OePJHheWF/
    article_updated_at: null
    accessed_at: 46244
    primary_source_url: null
    usage_note: 社群貼文列出熱量、蛋白質與價格；文章日期未能可靠判定，僅供歷史觀測，待包裝核對。
source_observation:
  price_twd: 95
  usage_note: 社群貼文列出熱量、蛋白質與價格；文章日期未能可靠判定，僅供歷史觀測，待包裝核對。
...
此文件保存試算表記錄 NUT-01063 的營養觀測。[^sheet-source-57afc12fbc07] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-57afc12fbc07]: 萊爾富三款高蛋白健康便當
