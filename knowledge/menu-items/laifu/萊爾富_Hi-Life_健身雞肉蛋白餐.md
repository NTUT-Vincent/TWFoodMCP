...
resource: https://www.ptt.cc/bbs/CVS/M.1712666278.A.747.html
tags:
  - 萊爾富 Hi-Life
  - 餐盒
  - TWFood 共筆
...
sources:
  - id: sheet-source-4644ec098110
    resource: https://www.ptt.cc/bbs/CVS/M.1712666278.A.747.html
    title: "[商品] 萊爾富健身雞肉蛋白餐"
    source_class: community_submission
    last_modified: 2024-04-09T00:00:00+08:00
    retrieved_at: 2026-08-19T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:laifu:hi-life_健身雞肉蛋白餐
  kind: menu_item
  market: TW
  brand: 萊爾富 Hi-Life
  name: 健身雞肉蛋白餐
  aliases:
    ...
    - 萊爾富 Hi-Life 健身雞肉蛋白餐
revision:
  revision_id: google-sheet-2026-08-22-nut-01192
serving:
  description: 1盒（完整商品）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: PTT 批踢踢實業坊
    source_author: 匿名使用者
    source_title: "[商品] 萊爾富健身雞肉蛋白餐"
    source_url: https://www.ptt.cc/bbs/CVS/M.1712666278.A.747.html
    article_updated_at: 45391
    accessed_at: 46253
    primary_source_url: null
    usage_note: 2024年論壇開箱明示整盒熱量、蛋白質與價格；未提供完整營養標示，現行商品與配方待核對。
source_observation:
  price_twd: 95
  usage_note: 2024年論壇開箱明示整盒熱量、蛋白質與價格；未提供完整營養標示，現行商品與配方待核對。
...
此文件保存試算表記錄 NUT-01192 的營養觀測。[^sheet-source-4644ec098110] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-4644ec098110]: [商品] 萊爾富健身雞肉蛋白餐
