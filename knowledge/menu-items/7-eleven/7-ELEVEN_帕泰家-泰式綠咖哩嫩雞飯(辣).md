---
type: Food Product
title: 7-ELEVEN 帕泰家-泰式綠咖哩嫩雞飯(辣)
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.7-11.com.tw/freshfoods/19_star/index.aspx
tags:
  - 7-ELEVEN
  - 咖哩飯
  - TWFood 共筆
...
sources:
  - id: sheet-source-e4e00369bf2d
    resource: https://www.7-11.com.tw/freshfoods/19_star/index.aspx
    title: 7-ELEVEN 小七食堂｜星級饗宴
    source_class: primary_official
    retrieved_at: 2026-08-12T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:7-eleven:帕泰家-泰式綠咖哩嫩雞飯辣
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 帕泰家-泰式綠咖哩嫩雞飯(辣)
  aliases:
    - 帕泰家-泰式綠咖哩嫩雞飯(辣)
    - 7-ELEVEN帕泰家-泰式綠咖哩嫩雞飯(辣)
    - 7-ELEVEN 帕泰家-泰式綠咖哩嫩雞飯(辣)
revision:
  revision_id: google-sheet-2026-08-22-nut-01089
serving:
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 7-ELEVEN Taiwan
    source_author: null
    source_title: 7-ELEVEN 小七食堂｜星級饗宴
    source_url: https://www.7-11.com.tw/freshfoods/19_star/index.aspx
...
此文件保存試算表記錄 NUT-01089 的營養觀測。[^sheet-source-e4e00369bf2d] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-e4e00369bf2d]: 7-ELEVEN 小七食堂｜星級饗宴
