...
food:
  id: food:tw:menu:7-eleven:阜杭豆漿-里肌肉蛋紫米飯糰
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 阜杭豆漿-里肌肉蛋紫米飯糰
  aliases:
    - 阜杭豆漿-里肌肉蛋紫米飯糰
    - 7-ELEVEN阜杭豆漿-里肌肉蛋紫米飯糰
    - 7-ELEVEN 阜杭豆漿-里肌肉蛋紫米飯糰
revision:
  revision_id: google-sheet-2026-08-22-nut-01018
serving:
...
此文件保存試算表記錄 NUT-01018 的營養觀測。[^sheet-source-1bc8021b9d42] 它是未驗證 draft，不能直接用於營養計算。
