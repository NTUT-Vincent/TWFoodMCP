...
food:
  id: food:tw:menu:7-eleven:一日野菜-海藻沙拉-27c70ce60a36
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 一日野菜-海藻沙拉
  aliases:
    ...
    - 7-ELEVEN 一日野菜-海藻沙拉
revision:
  revision_id: google-sheet-2026-08-22-nut-01022
serving:
...
此文件保存試算表記錄 NUT-01022 的營養觀測。[^sheet-source-1bc8021b9d42] 它是未驗證 draft，不能直接用於營養計算。
