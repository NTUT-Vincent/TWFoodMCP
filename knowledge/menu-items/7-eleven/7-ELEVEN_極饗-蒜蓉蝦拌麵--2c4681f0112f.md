...
food:
  id: food:tw:menu:7-eleven:極饗-蒜蓉蝦拌麵-2c4681f0112f
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 極饗-蒜蓉蝦拌麵
  aliases:
    ...
    - 7-ELEVEN 極饗-蒜蓉蝦拌麵
revision:
  revision_id: google-sheet-2026-08-22-nut-01000
serving:
...
此文件保存試算表記錄 NUT-01000 的營養觀測。[^sheet-source-fc746c52791e] 它是未驗證 draft，不能直接用於營養計算。
