---
type: Food Product
title: 7-ELEVEN 呷七碗招牌北部粽
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.threads.com/@ningning_dietitian/post/DY5qg5ckgsU
tags:
  - 7-ELEVEN
  - 粽子／米食
  - TWFood 共筆
...
sources:
  - id: sheet-source-511ca21cedf2
    resource: https://www.threads.com/@ningning_dietitian/post/DY5qg5ckgsU
    title: 7-ELEVEN 呷七碗招牌北部粽營養標示抽查
...
food:
  id: food:tw:menu:7-eleven:呷七碗招牌北部粽
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 呷七碗招牌北部粽
  aliases:
    ...
    - 7-ELEVEN 呷七碗招牌北部粽
revision:
  revision_id: google-sheet-2026-08-22-nut-01183
serving:
  description: 1顆（完整商品）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: Threads
    source_author: 寧寧營養師
    source_title: 7-ELEVEN 呷七碗招牌北部粽營養標示抽查
    source_url: https://www.threads.com/@ningning_dietitian/post/DY5qg5ckgsU
...
此文件保存試算表記錄 NUT-01183 的營養觀測。[^sheet-source-511ca21cedf2] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-511ca21cedf2]: 7-ELEVEN 呷七碗招牌北部粽營養標示抽查
