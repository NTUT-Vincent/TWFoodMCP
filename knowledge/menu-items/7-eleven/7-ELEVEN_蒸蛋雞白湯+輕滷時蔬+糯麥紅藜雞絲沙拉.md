---
type: Food Product
title: 7-ELEVEN 蒸蛋雞白湯＋輕滷時蔬＋糯麥紅藜雞絲沙拉
...
food:
  id: food:tw:menu:7-eleven:蒸蛋雞白湯輕滷時蔬糯麥紅藜雞絲沙拉
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 蒸蛋雞白湯＋輕滷時蔬＋糯麥紅藜雞絲沙拉
  aliases:
    - 蒸蛋雞白湯＋輕滷時蔬＋糯麥紅藜雞絲沙拉
    - 7-ELEVEN蒸蛋雞白湯＋輕滷時蔬＋糯麥紅藜雞絲沙拉
    - 7-ELEVEN 蒸蛋雞白湯＋輕滷時蔬＋糯麥紅藜雞絲沙拉
revision:
  revision_id: google-sheet-2026-08-22-nut-00348
serving:
...
此文件保存試算表記錄 NUT-00348 的營養觀測。[^sheet-source-5ec1a1247e42] 它是未驗證 draft，不能直接用於營養計算。

# Observation

| 欄位 | 值 |
| --- | --- |
| 食品 | 蒸蛋雞白湯＋輕滷時蔬＋糯麥紅藜雞絲沙拉 |
| 品牌／情境 | 7-ELEVEN |
| 分類 | 文章晚餐組合 |
| 份量基準 | 1組（文章表格完整搭配） |
| energy_kcal | 451 |
