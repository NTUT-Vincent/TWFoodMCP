---
type: Food Product
title: 7-ELEVEN CITY CAFE 厚乳拿鐵 (特大冰)
...
food:
  id: food:tw:menu:7-eleven:city_cafe_厚乳拿鐵_特大冰
  kind: menu_item
  market: TW
  ...
  aliases:
    - 厚乳拿鐵 (特大冰)
    - 7-ELEVEN CITY CAFE厚乳拿鐵 (特大冰)
    - 7-ELEVEN CITY CAFE 厚乳拿鐵 (特大冰)
revision:
  revision_id: google-sheet-2026-08-22-nut-00248
serving:
...
此文件保存試算表記錄 NUT-00248 的營養觀測。[^sheet-source-ede55fd63456] 它是未驗證 draft，不能直接用於營養計算。
