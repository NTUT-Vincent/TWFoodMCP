...
food:
  id: food:tw:menu:7-eleven:香檸青醬雞肉冷義大利麵-ed62e1b97e19
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 香檸青醬雞肉冷義大利麵
...
revision:
  revision_id: google-sheet-2026-08-22-nut-01033
serving:
...
此文件保存試算表記錄 NUT-01033 的營養觀測。[^sheet-source-1bc8021b9d42] 它是未驗證 draft，不能直接用於營養計算。
