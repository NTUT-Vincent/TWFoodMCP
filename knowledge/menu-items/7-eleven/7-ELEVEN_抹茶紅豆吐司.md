...
food:
  id: food:tw:menu:7-eleven:抹茶紅豆吐司
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 抹茶紅豆吐司
  aliases:
    ...
    - 7-ELEVEN 抹茶紅豆吐司
revision:
  revision_id: google-sheet-2026-08-22-nut-01108
serving:
  description: 1片（80 g）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    usage_note: 一般美食社群比較文；僅提供重量、價格與熱量，其他營養素不推算。
source_observation:
  price_twd: 39
  usage_note: 一般美食社群比較文；僅提供重量、價格與熱量，其他營養素不推算。
...
此文件保存試算表記錄 NUT-01108 的營養觀測。[^sheet-source-bf4ad4f5d06c] 它是未驗證 draft，不能直接用於營養計算。
