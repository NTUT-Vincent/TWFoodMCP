...
resource: https://www.7-11.com.tw/freshfoods/23_rice/index.aspx
tags:
  - 7-ELEVEN
  - 義大利麵
  - TWFood 共筆
...
sources:
  - id: sheet-source-d659239144a6
    resource: https://www.7-11.com.tw/freshfoods/23_rice/index.aspx
    title: 7-ELEVEN 小七食堂｜米食
    source_class: primary_official
    retrieved_at: 2026-08-09T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:7-eleven:homeal_奶香起司烤雞筆管麵
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
...
revision:
  revision_id: google-sheet-2026-08-22-nut-01011
serving:
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 7-ELEVEN Taiwan
    source_author: null
    source_title: 7-ELEVEN 小七食堂｜米食
    source_url: https://www.7-11.com.tw/freshfoods/23_rice/index.aspx
    article_updated_at: null
    accessed_at: 46243
    primary_source_url: null
    usage_note: 7-ELEVEN 官方頁面明列品名與熱量；未提供的營養素保持空白，實際包裝標示優先。
source_observation:
  price_twd: 99
  usage_note: 7-ELEVEN 官方頁面明列品名與熱量；未提供的營養素保持空白，實際包裝標示優先。
...
此文件保存試算表記錄 NUT-01011 的營養觀測。[^sheet-source-d659239144a6] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-d659239144a6]: 7-ELEVEN 小七食堂｜米食
