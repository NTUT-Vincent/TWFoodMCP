---
type: Food Product
title: 7-ELEVEN CITY CAFE 特選美式咖啡 (大冰)
...
food:
  id: food:tw:menu:7-eleven:city_cafe_特選美式咖啡_大冰
  kind: menu_item
  market: TW
  ...
  aliases:
    - 特選美式咖啡 (大冰)
    - 7-ELEVEN CITY CAFE特選美式咖啡 (大冰)
    - 7-ELEVEN CITY CAFE 特選美式咖啡 (大冰)
revision:
  revision_id: google-sheet-2026-08-22-nut-00234
serving:
...
extraction:
  ...
  source_row:
    ...
    usage_note: 文章轉錄；另列咖啡因 314.5 mg。非品牌官方頁，現行配方以門市／官方標示為準。
source_observation:
  usage_note: 文章轉錄；另列咖啡因 314.5 mg。非品牌官方頁，現行配方以門市／官方標示為準。
...
此文件保存試算表記錄 NUT-00234 的營養觀測。[^sheet-source-ede55fd63456] 它是未驗證 draft，不能直接用於營養計算。
