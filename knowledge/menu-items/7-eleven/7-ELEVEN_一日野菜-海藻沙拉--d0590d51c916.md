...
sources:
  - id: sheet-source-de6bf261d378
    resource: https://www.7-11.com.tw/freshfoods/2_Light/index.aspx
    title: 7-ELEVEN 小七食堂｜低卡健康
    source_class: primary_official
    retrieved_at: 2026-08-09T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:7-eleven:一日野菜-海藻沙拉-d0590d51c916
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 一日野菜-海藻沙拉
  aliases:
    ...
    - 7-ELEVEN 一日野菜-海藻沙拉
revision:
  revision_id: google-sheet-2026-08-22-nut-01006
serving:
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 7-ELEVEN Taiwan
    source_author: null
    source_title: 7-ELEVEN 小七食堂｜低卡健康
...
此文件保存試算表記錄 NUT-01006 的營養觀測。[^sheet-source-de6bf261d378] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-de6bf261d378]: 7-ELEVEN 小七食堂｜低卡健康
