---
type: Food Product
title: 7-ELEVEN 21 Plus義式烤雞堅果沙拉
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.7-11.com.tw/freshfoods/2_Light/index.aspx
tags:
  - 7-ELEVEN
  - 沙拉
  - TWFood 共筆
...
sources:
  - id: sheet-source-de6bf261d378
    resource: https://www.7-11.com.tw/freshfoods/2_Light/index.aspx
    title: 7-ELEVEN 小七食堂｜Simple Fit
    source_class: primary_official
    retrieved_at: 2026-08-11T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:7-eleven:21_plus義式烤雞堅果沙拉
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 21 Plus義式烤雞堅果沙拉
  aliases:
    - 21 Plus義式烤雞堅果沙拉
    - 7-ELEVEN21 Plus義式烤雞堅果沙拉
    - 7-ELEVEN 21 Plus義式烤雞堅果沙拉
revision:
  revision_id: google-sheet-2026-08-22-nut-01080
serving:
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 7-ELEVEN Taiwan
    source_author: null
    source_title: 7-ELEVEN 小七食堂｜Simple Fit
    source_url: https://www.7-11.com.tw/freshfoods/2_Light/index.aspx
...
此文件保存試算表記錄 NUT-01080 的營養觀測。[^sheet-source-de6bf261d378] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-de6bf261d378]: 7-ELEVEN 小七食堂｜Simple Fit
