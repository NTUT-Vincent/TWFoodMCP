---
type: Food Product
title: 7-ELEVEN 韓式泡菜烏龍麵
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.threads.com/@ningning_dietitian/post/DPC9WYZjc2p
tags:
  - 7-ELEVEN
  - 麵食
  - TWFood 共筆
...
sources:
  - id: sheet-source-67b86cd665b7
    resource: https://www.threads.com/@ningning_dietitian/post/DPC9WYZjc2p
    title: 7-ELEVEN 韓式泡菜烏龍麵營養標示抽查
    source_class: community_submission
    last_modified: 2025-09-25T00:00:00+08:00
    retrieved_at: 2026-08-14T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:7-eleven:韓式泡菜烏龍麵
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 韓式泡菜烏龍麵
  aliases:
    ...
    - 7-ELEVEN 韓式泡菜烏龍麵
revision:
  revision_id: google-sheet-2026-08-22-nut-01118
serving:
  description: 1盒
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: Threads
    source_author: "@ningning_dietitian"
    source_title: 7-ELEVEN 韓式泡菜烏龍麵營養標示抽查
    source_url: https://www.threads.com/@ningning_dietitian/post/DPC9WYZjc2p
    article_updated_at: 45925
    accessed_at: 46248
...
此文件保存試算表記錄 NUT-01118 的營養觀測。[^sheet-source-67b86cd665b7] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-67b86cd665b7]: 7-ELEVEN 韓式泡菜烏龍麵營養標示抽查
