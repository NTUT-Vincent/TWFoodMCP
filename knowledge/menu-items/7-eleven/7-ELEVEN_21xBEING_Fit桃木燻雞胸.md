---
type: Food Product
title: 7-ELEVEN 21xBEING Fit桃木燻雞胸
...
food:
  id: food:tw:menu:7-eleven:21xbeing_fit桃木燻雞胸
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 21xBEING Fit桃木燻雞胸
  aliases:
    - 21xBEING Fit桃木燻雞胸
    - 7-ELEVEN21xBEING Fit桃木燻雞胸
    - 7-ELEVEN 21xBEING Fit桃木燻雞胸
revision:
  revision_id: google-sheet-2026-08-22-nut-01078
serving:
...
此文件保存試算表記錄 NUT-01078 的營養觀測。[^sheet-source-0bdfeb34901d] 它是未驗證 draft，不能直接用於營養計算。

# Observation

| 欄位 | 值 |
| --- | --- |
| 食品 | 21xBEING Fit桃木燻雞胸 |
| 品牌／情境 | 7-ELEVEN |
| 分類 | 雞胸肉 |
| 份量基準 | 1份（官網商品頁） |
| energy_kcal | 120 |
