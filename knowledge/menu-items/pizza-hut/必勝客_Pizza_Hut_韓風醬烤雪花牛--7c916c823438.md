...
food:
  id: food:tw:menu:pizza-hut:pizza_hut_韓風醬烤雪花牛-7c916c823438
  kind: menu_item
  market: TW
  brand: 必勝客 Pizza Hut
  name: 韓風醬烤雪花牛
...
revision:
  revision_id: google-sheet-2026-08-22-nut-00090
serving:
...
此文件保存試算表記錄 NUT-00090 的營養觀測。[^sheet-source-11b7b2ea1340] 它是未驗證 draft，不能直接用於營養計算。
