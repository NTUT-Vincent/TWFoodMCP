...
food:
  id: food:tw:menu:pizza-hut:pizza_hut_四小福-160e2723b23b
  kind: menu_item
  market: TW
  brand: 必勝客 Pizza Hut
  name: 四小福
  aliases:
    ...
    - 必勝客 Pizza Hut 四小福
revision:
  revision_id: google-sheet-2026-08-22-nut-00058
serving:
...
此文件保存試算表記錄 NUT-00058 的營養觀測。[^sheet-source-11b7b2ea1340] 它是未驗證 draft，不能直接用於營養計算。
