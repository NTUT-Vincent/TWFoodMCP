...
food:
  id: food:tw:menu:pizza-hut:pizza_hut_韓式泡菜豬五花
  kind: menu_item
  market: TW
  brand: 必勝客 Pizza Hut
  name: 韓式泡菜豬五花
  aliases:
    - 韓式泡菜豬五花
    - 必勝客 Pizza Hut韓式泡菜豬五花
    - 必勝客 Pizza Hut 韓式泡菜豬五花
revision:
  revision_id: google-sheet-2026-08-22-nut-00088
serving:
...
此文件保存試算表記錄 NUT-00088 的營養觀測。[^sheet-source-11b7b2ea1340] 它是未驗證 draft，不能直接用於營養計算。
