...
food:
  id: food:tw:menu:pizza-hut:pizza_hut_超級總匯-22d0a69286a5
  kind: menu_item
  market: TW
  brand: 必勝客 Pizza Hut
  name: 超級總匯
  aliases:
    ...
    - 必勝客 Pizza Hut 超級總匯
revision:
  revision_id: google-sheet-2026-08-22-nut-00078
serving:
...
此文件保存試算表記錄 NUT-00078 的營養觀測。[^sheet-source-11b7b2ea1340] 它是未驗證 draft，不能直接用於營養計算。
