...
food:
  id: food:tw:menu:pizza-hut:必勝客_雙拼-四小福日式照燒雞-75bbb2afcf2e
  kind: menu_item
  market: TW
  brand: 必勝客
  name: 雙拼-四小福+日式照燒雞
  aliases:
    ...
    - 必勝客 雙拼-四小福+日式照燒雞
revision:
  revision_id: dailydietitian-2026-08-02-75bbb2afcf2e
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 111
...
extraction:
  ...
  candidate_id: dd:75bbb2afcf2e387f941b
