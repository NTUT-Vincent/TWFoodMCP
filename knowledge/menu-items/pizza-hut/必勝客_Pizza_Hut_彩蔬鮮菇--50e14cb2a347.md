...
food:
  id: food:tw:menu:pizza-hut:pizza_hut_彩蔬鮮菇-50e14cb2a347
  kind: menu_item
  market: TW
  brand: 必勝客 Pizza Hut
  name: 彩蔬鮮菇
  aliases:
    ...
    - 必勝客 Pizza Hut 彩蔬鮮菇
revision:
  revision_id: google-sheet-2026-08-22-nut-00075
serving:
...
此文件保存試算表記錄 NUT-00075 的營養觀測。[^sheet-source-11b7b2ea1340] 它是未驗證 draft，不能直接用於營養計算。
