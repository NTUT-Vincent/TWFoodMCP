...
food:
  id: food:tw:menu:pizza-hut:必勝客_雙拼-四小福日式照燒雞-d9bf18d2cc55
  kind: menu_item
  market: TW
  brand: 必勝客
  name: 雙拼-四小福+日式照燒雞
  aliases:
    ...
    - 必勝客 雙拼-四小福+日式照燒雞
revision:
  revision_id: dailydietitian-2026-08-02-d9bf18d2cc55
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 200
...
extraction:
  ...
  candidate_id: dd:d9bf18d2cc55383923be
