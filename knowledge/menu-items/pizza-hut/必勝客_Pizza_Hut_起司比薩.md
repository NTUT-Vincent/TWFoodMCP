...
food:
  id: food:tw:menu:pizza-hut:pizza_hut_起司比薩
  kind: menu_item
  market: TW
  brand: 必勝客 Pizza Hut
  name: 起司比薩
  aliases:
    ...
    - 必勝客 Pizza Hut 起司比薩
revision:
  revision_id: google-sheet-2026-08-22-nut-00073
serving:
...
此文件保存試算表記錄 NUT-00073 的營養觀測。[^sheet-source-11b7b2ea1340] 它是未驗證 draft，不能直接用於營養計算。
