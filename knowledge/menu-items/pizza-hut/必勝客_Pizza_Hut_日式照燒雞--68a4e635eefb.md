...
food:
  id: food:tw:menu:pizza-hut:pizza_hut_日式照燒雞-68a4e635eefb
  kind: menu_item
  market: TW
  brand: 必勝客 Pizza Hut
  name: 日式照燒雞
  aliases:
    ...
    - 必勝客 Pizza Hut 日式照燒雞
revision:
  revision_id: google-sheet-2026-08-22-nut-00054
serving:
...
此文件保存試算表記錄 NUT-00054 的營養觀測。[^sheet-source-11b7b2ea1340] 它是未驗證 draft，不能直接用於營養計算。
