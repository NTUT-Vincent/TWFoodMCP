...
food:
  id: food:tw:menu:pizza-hut:pizza_hut_炙燒豬肉總匯-b421c54d3063
  kind: menu_item
  market: TW
  brand: 必勝客 Pizza Hut
  name: 炙燒豬肉總匯
  aliases:
    - 炙燒豬肉總匯
    - 必勝客 Pizza Hut炙燒豬肉總匯
    - 必勝客 Pizza Hut 炙燒豬肉總匯
revision:
  revision_id: google-sheet-2026-08-22-nut-00067
serving:
...
此文件保存試算表記錄 NUT-00067 的營養觀測。[^sheet-source-11b7b2ea1340] 它是未驗證 draft，不能直接用於營養計算。
