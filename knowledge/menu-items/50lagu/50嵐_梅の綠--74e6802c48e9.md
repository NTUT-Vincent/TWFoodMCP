...
food:
  id: food:tw:menu:50lagu:梅綠-74e6802c48e9
  kind: menu_item
  market: TW
  brand: 50嵐
  name: 梅の綠
  aliases:
    ...
    - 50嵐 梅の綠
revision:
  revision_id: google-sheet-2026-08-22-nut-00429
serving:
  description: 大杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00429 的營養觀測。[^sheet-source-109602cde690] 它是未驗證 draft，不能直接用於營養計算。
