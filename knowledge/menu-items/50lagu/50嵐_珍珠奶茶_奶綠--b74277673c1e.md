...
food:
  id: food:tw:menu:50lagu:珍珠奶茶_奶綠-b74277673c1e
  kind: menu_item
  market: TW
  brand: 50嵐
  name: 珍珠奶茶/奶綠
  aliases:
    ...
    - 50嵐 珍珠奶茶/奶綠
revision:
  revision_id: google-sheet-2026-08-22-nut-00510
serving:
  description: 中杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00510 的營養觀測。[^sheet-source-109602cde690] 它是未驗證 draft，不能直接用於營養計算。
