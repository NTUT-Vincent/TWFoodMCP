...
food:
  id: food:tw:menu:50lagu:葡萄柚多多-e3e19496ad16
  kind: menu_item
  market: TW
  brand: 50嵐
  name: 葡萄柚多多
  aliases:
    ...
    - 50嵐 葡萄柚多多
revision:
  revision_id: google-sheet-2026-08-22-nut-00475
serving:
  description: 大杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00475 的營養觀測。[^sheet-source-109602cde690] 它是未驗證 draft，不能直接用於營養計算。
