...
food:
  id: food:tw:menu:50lagu:四季奶青瑪奇朵-08aeb05e9b2d
  kind: menu_item
  market: TW
  brand: 50嵐
  name: 四季奶青瑪奇朵
  aliases:
    ...
    - 50嵐 四季奶青瑪奇朵
revision:
  revision_id: google-sheet-2026-08-22-nut-00460
serving:
  description: 中杯（全糖）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    usage_note: 文章表格之全糖參考值；甜度、冰量、地區配方與配料會影響實際熱量及糖量，應以門市或現行標示為準。 中杯糖量原文為 40–50g，未填入單一數值。
source_observation:
  usage_note: 文章表格之全糖參考值；甜度、冰量、地區配方與配料會影響實際熱量及糖量，應以門市或現行標示為準。 中杯糖量原文為 40–50g，未填入單一數值。
...
此文件保存試算表記錄 NUT-00460 的營養觀測。[^sheet-source-109602cde690] 它是未驗證 draft，不能直接用於營養計算。
