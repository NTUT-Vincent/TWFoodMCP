...
food:
  id: food:tw:menu:50lagu:珍珠青_烏-9217c3ff971f
  kind: menu_item
  market: TW
  brand: 50嵐
  name: 珍珠青/烏
  aliases:
    ...
    - 50嵐 珍珠青/烏
revision:
  revision_id: google-sheet-2026-08-22-nut-00505
serving:
  description: 大杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00505 的營養觀測。[^sheet-source-109602cde690] 它是未驗證 draft，不能直接用於營養計算。
