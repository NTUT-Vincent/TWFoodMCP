...
food:
  id: food:tw:menu:50lagu:8冰綠-12ec84073395
  kind: menu_item
  market: TW
  brand: 50嵐
  name: 8冰綠
  aliases:
    ...
    - 50嵐 8冰綠
revision:
  revision_id: google-sheet-2026-08-22-nut-00432
serving:
  description: 中杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00432 的營養觀測。[^sheet-source-109602cde690] 它是未驗證 draft，不能直接用於營養計算。
