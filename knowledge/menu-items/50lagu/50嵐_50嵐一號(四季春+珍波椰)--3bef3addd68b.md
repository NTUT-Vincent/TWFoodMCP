...
food:
  id: food:tw:menu:50lagu:50嵐一號四季春珍波椰-3bef3addd68b
  kind: menu_item
  market: TW
  brand: 50嵐
  name: 50嵐一號（四季春+珍波椰）
  aliases:
    ...
    - 50嵐 50嵐一號（四季春+珍波椰）
revision:
  revision_id: google-sheet-2026-08-22-nut-00501
serving:
  description: 大杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00501 的營養觀測。[^sheet-source-109602cde690] 它是未驗證 draft，不能直接用於營養計算。
