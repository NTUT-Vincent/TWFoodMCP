...
food:
  id: food:tw:menu:50lagu:旺來紅-f262a5f0e080
  kind: menu_item
  market: TW
  brand: 50嵐
  name: 旺來紅
  aliases:
    ...
    - 50嵐 旺來紅
revision:
  revision_id: google-sheet-2026-08-22-nut-00437
serving:
  description: 大杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00437 的營養觀測。[^sheet-source-109602cde690] 它是未驗證 draft，不能直接用於營養計算。
