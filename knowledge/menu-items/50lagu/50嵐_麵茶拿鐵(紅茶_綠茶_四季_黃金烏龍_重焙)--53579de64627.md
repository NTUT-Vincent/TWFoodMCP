...
food:
  id: food:tw:menu:50lagu:麵茶拿鐵紅茶_綠茶_四季_黃金烏龍_重焙-53579de64627
  kind: menu_item
  market: TW
  brand: 50嵐
...
revision:
  revision_id: google-sheet-2026-08-22-nut-00499
serving:
  description: 大杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00499 的營養觀測。[^sheet-source-109602cde690] 它是未驗證 draft，不能直接用於營養計算。
