...
food:
  id: food:tw:menu:50lagu:8冰綠-6a3f937f38df
  kind: menu_item
  market: TW
  brand: 50嵐
  name: 8冰綠
  aliases:
    ...
    - 50嵐 8冰綠
revision:
  revision_id: google-sheet-2026-08-22-nut-00433
serving:
  description: 大杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00433 的營養觀測。[^sheet-source-109602cde690] 它是未驗證 draft，不能直接用於營養計算。
