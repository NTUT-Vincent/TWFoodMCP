...
food:
  id: food:tw:menu:starbucks:starbucks_黑胡椒豬肉可頌堡
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 黑胡椒豬肉可頌堡
  aliases:
    - 黑胡椒豬肉可頌堡
    - 星巴克 Starbucks黑胡椒豬肉可頌堡
    - 星巴克 Starbucks 黑胡椒豬肉可頌堡
revision:
  revision_id: google-sheet-2026-08-22-nut-00150
serving:
...
此文件保存試算表記錄 NUT-00150 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
