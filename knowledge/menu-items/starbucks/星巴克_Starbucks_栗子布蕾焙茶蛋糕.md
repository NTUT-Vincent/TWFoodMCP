...
food:
  id: food:tw:menu:starbucks:starbucks_栗子布蕾焙茶蛋糕
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 栗子布蕾焙茶蛋糕
  aliases:
    - 栗子布蕾焙茶蛋糕
    - 星巴克 Starbucks栗子布蕾焙茶蛋糕
    - 星巴克 Starbucks 栗子布蕾焙茶蛋糕
revision:
  revision_id: google-sheet-2026-08-22-nut-00124
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:3a24fdc4ddec
  existing_title: 星巴克 柚香蜂蜜波士頓派
  existing_concept: /menu-items/starbucks/foods/柚香蜂蜜波士頓派-3a24fdc4ddec.md
  comparison:
    corroborated: false
    compared:
      - &a1
      ...
      - &a3
        field: fat_g
        candidate_value: 17.3
        official_value: 12.4
        delta: 4.9
        tolerance: 0.24800000000000003
    matched: []
    mismatched:
      - *a1
      - *a2
...
此文件保存試算表記錄 NUT-00124 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值需要衝突審查：[星巴克 柚香蜂蜜波士頓派](/menu-items/starbucks/foods/柚香蜂蜜波士頓派-3a24fdc4ddec.md)。
