...
food:
  id: food:tw:menu:starbucks:starbucks_葡萄起司胚芽貝果
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 葡萄起司胚芽貝果
  aliases:
    - 葡萄起司胚芽貝果
    - 星巴克 Starbucks葡萄起司胚芽貝果
    - 星巴克 Starbucks 葡萄起司胚芽貝果
revision:
  revision_id: google-sheet-2026-08-22-nut-00159
serving:
...
此文件保存試算表記錄 NUT-00159 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
