...
food:
  id: food:tw:menu:starbucks:starbucks_比利時鬆餅
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 比利時鬆餅
  aliases:
    ...
    - 星巴克 Starbucks 比利時鬆餅
revision:
  revision_id: google-sheet-2026-08-22-nut-00099
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:c871b45a8c56
  existing_title: 星巴克 比利時鬆餅
  existing_concept: /menu-items/starbucks/foods/比利時鬆餅-c871b45a8c56.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 273.2
        official_value: 273.2
        delta: 0
        tolerance: 2.7319999999999998
      - &a2
        field: protein_g
        candidate_value: 3.5
        official_value: 3.5
      ...
      - &a3
        field: fat_g
        candidate_value: 14.4
        official_value: 14.4
        delta: 0
        tolerance: 0.28800000000000003
    matched:
      - *a1
      - *a2
      - *a3
...
此文件保存試算表記錄 NUT-00099 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 比利時鬆餅](/menu-items/starbucks/foods/比利時鬆餅-c871b45a8c56.md)。
