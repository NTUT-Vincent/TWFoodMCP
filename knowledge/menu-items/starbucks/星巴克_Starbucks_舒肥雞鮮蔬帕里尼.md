...
food:
  id: food:tw:menu:starbucks:starbucks_舒肥雞鮮蔬帕里尼
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 舒肥雞鮮蔬帕里尼
  aliases:
    - 舒肥雞鮮蔬帕里尼
    - 星巴克 Starbucks舒肥雞鮮蔬帕里尼
    - 星巴克 Starbucks 舒肥雞鮮蔬帕里尼
revision:
  revision_id: google-sheet-2026-08-22-nut-00146
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:413fe4c9792c
  existing_title: 星巴克 舒肥雞鮮蔬帕里尼
  existing_concept: /menu-items/starbucks/foods/舒肥雞鮮蔬帕里尼-413fe4c9792c.md
  comparison:
    corroborated: true
    compared:
      - &a1
      ...
      - &a2
        field: protein_g
        candidate_value: 18.5
        official_value: 18.5
        delta: 0
        tolerance: 0.37
      - &a3
        field: fat_g
        candidate_value: 21.3
        official_value: 21.3
        delta: 0
        tolerance: 0.42600000000000005
    matched:
      - *a1
      - *a2
      - *a3
...
此文件保存試算表記錄 NUT-00146 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 舒肥雞鮮蔬帕里尼](/menu-items/starbucks/foods/舒肥雞鮮蔬帕里尼-413fe4c9792c.md)。
