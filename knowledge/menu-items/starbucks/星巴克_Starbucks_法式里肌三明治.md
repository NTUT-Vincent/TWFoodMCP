...
food:
  id: food:tw:menu:starbucks:starbucks_法式里肌三明治
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 法式里肌三明治
  aliases:
    - 法式里肌三明治
    - 星巴克 Starbucks法式里肌三明治
    - 星巴克 Starbucks 法式里肌三明治
revision:
  revision_id: google-sheet-2026-08-22-nut-00116
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:862dff1bbfe7
  existing_title: 星巴克 焗烤法式里肌三明治
  existing_concept: /menu-items/starbucks/foods/焗烤法式里肌三明治-862dff1bbfe7.md
  comparison:
    corroborated: false
    compared:
      - &a1
      ...
      - &a2
        field: protein_g
        candidate_value: 16.3
        official_value: 16.9
        delta: 0.5999999999999979
        tolerance: 0.33799999999999997
      - &a3
        field: fat_g
        candidate_value: 13.3
        official_value: 15.5
...
此文件保存試算表記錄 NUT-00116 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值需要衝突審查：[星巴克 焗烤法式里肌三明治](/menu-items/starbucks/foods/焗烤法式里肌三明治-862dff1bbfe7.md)。
