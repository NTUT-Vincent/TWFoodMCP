...
food:
  id: food:tw:menu:starbucks:starbucks_松露鹽可頌
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 松露鹽可頌
  aliases:
    ...
    - 星巴克 Starbucks 松露鹽可頌
revision:
  revision_id: google-sheet-2026-08-22-nut-00114
serving:
...
此文件保存試算表記錄 NUT-00114 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
