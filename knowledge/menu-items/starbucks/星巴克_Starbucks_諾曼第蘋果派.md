...
food:
  id: food:tw:menu:starbucks:starbucks_諾曼第蘋果派
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 諾曼第蘋果派
  aliases:
    - 諾曼第蘋果派
    - 星巴克 Starbucks諾曼第蘋果派
    - 星巴克 Starbucks 諾曼第蘋果派
revision:
  revision_id: google-sheet-2026-08-22-nut-00168
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:b18c4e547afb
  existing_title: 星巴克 諾曼第蘋果派
  existing_concept: /menu-items/starbucks/foods/諾曼第蘋果派-b18c4e547afb.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 192.7
        official_value: 192.7
        delta: 0
        tolerance: 1.9269999999999998
      - &a2
        field: protein_g
        candidate_value: 2.1
        official_value: 2.1
...
此文件保存試算表記錄 NUT-00168 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 諾曼第蘋果派](/menu-items/starbucks/foods/諾曼第蘋果派-b18c4e547afb.md)。
