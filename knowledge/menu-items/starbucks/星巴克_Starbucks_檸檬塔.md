...
food:
  id: food:tw:menu:starbucks:starbucks_檸檬塔
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 檸檬塔
  aliases:
    ...
    - 星巴克 Starbucks 檸檬塔
revision:
  revision_id: google-sheet-2026-08-22-nut-00171
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:eb9b759d8096
  existing_title: 星巴克 經典檸檬塔
  existing_concept: /menu-items/starbucks/foods/經典檸檬塔-eb9b759d8096.md
  comparison:
    corroborated: false
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00171 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值需要衝突審查：[星巴克 經典檸檬塔](/menu-items/starbucks/foods/經典檸檬塔-eb9b759d8096.md)。
