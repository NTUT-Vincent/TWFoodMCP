...
food:
  id: food:tw:menu:starbucks:starbucks_藍莓三重奏起司蛋糕
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 藍莓三重奏起司蛋糕
  aliases:
    - 藍莓三重奏起司蛋糕
    - 星巴克 Starbucks藍莓三重奏起司蛋糕
    - 星巴克 Starbucks 藍莓三重奏起司蛋糕
revision:
  revision_id: google-sheet-2026-08-22-nut-00175
serving:
...
此文件保存試算表記錄 NUT-00175 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
