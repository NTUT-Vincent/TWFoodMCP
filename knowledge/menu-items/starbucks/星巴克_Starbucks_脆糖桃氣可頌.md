...
food:
  id: food:tw:menu:starbucks:starbucks_脆糖桃氣可頌
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 脆糖桃氣可頌
  aliases:
    - 脆糖桃氣可頌
    - 星巴克 Starbucks脆糖桃氣可頌
    - 星巴克 Starbucks 脆糖桃氣可頌
revision:
  revision_id: google-sheet-2026-08-22-nut-00129
serving:
...
此文件保存試算表記錄 NUT-00129 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
