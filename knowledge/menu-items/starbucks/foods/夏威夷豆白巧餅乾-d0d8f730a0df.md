...
type: Food Menu Item
title: 星巴克 夏威夷豆白巧餅乾
description: 星巴克台灣官方 2026-07-22 食品營養表所列「夏威夷豆白巧餅乾」每份營養資料。
...
food:
  id: food:tw:menu:starbucks:d0d8f730a0df
  kind: menu_item
  market: TW
  brand: 星巴克
  name: 夏威夷豆白巧餅乾
  ...
  aliases:
    ...
    - Starbucks 夏威夷豆白巧餅乾
revision:
  revision_id: official-table-2026-07-22-d0d8f730a0df
  source_version: 2026-07-22
  source_image: food-04.png
serving:
  description: 官方表格所列一份（50 公克）
  amount: 50
  unit: g
nutrition:
  - basis: per_serving
...
官方營養表提供一份 50 公克的熱量與八項營養數值；本文件保留官方每份基準，不補齊未提供欄位。[^starbucks-food-2026-07-22]
