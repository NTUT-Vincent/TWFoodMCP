...
type: Food Menu Item
title: 星巴克 檸檬瑪德蓮佐冰淇淋
description: 星巴克台灣官方 2026-07-22 食品營養表所列「檸檬瑪德蓮佐冰淇淋」每份營養資料。
...
food:
  id: food:tw:menu:starbucks:232c1c43d046
  kind: menu_item
  market: TW
  brand: 星巴克
  name: 檸檬瑪德蓮佐冰淇淋
  ...
  aliases:
    ...
    - Starbucks 檸檬瑪德蓮佐冰淇淋
revision:
  revision_id: official-table-2026-07-22-232c1c43d046
  source_version: 2026-07-22
  source_image: food-03.png
serving:
  description: 官方表格所列一份（125 公克）
  amount: 125
  unit: g
nutrition:
  - basis: per_serving
...
官方營養表提供一份 125 公克的熱量與八項營養數值；本文件保留官方每份基準，不補齊未提供欄位。[^starbucks-food-2026-07-22]
