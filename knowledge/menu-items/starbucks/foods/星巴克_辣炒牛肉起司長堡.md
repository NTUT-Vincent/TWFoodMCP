...
type: Food Menu Item
title: 星巴克 辣炒牛肉起司長堡
description: 星巴克台灣官方 2026-07-22 食品營養表所列「辣炒牛肉起司長堡」每份營養資料。
...
food:
  id: food:tw:menu:starbucks:335409ec7883
  kind: menu_item
  market: TW
  brand: 星巴克
  name: 辣炒牛肉起司長堡
  ...
  aliases:
    ...
    - Starbucks 辣炒牛肉起司長堡
revision:
  revision_id: official-table-2026-07-22-335409ec7883
  source_version: 2026-07-22
  source_image: food-01.png
serving:
  description: 官方表格所列一份（180 公克）
  amount: 180
  unit: g
nutrition:
  - basis: per_serving
...
官方營養表提供一份 180 公克的熱量與八項營養數值；本文件保留官方每份基準，不補齊未提供欄位。[^starbucks-food-2026-07-22]
