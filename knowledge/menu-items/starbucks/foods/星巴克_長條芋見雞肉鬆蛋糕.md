...
type: Food Menu Item
title: 星巴克 長條芋見雞肉鬆蛋糕
description: 星巴克台灣官方 2026-07-22 食品營養表所列「長條芋見雞肉鬆蛋糕」每份營養資料。
...
food:
  id: food:tw:menu:starbucks:c6700c85b756
  kind: menu_item
  market: TW
  brand: 星巴克
  name: 長條芋見雞肉鬆蛋糕
  ...
  aliases:
    ...
    - Starbucks 長條芋見雞肉鬆蛋糕
revision:
  revision_id: official-table-2026-07-22-c6700c85b756
  source_version: 2026-07-22
  source_image: food-03.png
serving:
  description: 官方表格所列一份（450 公克）
  amount: 450
  unit: g
nutrition:
  - basis: per_serving
    values:
      ...
      protein_g: 30.2
      fat_g: 59
      saturated_fat_g: 31.1
      trans_fat_g: 0
      carbohydrate_g: 166.1
      sugar_g: 58.1
      sodium_mg: 1157
quality:
...
官方營養表提供一份 450 公克的熱量與八項營養數值；本文件保留官方每份基準，不補齊未提供欄位。[^starbucks-food-2026-07-22]
