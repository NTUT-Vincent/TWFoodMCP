...
type: Food Menu Item
title: 星巴克 六吋經典起司蛋糕
description: 星巴克台灣官方 2026-07-22 食品營養表所列「六吋經典起司蛋糕」每份營養資料。
...
food:
  id: food:tw:menu:starbucks:360ece0f266f
  kind: menu_item
  market: TW
  brand: 星巴克
  name: 六吋經典起司蛋糕
  ...
  aliases:
    ...
    - Starbucks 六吋經典起司蛋糕
revision:
  revision_id: official-table-2026-07-22-360ece0f266f
  source_version: 2026-07-22
  source_image: food-03.png
serving:
  description: 官方表格所列一份（580 公克）
  amount: 580
  unit: g
nutrition:
  - basis: per_serving
    values:
      ...
      protein_g: 32.5
      fat_g: 160.1
      saturated_fat_g: 101.5
      trans_fat_g: 2.3
      carbohydrate_g: 135.1
      sugar_g: 91.1
      sodium_mg: 1433
quality:
...
官方營養表提供一份 580 公克的熱量與八項營養數值；本文件保留官方每份基準，不補齊未提供欄位。[^starbucks-food-2026-07-22]
