...
type: Food Menu Item
title: 星巴克 雙起司軟歐麵包
description: 星巴克台灣官方 2026-07-22 食品營養表所列「雙起司軟歐麵包」每份營養資料。
...
food:
  id: food:tw:menu:starbucks:d1fabef64941
  kind: menu_item
  market: TW
  brand: 星巴克
  name: 雙起司軟歐麵包
  ...
  aliases:
    ...
    - Starbucks 雙起司軟歐麵包
revision:
  revision_id: official-table-2026-07-22-d1fabef64941
  source_version: 2026-07-22
  source_image: food-01.png
serving:
  description: 官方表格所列一份（104 公克）
  amount: 104
  unit: g
nutrition:
  - basis: per_serving
...
官方營養表提供一份 104 公克的熱量與八項營養數值；本文件保留官方每份基準，不補齊未提供欄位。[^starbucks-food-2026-07-22]
