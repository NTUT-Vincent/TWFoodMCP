...
type: Food Menu Item
title: 星巴克 柚香蜂蜜波士頓派
description: 星巴克台灣官方 2026-07-22 食品營養表所列「柚香蜂蜜波士頓派」每份營養資料。
...
food:
  id: food:tw:menu:starbucks:3a24fdc4ddec
  kind: menu_item
  market: TW
  brand: 星巴克
  name: 柚香蜂蜜波士頓派
  ...
  aliases:
    ...
    - Starbucks 柚香蜂蜜波士頓派
revision:
  revision_id: official-table-2026-07-22-3a24fdc4ddec
  source_version: 2026-07-22
  source_image: food-02.png
serving:
  description: 官方表格所列一份（58 公克）
  amount: 58
  unit: g
nutrition:
  - basis: per_serving
...
官方營養表提供一份 58 公克的熱量與八項營養數值；本文件保留官方每份基準，不補齊未提供欄位。[^starbucks-food-2026-07-22]
