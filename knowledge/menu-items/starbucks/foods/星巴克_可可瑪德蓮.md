...
type: Food Menu Item
title: 星巴克 可可瑪德蓮
description: 星巴克台灣官方 2026-07-22 食品營養表所列「可可瑪德蓮」每份營養資料。
...
food:
  id: food:tw:menu:starbucks:b49fbdefd076
  kind: menu_item
  market: TW
  brand: 星巴克
  name: 可可瑪德蓮
  ...
  aliases:
    ...
    - Starbucks 可可瑪德蓮
revision:
  revision_id: official-table-2026-07-22-b49fbdefd076
  source_version: 2026-07-22
  source_image: food-04.png
serving:
  description: 官方表格所列一份（45 公克）
  amount: 45
  unit: g
nutrition:
  - basis: per_serving
...
官方營養表提供一份 45 公克的熱量與八項營養數值；本文件保留官方每份基準，不補齊未提供欄位。[^starbucks-food-2026-07-22]
