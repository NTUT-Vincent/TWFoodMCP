...
type: Food Menu Item
title: 星巴克 冰伯爵茶那堤（大杯）
description: 星巴克台灣官方商品頁所列「冰伯爵茶那堤」大杯的熱量、糖與咖啡因資料。
...
food:
  id: food:tw:menu:starbucks:drink-913-grande
  kind: menu_item
  market: TW
  brand: 星巴克
  name: 冰伯爵茶那堤
...
官方商品頁提供大杯的 `caffeine_mg`、`energy_kcal`、`sugar_g`；本文件保留官方每份基準，不推測其他營養欄位。[^starbucks-drink-913-2026-08-05]
