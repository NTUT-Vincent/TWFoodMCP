...
type: Food Menu Item
title: 星巴克 濃縮咖啡（Solo）
description: 星巴克台灣官方商品頁所列「濃縮咖啡」Solo的熱量、糖與咖啡因資料。
...
food:
  id: food:tw:menu:starbucks:drink-695-solo
  kind: menu_item
  market: TW
  brand: 星巴克
  name: 濃縮咖啡
...
官方商品頁提供Solo的 `caffeine_mg`、`energy_kcal`、`sugar_g`；本文件保留官方每份基準，不推測其他營養欄位。[^starbucks-drink-695-2026-08-05]
