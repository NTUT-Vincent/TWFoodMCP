...
food:
  id: food:tw:menu:starbucks:starbucks_比利時風格鬆餅
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 比利時風格鬆餅
  aliases:
    - 比利時風格鬆餅
    - 星巴克 Starbucks比利時風格鬆餅
    - 星巴克 Starbucks 比利時風格鬆餅
revision:
  revision_id: google-sheet-2026-08-22-nut-00098
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:0faaf8ac8350
  existing_title: 星巴克 比利時風格鬆餅
  existing_concept: /menu-items/starbucks/foods/比利時風格鬆餅-0faaf8ac8350.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00098 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 比利時風格鬆餅](/menu-items/starbucks/foods/比利時風格鬆餅-0faaf8ac8350.md)。
