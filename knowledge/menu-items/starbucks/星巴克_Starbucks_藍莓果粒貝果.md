...
food:
  id: food:tw:menu:starbucks:starbucks_藍莓果粒貝果
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 藍莓果粒貝果
  aliases:
    - 藍莓果粒貝果
    - 星巴克 Starbucks藍莓果粒貝果
    - 星巴克 Starbucks 藍莓果粒貝果
revision:
  revision_id: google-sheet-2026-08-22-nut-00178
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:ffd9fb1fdc9e
  existing_title: 星巴克 藍莓果粒貝果
  existing_concept: /menu-items/starbucks/foods/藍莓果粒貝果-ffd9fb1fdc9e.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00178 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 藍莓果粒貝果](/menu-items/starbucks/foods/藍莓果粒貝果-ffd9fb1fdc9e.md)。
