...
food:
  id: food:tw:menu:starbucks:starbucks_馬斯卡邦輕乳蛋糕
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 馬斯卡邦輕乳蛋糕
  aliases:
    - 馬斯卡邦輕乳蛋糕
    - 星巴克 Starbucks馬斯卡邦輕乳蛋糕
    - 星巴克 Starbucks 馬斯卡邦輕乳蛋糕
revision:
  revision_id: google-sheet-2026-08-22-nut-00136
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:3b89e973456b
  existing_title: 星巴克 馬斯卡邦輕乳蛋糕
  existing_concept: /menu-items/starbucks/foods/馬斯卡邦輕乳蛋糕-3b89e973456b.md
  comparison:
    corroborated: true
    compared:
      - &a1
      ...
      - &a3
        field: fat_g
        candidate_value: 14.3
        official_value: 14.3
        delta: 0
        tolerance: 0.28600000000000003
    matched:
      - *a1
      - *a2
      - *a3
...
此文件保存試算表記錄 NUT-00136 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 馬斯卡邦輕乳蛋糕](/menu-items/starbucks/foods/馬斯卡邦輕乳蛋糕-3b89e973456b.md)。
