...
food:
  id: food:tw:menu:starbucks:starbucks_松露生巧克力蛋糕
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 松露生巧克力蛋糕
  aliases:
    - 松露生巧克力蛋糕
    - 星巴克 Starbucks松露生巧克力蛋糕
    - 星巴克 Starbucks 松露生巧克力蛋糕
revision:
  revision_id: google-sheet-2026-08-22-nut-00112
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:c5541a3321b2
  existing_title: 星巴克 經典咖啡松露生巧克力蛋糕
  existing_concept: /menu-items/starbucks/foods/經典咖啡松露生巧克力蛋糕-c5541a3321b2.md
  comparison:
    corroborated: false
    compared:
      - &a2
      ...
      - &a1
        field: fat_g
        candidate_value: 20.2
        official_value: 19.9
        delta: 0.3000000000000007
        tolerance: 0.39799999999999996
    matched:
      - *a1
    mismatched:
      - *a2
...
此文件保存試算表記錄 NUT-00112 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值需要衝突審查：[星巴克 經典咖啡松露生巧克力蛋糕](/menu-items/starbucks/foods/經典咖啡松露生巧克力蛋糕-c5541a3321b2.md)。
