...
food:
  id: food:tw:menu:starbucks:starbucks_焦糖香蕉核果生乳捲
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 焦糖香蕉核果生乳捲
  aliases:
    - 焦糖香蕉核果生乳捲
    - 星巴克 Starbucks焦糖香蕉核果生乳捲
    - 星巴克 Starbucks 焦糖香蕉核果生乳捲
revision:
  revision_id: google-sheet-2026-08-22-nut-00144
serving:
...
此文件保存試算表記錄 NUT-00144 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
