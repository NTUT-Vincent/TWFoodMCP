...
food:
  id: food:tw:menu:starbucks:starbucks_義式番茄起司捲
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 義式番茄起司捲
  aliases:
    - 義式番茄起司捲
    - 星巴克 Starbucks義式番茄起司捲
    - 星巴克 Starbucks 義式番茄起司捲
revision:
  revision_id: google-sheet-2026-08-22-nut-00156
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:698b37baa693
  existing_title: 星巴克 義式番茄起司捲
  existing_concept: /menu-items/starbucks/foods/義式番茄起司捲-698b37baa693.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 312.3
        official_value: 312.3
        delta: 0
        tolerance: 3.123
      - &a2
        field: protein_g
...
此文件保存試算表記錄 NUT-00156 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 義式番茄起司捲](/menu-items/starbucks/foods/義式番茄起司捲-698b37baa693.md)。
