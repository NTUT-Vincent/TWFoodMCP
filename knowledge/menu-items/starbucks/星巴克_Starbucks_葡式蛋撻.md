...
food:
  id: food:tw:menu:starbucks:starbucks_葡式蛋撻
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 葡式蛋撻
  aliases:
    ...
    - 星巴克 Starbucks 葡式蛋撻
revision:
  revision_id: google-sheet-2026-08-22-nut-00158
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:1c87c19552a5
  existing_title: 星巴克 葡式蛋撻
  existing_concept: /menu-items/starbucks/foods/葡式蛋撻-1c87c19552a5.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 180.9
        official_value: 180.9
        delta: 0
        tolerance: 1.8090000000000002
      - &a2
        field: protein_g
        candidate_value: 3.6
        official_value: 3.6
...
此文件保存試算表記錄 NUT-00158 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 葡式蛋撻](/menu-items/starbucks/foods/葡式蛋撻-1c87c19552a5.md)。
