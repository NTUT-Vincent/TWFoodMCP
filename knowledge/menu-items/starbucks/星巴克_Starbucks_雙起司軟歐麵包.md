...
food:
  id: food:tw:menu:starbucks:starbucks_雙起司軟歐麵包
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 雙起司軟歐麵包
  aliases:
    - 雙起司軟歐麵包
    - 星巴克 Starbucks雙起司軟歐麵包
    - 星巴克 Starbucks 雙起司軟歐麵包
revision:
  revision_id: google-sheet-2026-08-22-nut-00180
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:d1fabef64941
  existing_title: 星巴克 雙起司軟歐麵包
  existing_concept: /menu-items/starbucks/foods/雙起司軟歐麵包-d1fabef64941.md
  comparison:
    corroborated: true
    compared:
      - &a1
      ...
      - &a3
        field: fat_g
        candidate_value: 11.9
        official_value: 11.9
        delta: 0
        tolerance: 0.23800000000000002
    matched:
      - *a1
      - *a2
      - *a3
...
此文件保存試算表記錄 NUT-00180 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 雙起司軟歐麵包](/menu-items/starbucks/foods/雙起司軟歐麵包-d1fabef64941.md)。
