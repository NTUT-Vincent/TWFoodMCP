...
food:
  id: food:tw:menu:starbucks:starbucks_草莓流芯輕乳蛋糕
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 草莓流芯輕乳蛋糕
  aliases:
    - 草莓流芯輕乳蛋糕
    - 星巴克 Starbucks草莓流芯輕乳蛋糕
    - 星巴克 Starbucks 草莓流芯輕乳蛋糕
revision:
  revision_id: google-sheet-2026-08-22-nut-00131
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:8eb281d22271
  existing_title: 星巴克 黑芝麻可可千層薄餅
  existing_concept: /menu-items/starbucks/foods/黑芝麻可可千層薄餅-8eb281d22271.md
  comparison:
    corroborated: false
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00131 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值需要衝突審查：[星巴克 黑芝麻可可千層薄餅](/menu-items/starbucks/foods/黑芝麻可可千層薄餅-8eb281d22271.md)。
