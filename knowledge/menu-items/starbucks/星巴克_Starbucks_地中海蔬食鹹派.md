...
food:
  id: food:tw:menu:starbucks:starbucks_地中海蔬食鹹派
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 地中海蔬食鹹派
  aliases:
    - 地中海蔬食鹹派
    - 星巴克 Starbucks地中海蔬食鹹派
    - 星巴克 Starbucks 地中海蔬食鹹派
revision:
  revision_id: google-sheet-2026-08-22-nut-00106
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:a5ff2d4f1ea9
  existing_title: 星巴克 地中海蔬食鹹派
  existing_concept: /menu-items/starbucks/foods/地中海蔬食鹹派-a5ff2d4f1ea9.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 272.6
        official_value: 272.6
        delta: 0
        tolerance: 2.7260000000000004
      - &a2
        field: protein_g
        candidate_value: 5.3
        official_value: 5.3
...
此文件保存試算表記錄 NUT-00106 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 地中海蔬食鹹派](/menu-items/starbucks/foods/地中海蔬食鹹派-a5ff2d4f1ea9.md)。
