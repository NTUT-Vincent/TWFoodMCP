---
type: Food Product
title: 星巴克 Starbucks 紅心芭樂蘋果燕麥優格
...
food:
  id: food:tw:menu:starbucks:starbucks_紅心芭樂蘋果燕麥優格
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 紅心芭樂蘋果燕麥優格
  aliases:
    - 紅心芭樂蘋果燕麥優格
    - 星巴克 Starbucks紅心芭樂蘋果燕麥優格
    - 星巴克 Starbucks 紅心芭樂蘋果燕麥優格
revision:
  revision_id: google-sheet-2026-08-22-nut-00121
serving:
...
此文件保存試算表記錄 NUT-00121 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
