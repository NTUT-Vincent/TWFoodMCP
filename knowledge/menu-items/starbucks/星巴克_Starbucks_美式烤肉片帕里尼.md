...
food:
  id: food:tw:menu:starbucks:starbucks_美式烤肉片帕里尼
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 美式烤肉片帕里尼
  aliases:
    - 美式烤肉片帕里尼
    - 星巴克 Starbucks美式烤肉片帕里尼
    - 星巴克 Starbucks 美式烤肉片帕里尼
revision:
  revision_id: google-sheet-2026-08-22-nut-00122
serving:
...
此文件保存試算表記錄 NUT-00122 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
