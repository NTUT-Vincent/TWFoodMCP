...
food:
  id: food:tw:menu:starbucks:starbucks_法式可頌
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 法式可頌
  aliases:
    ...
    - 星巴克 Starbucks 法式可頌
revision:
  revision_id: google-sheet-2026-08-22-nut-00115
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:ba0d3bb98d5f
  existing_title: 星巴克 法式可頌
  existing_concept: /menu-items/starbucks/foods/法式可頌-ba0d3bb98d5f.md
  comparison:
    corroborated: true
    compared:
      - &a1
      ...
      - &a3
        field: fat_g
        candidate_value: 11.8
        official_value: 11.8
        delta: 0
        tolerance: 0.23600000000000002
    matched:
      - *a1
      - *a2
      - *a3
...
此文件保存試算表記錄 NUT-00115 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 法式可頌](/menu-items/starbucks/foods/法式可頌-ba0d3bb98d5f.md)。
