...
food:
  id: food:tw:menu:starbucks:starbucks_起司牛肉可頌
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 起司牛肉可頌
  aliases:
    - 起司牛肉可頌
    - 星巴克 Starbucks起司牛肉可頌
    - 星巴克 Starbucks 起司牛肉可頌
revision:
  revision_id: google-sheet-2026-08-22-nut-00132
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:a5a80f7d53ba
  existing_title: 星巴克 起司牛肉可頌
  existing_concept: /menu-items/starbucks/foods/起司牛肉可頌-a5a80f7d53ba.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00132 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 起司牛肉可頌](/menu-items/starbucks/foods/起司牛肉可頌-a5a80f7d53ba.md)。
