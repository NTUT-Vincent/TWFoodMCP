...
food:
  id: food:tw:menu:starbucks:starbucks_法式烤布蕾瑪德蓮
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 法式烤布蕾瑪德蓮
  aliases:
    - 法式烤布蕾瑪德蓮
    - 星巴克 Starbucks法式烤布蕾瑪德蓮
    - 星巴克 Starbucks 法式烤布蕾瑪德蓮
revision:
  revision_id: google-sheet-2026-08-22-nut-00117
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:967a92bef554
  existing_title: 星巴克 法式烤布蕾瑪德蓮
  existing_concept: /menu-items/starbucks/foods/法式烤布蕾瑪德蓮-967a92bef554.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 211.3
        official_value: 211.3
        delta: 0
        tolerance: 2.113
      - &a2
        field: protein_g
...
此文件保存試算表記錄 NUT-00117 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 法式烤布蕾瑪德蓮](/menu-items/starbucks/foods/法式烤布蕾瑪德蓮-967a92bef554.md)。
