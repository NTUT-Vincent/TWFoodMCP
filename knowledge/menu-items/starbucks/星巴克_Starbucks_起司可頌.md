...
food:
  id: food:tw:menu:starbucks:starbucks_起司可頌
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 起司可頌
  aliases:
    ...
    - 星巴克 Starbucks 起司可頌
revision:
  revision_id: google-sheet-2026-08-22-nut-00133
serving:
...
此文件保存試算表記錄 NUT-00133 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 起司可頌](/menu-items/starbucks/foods/起司可頌-1f2d19e95f47.md)。
