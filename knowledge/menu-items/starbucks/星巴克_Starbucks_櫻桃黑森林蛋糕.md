...
food:
  id: food:tw:menu:starbucks:starbucks_櫻桃黑森林蛋糕
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 櫻桃黑森林蛋糕
  aliases:
    - 櫻桃黑森林蛋糕
    - 星巴克 Starbucks櫻桃黑森林蛋糕
    - 星巴克 Starbucks 櫻桃黑森林蛋糕
revision:
  revision_id: google-sheet-2026-08-22-nut-00182
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:533d9f9b055f
  existing_title: 星巴克 櫻桃黑森林蛋糕
  existing_concept: /menu-items/starbucks/foods/櫻桃黑森林蛋糕-533d9f9b055f.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00182 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 櫻桃黑森林蛋糕](/menu-items/starbucks/foods/櫻桃黑森林蛋糕-533d9f9b055f.md)。
