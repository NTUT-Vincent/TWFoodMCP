...
food:
  id: food:tw:menu:starbucks:starbucks_焦糖千層蛋塔
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 焦糖千層蛋塔
  aliases:
    - 焦糖千層蛋塔
    - 星巴克 Starbucks焦糖千層蛋塔
    - 星巴克 Starbucks 焦糖千層蛋塔
revision:
  revision_id: google-sheet-2026-08-22-nut-00143
serving:
...
此文件保存試算表記錄 NUT-00143 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
