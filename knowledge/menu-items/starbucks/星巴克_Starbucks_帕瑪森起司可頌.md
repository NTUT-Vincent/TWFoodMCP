...
food:
  id: food:tw:menu:starbucks:starbucks_帕瑪森起司可頌
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 帕瑪森起司可頌
  aliases:
    - 帕瑪森起司可頌
    - 星巴克 Starbucks帕瑪森起司可頌
    - 星巴克 Starbucks 帕瑪森起司可頌
revision:
  revision_id: google-sheet-2026-08-22-nut-00111
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:1f2d19e95f47
  existing_title: 星巴克 起司可頌
  existing_concept: /menu-items/starbucks/foods/起司可頌-1f2d19e95f47.md
  comparison:
    corroborated: false
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 277
        official_value: 292.2
        delta: 15.199999999999989
        tolerance: 2.922
      - &a2
        field: protein_g
        candidate_value: 8
...
此文件保存試算表記錄 NUT-00111 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值需要衝突審查：[星巴克 起司可頌](/menu-items/starbucks/foods/起司可頌-1f2d19e95f47.md)。
