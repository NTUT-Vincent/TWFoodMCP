...
food:
  id: food:tw:menu:starbucks:starbucks_可可瑪德蓮
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 可可瑪德蓮
  aliases:
    ...
    - 星巴克 Starbucks 可可瑪德蓮
revision:
  revision_id: google-sheet-2026-08-22-nut-00100
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:b49fbdefd076
  existing_title: 星巴克 可可瑪德蓮
  existing_concept: /menu-items/starbucks/foods/可可瑪德蓮-b49fbdefd076.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 202.4
        official_value: 202.4
        delta: 0
        tolerance: 2.024
      - &a2
        field: protein_g
...
此文件保存試算表記錄 NUT-00100 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 可可瑪德蓮](/menu-items/starbucks/foods/可可瑪德蓮-b49fbdefd076.md)。
