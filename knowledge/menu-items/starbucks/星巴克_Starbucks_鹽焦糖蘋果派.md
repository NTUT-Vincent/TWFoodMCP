...
food:
  id: food:tw:menu:starbucks:starbucks_鹽焦糖蘋果派
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 鹽焦糖蘋果派
  aliases:
    - 鹽焦糖蘋果派
    - 星巴克 Starbucks鹽焦糖蘋果派
    - 星巴克 Starbucks 鹽焦糖蘋果派
revision:
  revision_id: google-sheet-2026-08-22-nut-00183
serving:
...
此文件保存試算表記錄 NUT-00183 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
