...
food:
  id: food:tw:menu:starbucks:starbucks_夏威夷豆白巧餅乾
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 夏威夷豆白巧餅乾
  aliases:
    - 夏威夷豆白巧餅乾
    - 星巴克 Starbucks夏威夷豆白巧餅乾
    - 星巴克 Starbucks 夏威夷豆白巧餅乾
revision:
  revision_id: google-sheet-2026-08-22-nut-00123
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:d0d8f730a0df
  existing_title: 星巴克 夏威夷豆白巧餅乾
  existing_concept: /menu-items/starbucks/foods/夏威夷豆白巧餅乾-d0d8f730a0df.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 238.4
        official_value: 238.4
        delta: 0
        tolerance: 2.384
      - &a2
        field: protein_g
      ...
      - &a3
        field: fat_g
        candidate_value: 11.35
        official_value: 11.35
        delta: 0
        tolerance: 0.227
    matched:
      - *a1
...
此文件保存試算表記錄 NUT-00123 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 夏威夷豆白巧餅乾](/menu-items/starbucks/foods/夏威夷豆白巧餅乾-d0d8f730a0df.md)。
