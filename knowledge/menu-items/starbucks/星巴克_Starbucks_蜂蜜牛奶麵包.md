...
food:
  id: food:tw:menu:starbucks:starbucks_蜂蜜牛奶麵包
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 蜂蜜牛奶麵包
  aliases:
    - 蜂蜜牛奶麵包
    - 星巴克 Starbucks蜂蜜牛奶麵包
    - 星巴克 Starbucks 蜂蜜牛奶麵包
revision:
  revision_id: google-sheet-2026-08-22-nut-00161
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:959b0c4b9e7b
  existing_title: 星巴克 蜂蜜牛奶麵包
  existing_concept: /menu-items/starbucks/foods/蜂蜜牛奶麵包-959b0c4b9e7b.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00161 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 蜂蜜牛奶麵包](/menu-items/starbucks/foods/蜂蜜牛奶麵包-959b0c4b9e7b.md)。
