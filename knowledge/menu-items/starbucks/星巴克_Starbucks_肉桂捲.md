...
food:
  id: food:tw:menu:starbucks:starbucks_肉桂捲
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 肉桂捲
  aliases:
    ...
    - 星巴克 Starbucks 肉桂捲
revision:
  revision_id: google-sheet-2026-08-22-nut-00107
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:d9958eb7d202
  existing_title: 星巴克 經典核桃肉桂捲
  existing_concept: /menu-items/starbucks/foods/經典核桃肉桂捲-d9958eb7d202.md
  comparison:
    corroborated: false
    compared:
      - &a1
      ...
      - &a3
        ...
        official_value: 22.1
        delta: 4.800000000000001
        tolerance: 0.44200000000000006
    matched: []
    mismatched:
      - *a1
      - *a2
...
此文件保存試算表記錄 NUT-00107 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值需要衝突審查：[星巴克 經典核桃肉桂捲](/menu-items/starbucks/foods/經典核桃肉桂捲-d9958eb7d202.md)。
