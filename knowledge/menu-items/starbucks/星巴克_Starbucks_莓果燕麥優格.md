...
food:
  id: food:tw:menu:starbucks:starbucks_莓果燕麥優格
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 莓果燕麥優格
  aliases:
    - 莓果燕麥優格
    - 星巴克 Starbucks莓果燕麥優格
    - 星巴克 Starbucks 莓果燕麥優格
revision:
  revision_id: google-sheet-2026-08-22-nut-00140
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:a76f5e7f7f34
  existing_title: 星巴克 莓果燕麥優格
  existing_concept: /menu-items/starbucks/foods/莓果燕麥優格-a76f5e7f7f34.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00140 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 莓果燕麥優格](/menu-items/starbucks/foods/莓果燕麥優格-a76f5e7f7f34.md)。
