...
food:
  id: food:tw:menu:starbucks:starbucks_蜂蜜優格
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 蜂蜜優格
  aliases:
    ...
    - 星巴克 Starbucks 蜂蜜優格
revision:
  revision_id: google-sheet-2026-08-22-nut-00162
serving:
...
此文件保存試算表記錄 NUT-00162 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
