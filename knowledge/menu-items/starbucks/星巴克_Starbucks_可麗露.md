...
food:
  id: food:tw:menu:starbucks:starbucks_可麗露
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 可麗露
  aliases:
    ...
    - 星巴克 Starbucks 可麗露
revision:
  revision_id: google-sheet-2026-08-22-nut-00101
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:51439432c1f2
  existing_title: 星巴克 經典可麗露
  existing_concept: /menu-items/starbucks/foods/經典可麗露-51439432c1f2.md
  comparison:
    corroborated: false
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00101 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值需要衝突審查：[星巴克 經典可麗露](/menu-items/starbucks/foods/經典可麗露-51439432c1f2.md)。
