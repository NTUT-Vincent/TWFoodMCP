...
food:
  id: food:tw:menu:starbucks:starbucks_蘋果卡士達蛋撻
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 蘋果卡士達蛋撻
  aliases:
    - 蘋果卡士達蛋撻
    - 星巴克 Starbucks蘋果卡士達蛋撻
    - 星巴克 Starbucks 蘋果卡士達蛋撻
revision:
  revision_id: google-sheet-2026-08-22-nut-00181
serving:
...
此文件保存試算表記錄 NUT-00181 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
