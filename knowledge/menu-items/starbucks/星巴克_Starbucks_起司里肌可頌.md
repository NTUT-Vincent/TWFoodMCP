...
food:
  id: food:tw:menu:starbucks:starbucks_起司里肌可頌
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 起司里肌可頌
  aliases:
    - 起司里肌可頌
    - 星巴克 Starbucks起司里肌可頌
    - 星巴克 Starbucks 起司里肌可頌
revision:
  revision_id: google-sheet-2026-08-22-nut-00134
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:9a91164c7da1
  existing_title: 星巴克 起司里肌可頌
  existing_concept: /menu-items/starbucks/foods/起司里肌可頌-9a91164c7da1.md
  comparison:
    corroborated: true
    compared:
      - &a1
        ...
        official_value: 402
        delta: 0
        tolerance: 4.0200000000000005
      - &a2
        field: protein_g
        candidate_value: 12.2
        official_value: 12.2
        delta: 0
        tolerance: 0.244
      - &a3
        field: fat_g
        candidate_value: 27.4
        official_value: 27.4
        delta: 0
        tolerance: 0.5479999999999999
    matched:
      - *a1
      - *a2
      - *a3
...
此文件保存試算表記錄 NUT-00134 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 起司里肌可頌](/menu-items/starbucks/foods/起司里肌可頌-9a91164c7da1.md)。
