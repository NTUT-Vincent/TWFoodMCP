...
food:
  id: food:tw:menu:starbucks:starbucks_溫野菜
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 溫野菜
  aliases:
    ...
    - 星巴克 Starbucks 溫野菜
revision:
  revision_id: google-sheet-2026-08-22-nut-00151
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:c095ab0c3908
  existing_title: 星巴克 溫野菜
  existing_concept: /menu-items/starbucks/foods/溫野菜-c095ab0c3908.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00151 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 溫野菜](/menu-items/starbucks/foods/溫野菜-c095ab0c3908.md)。
