...
food:
  id: food:tw:menu:starbucks:starbucks_檸檬瑪德蓮
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 檸檬瑪德蓮
  aliases:
    ...
    - 星巴克 Starbucks 檸檬瑪德蓮
revision:
  revision_id: google-sheet-2026-08-22-nut-00172
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:95742c31ab6c
  existing_title: 星巴克 檸檬瑪德蓮
  existing_concept: /menu-items/starbucks/foods/檸檬瑪德蓮-95742c31ab6c.md
  comparison:
    corroborated: true
    compared:
      - &a1
      ...
      - &a3
        field: fat_g
        candidate_value: 11.7
        official_value: 11.7
        delta: 0
        tolerance: 0.23399999999999999
    matched:
      - *a1
      - *a2
      - *a3
...
此文件保存試算表記錄 NUT-00172 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 檸檬瑪德蓮](/menu-items/starbucks/foods/檸檬瑪德蓮-95742c31ab6c.md)。
