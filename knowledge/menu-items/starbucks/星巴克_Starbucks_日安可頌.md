...
food:
  id: food:tw:menu:starbucks:starbucks_日安可頌
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 日安可頌
  aliases:
    ...
    - 星巴克 Starbucks 日安可頌
revision:
  revision_id: google-sheet-2026-08-22-nut-00097
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:b70940cdedaa
  existing_title: 星巴克 日安可頌
  existing_concept: /menu-items/starbucks/foods/日安可頌-b70940cdedaa.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 302.4
        official_value: 302.4
        delta: 0
        tolerance: 3.024
      - &a2
        field: protein_g
...
此文件保存試算表記錄 NUT-00097 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 日安可頌](/menu-items/starbucks/foods/日安可頌-b70940cdedaa.md)。
