...
food:
  id: food:tw:menu:starbucks:starbucks_軟法麵包
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 軟法麵包
  aliases:
    ...
    - 星巴克 Starbucks 軟法麵包
revision:
  revision_id: google-sheet-2026-08-22-nut-00141
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:starbucks:b366a9ad14fd
  existing_title: 星巴克 軟法麵包
  existing_concept: /menu-items/starbucks/foods/軟法麵包-b366a9ad14fd.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00141 的營養觀測。[^sheet-source-6d43b0dddc8f] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[星巴克 軟法麵包](/menu-items/starbucks/foods/軟法麵包-b366a9ad14fd.md)。
