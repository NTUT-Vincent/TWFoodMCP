...
type: Food Product
title: 麥當勞 OREO冰炫風
description: 麥當勞台灣官方品項「OREO冰炫風」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/mcflurry.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/mcflurry.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200081&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:mcflurry
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: OREO冰炫風
  aliases:
    ...
    - mcflurry
revision:
  revision_id: official-api-200081-2026-08-01
  source_product_id: "200081"
serving:
  description: 官方每份 185.2 公克
  amount: 185.2
  unit: g
nutrition:
  - basis: per_serving
