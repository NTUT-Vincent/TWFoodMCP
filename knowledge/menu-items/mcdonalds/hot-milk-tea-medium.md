...
type: Food Product
title: 麥當勞 奶茶 (熱)
description: 麥當勞台灣官方品項「奶茶 (熱)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/hot-milk-tea-medium.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/hot-milk-tea-medium.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200057&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:hot-milk-tea-medium
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 奶茶 (熱)
  aliases:
    ...
    - hot-milk-tea-medium
revision:
  revision_id: official-api-200057-2026-08-01
  source_product_id: "200057"
serving:
  description: 官方每份 377 公克
  amount: 377
  unit: g
nutrition:
  - basis: per_serving
