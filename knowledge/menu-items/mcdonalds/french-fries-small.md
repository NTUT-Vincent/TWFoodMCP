...
type: Food Product
title: 麥當勞 薯條(小)
description: 麥當勞台灣官方品項「薯條(小)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/french-fries-small.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/french-fries-small.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200076&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:french-fries-small
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 薯條(小)
  aliases:
    ...
    - french-fries-small
revision:
  revision_id: official-api-200076-2026-08-01
  source_product_id: "200076"
serving:
  description: 官方每份 78 公克
  amount: 78
  unit: g
nutrition:
  - basis: per_serving
