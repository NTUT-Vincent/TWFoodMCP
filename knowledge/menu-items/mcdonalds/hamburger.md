...
type: Food Product
title: 麥當勞 漢堡
description: 麥當勞台灣官方品項「漢堡」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/hamburger.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200006&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:hamburger
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 漢堡
  ...
  - hamburger
revision:
  revision_id: official-api-200006-2026-08-01
  source_product_id: '200006'
serving:
  description: 官方每份 102.27 公克
  amount: 102.27
  unit: g
nutrition:
- basis: per_serving
