...
type: Food Product
title: 麥當勞 麥克鷄塊®(6塊)
description: 麥當勞台灣官方品項「麥克鷄塊®(6塊)」的每份營養資料，來源為官方 itemDetails API。
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/chicken-mcnuggets-6-pieces.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200015&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:chicken-mcnuggets-6-pieces
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 麥克鷄塊®(6塊)
...
revision:
  revision_id: official-api-200015-2026-08-01
  source_product_id: "200015"
serving:
