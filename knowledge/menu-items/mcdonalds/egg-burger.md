...
type: Food Product
title: 麥當勞 吉事蛋堡
description: 麥當勞台灣官方品項「吉事蛋堡」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/egg-burger.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200038&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:egg-burger
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 吉事蛋堡
  ...
  - egg-burger
revision:
  revision_id: official-api-200038-2026-08-01
  source_product_id: '200038'
serving:
  description: 官方每份 124.49 公克
  amount: 124.49
  unit: g
nutrition:
- basis: per_serving
