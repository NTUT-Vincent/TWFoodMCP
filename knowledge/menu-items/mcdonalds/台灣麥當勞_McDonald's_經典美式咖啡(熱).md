---
type: Food Product
title: 台灣麥當勞 McDonald's 經典美式咖啡(熱)
...
food:
  id: food:tw:menu:mcdonalds:mcdonalds_經典美式咖啡熱
  kind: menu_item
  market: TW
  ...
  aliases:
    - 經典美式咖啡(熱)
    - 台灣麥當勞 McDonald's經典美式咖啡(熱)
    - 台灣麥當勞 McDonald's 經典美式咖啡(熱)
revision:
  revision_id: google-sheet-2026-08-22-nut-00039
serving:
...
official_review_hint:
  ...
  existing_concept: /menu-items/mcdonalds/americano.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00039 的營養觀測。[^sheet-source-170fcc78d889] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[麥當勞 經典美式咖啡(熱)](/menu-items/mcdonalds/americano.md)。
