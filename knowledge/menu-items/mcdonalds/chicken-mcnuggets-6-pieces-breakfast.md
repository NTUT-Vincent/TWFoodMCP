---
type: Food Product
title: 麥當勞 麥克鷄塊(6塊/早餐)
description: 麥當勞台灣官方品項「麥克鷄塊(6塊/早餐)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/chicken-mcnuggets-6-pieces-breakfast.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/chicken-mcnuggets-6-pieces-breakfast.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200287&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:chicken-mcnuggets-6-pieces-breakfast
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 麥克鷄塊(6塊/早餐)
  aliases:
    ...
    - 麥當勞麥克鷄塊(6塊/早餐)
    - 麥當勞 麥克鷄塊(6塊/早餐)
    - McDonald's 麥克鷄塊(6塊/早餐)
    - chicken-mcnuggets-6-pieces-breakfast
revision:
  revision_id: official-api-200287-2026-08-01
  source_product_id: "200287"
serving:
  description: 官方每份 102 公克
  amount: 102
  unit: g
nutrition:
  - basis: per_serving
