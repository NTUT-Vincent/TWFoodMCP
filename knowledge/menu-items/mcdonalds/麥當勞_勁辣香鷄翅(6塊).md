...
type: Food Product
title: 麥當勞 勁辣香鷄翅(6塊)
description: 麥當勞台灣官方品項「勁辣香鷄翅(6塊)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/spicy-chicken-wing-6-pieces.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/spicy-chicken-wing-6-pieces.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200169&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:spicy-chicken-wing-6-pieces
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 勁辣香鷄翅(6塊)
  aliases:
    ...
    - 麥當勞 勁辣香鷄翅(6塊)
    - McDonald's 勁辣香鷄翅(6塊)
    - spicy-chicken-wing-6-pieces
revision:
  revision_id: official-api-200169-2026-08-01
  source_product_id: "200169"
serving:
  description: 官方每份 238.35 公克
  amount: 238.35
  unit: g
nutrition:
  - basis: per_serving
