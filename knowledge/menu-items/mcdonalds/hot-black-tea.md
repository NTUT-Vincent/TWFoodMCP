...
type: Food Product
title: 麥當勞 紅茶(熱)
description: 麥當勞台灣官方品項「紅茶(熱)」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/hot-black-tea.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200055&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:hot-black-tea
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 紅茶(熱)
  ...
  - hot-black-tea
revision:
  revision_id: official-api-200055-2026-08-01
  source_product_id: '200055'
serving:
