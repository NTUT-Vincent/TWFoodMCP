...
type: Food Product
title: 麥當勞 勁辣香鷄翅(2塊)
description: 麥當勞台灣官方品項「勁辣香鷄翅(2塊)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/spicy-chicken-wing-2-pieces.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/spicy-chicken-wing-2-pieces.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200018&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:spicy-chicken-wing-2-pieces
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 勁辣香鷄翅(2塊)
  aliases:
    ...
    - 麥當勞 勁辣香鷄翅(2塊)
    - McDonald's 勁辣香鷄翅(2塊)
    - spicy-chicken-wing-2-pieces
revision:
  revision_id: official-api-200018-2026-08-01
  source_product_id: "200018"
serving:
  description: 官方每份 79.45 公克
  amount: 79.45
  unit: g
nutrition:
  - basis: per_serving
