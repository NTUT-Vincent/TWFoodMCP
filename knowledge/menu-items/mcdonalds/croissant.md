...
type: Food Product
title: 麥當勞 原味可頌
description: 麥當勞台灣官方品項「原味可頌」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/croissant.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200050&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:croissant
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 原味可頌
  ...
  - croissant
revision:
  revision_id: official-api-200050-2026-08-01
  source_product_id: '200050'
serving:
  description: 官方每份 69 公克
  amount: 69
  unit: g
nutrition:
- basis: per_serving
