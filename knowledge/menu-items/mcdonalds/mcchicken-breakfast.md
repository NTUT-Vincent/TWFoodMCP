...
type: Food Product
title: 麥當勞 麥香鷄
description: 麥當勞台灣官方品項「麥香鷄」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/mcchicken-breakfast.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200331&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:mcchicken-breakfast
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 麥香鷄
  ...
  - mcchicken-breakfast
revision:
  revision_id: official-api-200331-2026-08-01
  source_product_id: '200331'
serving:
  description: 官方每份 167.38 公克
  amount: 167.38
  unit: g
nutrition:
- basis: per_serving
