...
type: Food Product
title: 麥當勞 水果袋(芭樂)
description: 麥當勞台灣官方品項「水果袋(芭樂)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/sliced-guava.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/sliced-guava.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200075&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:sliced-guava
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 水果袋(芭樂)
  aliases:
    ...
    - sliced-guava
revision:
  revision_id: official-api-200075-2026-08-01
  source_product_id: "200075"
serving:
  description: 官方每份 70 公克
  amount: 70
  unit: g
nutrition:
  - basis: per_serving
