...
type: Food Product
title: 麥當勞 蛋捲冰淇淋
description: 麥當勞台灣官方品項「蛋捲冰淇淋」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/ice-cream-cone.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200082&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:ice-cream-cone
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 蛋捲冰淇淋
  ...
  - ice-cream-cone
revision:
  revision_id: official-api-200082-2026-08-01
  source_product_id: '200082'
serving:
  description: 官方每份 93.8 公克
  amount: 93.8
  unit: g
nutrition:
- basis: per_serving
