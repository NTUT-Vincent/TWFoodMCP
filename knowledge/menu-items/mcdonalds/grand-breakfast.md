...
type: Food Product
title: 麥當勞 鷄塊鬆餅大早餐
description: 麥當勞台灣官方品項「鷄塊鬆餅大早餐」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/grand-breakfast.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200034&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:grand-breakfast
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 鷄塊鬆餅大早餐
  ...
  - grand-breakfast
revision:
  revision_id: official-api-200034-2026-08-01
  source_product_id: '200034'
serving:
  description: 官方每份 381.1 公克
  amount: 381.1
  unit: g
nutrition:
- basis: per_serving
