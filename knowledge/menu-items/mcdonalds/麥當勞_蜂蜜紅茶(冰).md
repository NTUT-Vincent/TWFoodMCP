...
type: Food Product
title: 麥當勞 蜂蜜紅茶(冰)
description: 麥當勞台灣官方品項「蜂蜜紅茶(冰)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/honey-black-tea-iced.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/honey-black-tea-iced.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200245&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:honey-black-tea-iced
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 蜂蜜紅茶(冰)
  aliases:
    ...
    - 麥當勞 蜂蜜紅茶(冰)
    - McDonald's 蜂蜜紅茶(冰)
    - honey-black-tea-iced
revision:
  revision_id: official-api-200245-2026-08-01
  source_product_id: "200245"
serving:
  description: 官方每份 450.02 公克
  amount: 450.02
  unit: g
nutrition:
  - basis: per_serving
