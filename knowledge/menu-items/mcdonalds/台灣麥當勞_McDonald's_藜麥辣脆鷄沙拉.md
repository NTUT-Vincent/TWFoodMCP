---
type: Food Product
title: 台灣麥當勞 McDonald's 藜麥辣脆鷄沙拉
...
food:
  id: food:tw:menu:mcdonalds:mcdonalds_藜麥辣脆鷄沙拉
  kind: menu_item
  market: TW
  ...
  aliases:
    - 藜麥辣脆鷄沙拉
    - 台灣麥當勞 McDonald's藜麥辣脆鷄沙拉
    - 台灣麥當勞 McDonald's 藜麥辣脆鷄沙拉
revision:
  revision_id: google-sheet-2026-08-22-nut-00050
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:200326
  existing_title: 麥當勞 藜麥辣脆鷄沙拉
  existing_concept: /menu-items/mcdonalds/200326.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 376.95
        official_value: 376.95
        delta: 0
        tolerance: 3.7695
      - &a2
        field: protein_g
      ...
      - &a8
        field: sodium_mg
        candidate_value: 683.4
        official_value: 683.4
        delta: 0
        tolerance: 13.668
    matched:
      - *a1
...
此文件保存試算表記錄 NUT-00050 的營養觀測。[^sheet-source-170fcc78d889] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[麥當勞 藜麥辣脆鷄沙拉](/menu-items/mcdonalds/200326.md)。
