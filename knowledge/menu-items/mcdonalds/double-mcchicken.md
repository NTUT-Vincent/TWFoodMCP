...
type: Food Product
title: 麥當勞 雙層麥香鷄
description: 麥當勞台灣官方品項「雙層麥香鷄」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/double-mcchicken.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200297&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:double-mcchicken
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 雙層麥香鷄
  ...
  - double-mcchicken
revision:
  revision_id: official-api-200297-2026-08-01
  source_product_id: '200297'
serving:
  description: 官方每份 225.38 公克
  amount: 225.38
  unit: g
nutrition:
- basis: per_serving
