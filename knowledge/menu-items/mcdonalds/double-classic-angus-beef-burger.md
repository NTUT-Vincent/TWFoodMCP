...
type: Food Product
title: 麥當勞 雙層四盎司牛肉堡
description: 麥當勞台灣官方品項「雙層四盎司牛肉堡」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/double-classic-angus-beef-burger.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200303&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:double-classic-angus-beef-burger
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 雙層四盎司牛肉堡
  ...
  - 麥當勞 雙層四盎司牛肉堡
  - McDonald's 雙層四盎司牛肉堡
  - double-classic-angus-beef-burger
revision:
  revision_id: official-api-200303-2026-08-01
  source_product_id: '200303'
serving:
  description: 官方每份 288.92 公克
  amount: 288.92
  unit: g
nutrition:
- basis: per_serving
