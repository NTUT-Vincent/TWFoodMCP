...
type: Food Product
title: 麥當勞 大蛋捲冰淇淋
description: 麥當勞台灣官方品項「大蛋捲冰淇淋」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/ice-cream-cone-large.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200083&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:ice-cream-cone-large
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 大蛋捲冰淇淋
...
revision:
  revision_id: official-api-200083-2026-08-01
  source_product_id: '200083'
serving:
  description: 官方每份 132.68 公克
  amount: 132.68
  unit: g
nutrition:
- basis: per_serving
