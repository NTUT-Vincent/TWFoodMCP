---
type: Food Product
title: 麥當勞 金選美式咖啡(冰)-大杯
description: 麥當勞台灣官方品項「金選美式咖啡(冰)-大杯」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/iced-select-brew-americano-large.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/iced-select-brew-americano-large.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200339&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:200339
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 金選美式咖啡(冰)-大杯
  aliases:
    ...
    - 麥當勞金選美式咖啡(冰)-大杯
    - 麥當勞 金選美式咖啡(冰)-大杯
    - McDonald's 金選美式咖啡(冰)-大杯
    - "200339"
revision:
  revision_id: official-api-200339-2026-08-01
  source_product_id: "200339"
serving:
  description: 官方每份 480 公克
  amount: 480
  unit: g
nutrition:
  - basis: per_serving
