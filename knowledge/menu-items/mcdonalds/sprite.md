...
type: Food Product
title: 麥當勞 雪碧(小)
description: 麥當勞台灣官方品項「雪碧(小)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/sprite.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/sprite.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200069&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:sprite
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 雪碧(小)
  aliases:
    ...
    - sprite
revision:
  revision_id: official-api-200069-2026-08-01
  source_product_id: "200069"
serving:
  description: 官方每份 450.1 公克
  amount: 450.1
  unit: g
nutrition:
  - basis: per_serving
