...
food:
  id: food:tw:menu:mcdonalds:mcdonalds_香芋派
  kind: menu_item
  market: TW
  ...
  aliases:
    - 香芋派
    - 台灣麥當勞 McDonald's香芋派
    - 台灣麥當勞 McDonald's 香芋派
revision:
  revision_id: google-sheet-2026-08-22-nut-00034
serving:
...
此文件保存試算表記錄 NUT-00034 的營養觀測。[^sheet-source-170fcc78d889] 它是未驗證 draft，不能直接用於營養計算。
