...
food:
  id: food:tw:menu:mcdonalds:mcdonalds_香草奶昔
  kind: menu_item
  market: TW
  ...
  aliases:
    - 香草奶昔
    - 台灣麥當勞 McDonald's香草奶昔
    - 台灣麥當勞 McDonald's 香草奶昔
revision:
  revision_id: google-sheet-2026-08-22-nut-00035
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:200337
  existing_title: 麥當勞 香草奶昔
  existing_concept: /menu-items/mcdonalds/200337.md
  comparison:
    corroborated: false
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 430
        official_value: 430.15
        delta: 0.14999999999997726
        tolerance: 4.3015
      - &a2
        field: protein_g
        candidate_value: 12.3
        official_value: 3.6
        delta: 8.700000000000001
        tolerance: 0.2
      - &a3
        field: fat_g
        candidate_value: 10.9
        official_value: 3
        delta: 7.9
        tolerance: 0.2
      - &a4
      ...
      - &a5
        ...
        candidate_value: 71.1
        official_value: 21
        delta: 50.099999999999994
        tolerance: 0.42
      - &a6
        field: sugar_g
        candidate_value: 50.4
        official_value: 14
        delta: 36.4
        tolerance: 0.28
      - &a7
        field: sodium_mg
        candidate_value: 285.3
        official_value: 90.7
        delta: 194.60000000000002
        tolerance: 5
    matched:
      - *a1
    mismatched:
...
此文件保存試算表記錄 NUT-00035 的營養觀測。[^sheet-source-170fcc78d889] 它是未驗證 draft，不能直接用於營養計算。
...
數值需要衝突審查：[麥當勞 香草奶昔](/menu-items/mcdonalds/200337.md)。
