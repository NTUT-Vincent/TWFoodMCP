---
type: Food Product
title: 麥當勞 檸檬風味紅茶(冰)(小)
description: 麥當勞台灣官方品項「檸檬風味紅茶(冰)(小)」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/iced-black-tea-lemon-flavor.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200104&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:iced-black-tea-lemon-flavor
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 檸檬風味紅茶(冰)(小)
  ...
  - 麥當勞檸檬風味紅茶(冰)(小)
  - 麥當勞 檸檬風味紅茶(冰)(小)
  - McDonald's 檸檬風味紅茶(冰)(小)
  - iced-black-tea-lemon-flavor
revision:
  revision_id: official-api-200104-2026-08-01
  source_product_id: '200104'
serving:
  description: 官方每份 450 公克
  amount: 450
  unit: g
nutrition:
- basis: per_serving
