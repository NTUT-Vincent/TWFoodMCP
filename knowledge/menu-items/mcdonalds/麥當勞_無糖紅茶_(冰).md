...
type: Food Product
title: 麥當勞 無糖紅茶 (冰)
description: 麥當勞台灣官方品項「無糖紅茶 (冰)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/iced-black-tea-sugar-free.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/iced-black-tea-sugar-free.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200098&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:iced-black-tea-sugar-free
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 無糖紅茶 (冰)
  aliases:
    ...
    - 麥當勞 無糖紅茶 (冰)
    - McDonald's 無糖紅茶 (冰)
    - iced-black-tea-sugar-free
revision:
  revision_id: official-api-200098-2026-08-01
  source_product_id: "200098"
serving:
