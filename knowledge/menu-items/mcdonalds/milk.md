...
type: Food Product
title: 麥當勞 鮮乳(盒裝)
description: 麥當勞台灣官方品項「鮮乳(盒裝)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/milk.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/milk.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200073&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:milk
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 鮮乳(盒裝)
  aliases:
    ...
    - milk
revision:
  revision_id: official-api-200073-2026-08-01
  source_product_id: "200073"
serving:
  description: 官方每份 220 公克
  amount: 220
  unit: g
nutrition:
  - basis: per_serving
