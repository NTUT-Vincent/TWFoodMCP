...
type: Food Product
title: 麥當勞 豬肉滿福堡
description: 麥當勞台灣官方品項「豬肉滿福堡」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/sausage-mcmuffin.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200027&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:sausage-mcmuffin
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 豬肉滿福堡
  ...
  - sausage-mcmuffin
revision:
  revision_id: official-api-200027-2026-08-01
  source_product_id: '200027'
serving:
  description: 官方每份 116.39 公克
  amount: 116.39
  unit: g
nutrition:
- basis: per_serving
