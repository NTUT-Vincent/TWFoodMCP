---
type: Food Product
title: 台灣麥當勞 McDonald's 金選美式咖啡(冰)
...
food:
  id: food:tw:menu:mcdonalds:mcdonalds_金選美式咖啡冰
  kind: menu_item
  market: TW
  ...
  aliases:
    - 金選美式咖啡(冰)
    - 台灣麥當勞 McDonald's金選美式咖啡(冰)
    - 台灣麥當勞 McDonald's 金選美式咖啡(冰)
revision:
  revision_id: google-sheet-2026-08-22-nut-00033
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:200334
  existing_title: 麥當勞 金選美式咖啡(冰)
  existing_concept: /menu-items/mcdonalds/200334.md
  comparison:
    corroborated: true
    compared:
      - &a1
...
此文件保存試算表記錄 NUT-00033 的營養觀測。[^sheet-source-170fcc78d889] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[麥當勞 金選美式咖啡(冰)](/menu-items/mcdonalds/200334.md)。
