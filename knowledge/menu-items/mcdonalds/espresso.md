...
type: Food Product
title: 麥當勞 義式濃縮咖啡(熱)
description: 麥當勞台灣官方品項「義式濃縮咖啡(熱)」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/espresso.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200114&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:espresso
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 義式濃縮咖啡(熱)
  ...
  - espresso
revision:
  revision_id: official-api-200114-2026-08-01
  source_product_id: '200114'
serving:
  description: 官方每份 45 公克
  amount: 45
  unit: g
nutrition:
- basis: per_serving
