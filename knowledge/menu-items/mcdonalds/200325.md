...
type: Food Product
title: 麥當勞 藜麥烤鷄沙拉
description: 麥當勞台灣官方品項「藜麥烤鷄沙拉」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/quinoa-salad-with-grilled-chicken-filet.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200325&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:200325
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 藜麥烤鷄沙拉
  ...
  - '200325'
revision:
  revision_id: official-api-200325-2026-08-01
  source_product_id: '200325'
serving:
  description: 官方每份 275.83 公克
  amount: 275.83
  unit: g
nutrition:
- basis: per_serving
