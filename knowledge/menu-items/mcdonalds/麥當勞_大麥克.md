...
type: Food Product
title: 麥當勞 大麥克
description: 麥當勞台灣官方品項「大麥克」的每份營養資料，來源為官方 itemDetails API。
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/big-mac.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200008&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  ...
  aliases:
    ...
    - big-mac
revision:
  revision_id: official-api-200008-2026-08-01
  source_product_id: "200008"
serving:
  description: 官方每份 211.64 公克
  amount: 211.64
  unit: g
nutrition:
  - basis: per_serving
