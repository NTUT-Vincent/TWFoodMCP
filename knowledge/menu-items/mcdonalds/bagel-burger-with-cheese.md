...
type: Food Product
title: 麥當勞 番茄嫩蛋焙果堡
description: 麥當勞台灣官方品項「番茄嫩蛋焙果堡」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/bagel-burger-with-cheese.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200265&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:bagel-burger-with-cheese
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 番茄嫩蛋焙果堡
...
revision:
  revision_id: official-api-200265-2026-08-01
  source_product_id: '200265'
serving:
  description: 官方每份 208.61 公克
  amount: 208.61
  unit: g
nutrition:
- basis: per_serving
