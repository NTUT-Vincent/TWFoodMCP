...
type: Food Product
title: 麥當勞 巧克力榛果可頌
description: 麥當勞台灣官方品項「巧克力榛果可頌」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/croissant-chocolate.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/croissant-chocolate.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200051&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:croissant-chocolate
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 巧克力榛果可頌
  aliases:
    ...
    - croissant-chocolate
revision:
  revision_id: official-api-200051-2026-08-01
  source_product_id: "200051"
serving:
  description: 官方每份 62 公克
  amount: 62
  unit: g
nutrition:
  - basis: per_serving
