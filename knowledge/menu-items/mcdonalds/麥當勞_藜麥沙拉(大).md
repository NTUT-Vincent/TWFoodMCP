...
type: Food Product
title: 麥當勞 藜麥沙拉(大)
description: 麥當勞台灣官方品項「藜麥沙拉(大)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/quinoa-salad.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/quinoa-salad.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200323&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:200323
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 藜麥沙拉(大)
  aliases:
    ...
    - "200323"
revision:
  revision_id: official-api-200323-2026-08-01
  source_product_id: "200323"
serving:
  description: 官方每份 190.83 公克
  amount: 190.83
  unit: g
nutrition:
  - basis: per_serving
