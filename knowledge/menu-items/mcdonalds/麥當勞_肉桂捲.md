...
type: Food Product
title: 麥當勞 肉桂捲
description: 麥當勞台灣官方品項「肉桂捲」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/cinnamon-swirl.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/cinnamon-swirl.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200053&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:cinnamon-swirl
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 肉桂捲
  aliases:
    ...
    - cinnamon-swirl
revision:
  revision_id: official-api-200053-2026-08-01
  source_product_id: "200053"
serving:
  description: 官方每份 95 公克
  amount: 95
  unit: g
nutrition:
  - basis: per_serving
