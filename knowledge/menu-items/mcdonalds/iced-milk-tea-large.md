...
type: Food Product
title: 麥當勞 奶茶 (冰)
description: 麥當勞台灣官方品項「奶茶 (冰)」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/iced-milk-tea-large.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200110&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:iced-milk-tea-large
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 奶茶 (冰)
  ...
  - iced-milk-tea-large
revision:
  revision_id: official-api-200110-2026-08-01
  source_product_id: '200110'
serving:
