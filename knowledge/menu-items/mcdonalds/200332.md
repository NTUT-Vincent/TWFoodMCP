...
type: Food Product
title: 麥當勞 金選美式咖啡(熱)
description: 麥當勞台灣官方品項「金選美式咖啡(熱)」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/select-brew-americano.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200332&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:200332
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 金選美式咖啡(熱)
  ...
  - '200332'
revision:
  revision_id: official-api-200332-2026-08-01
  source_product_id: '200332'
serving:
