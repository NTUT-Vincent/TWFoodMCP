...
type: Food Product
title: 麥當勞 經典卡布奇諾(熱)
description: 麥當勞台灣官方品項「經典卡布奇諾(熱)」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/cappuccino.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200123&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:cappuccino
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 經典卡布奇諾(熱)
  ...
  - cappuccino
revision:
  revision_id: official-api-200123-2026-08-01
  source_product_id: '200123'
serving:
  description: 官方每份 369 公克
  amount: 369
  unit: g
nutrition:
- basis: per_serving
