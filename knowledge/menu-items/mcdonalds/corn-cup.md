...
type: Food Product
title: 麥當勞 玉米杯
description: 麥當勞台灣官方品項「玉米杯」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/corn-cup.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200020&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:corn-cup
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 玉米杯
  ...
  - corn-cup
revision:
  revision_id: official-api-200020-2026-08-01
  source_product_id: '200020'
serving:
  description: 官方每份 113 公克
  amount: 113
  unit: g
nutrition:
- basis: per_serving
