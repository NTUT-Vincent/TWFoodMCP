...
food:
  id: food:tw:menu:mcdonalds:mcdonalds_藜麥沙拉
  kind: menu_item
  market: TW
  ...
  aliases:
    - 藜麥沙拉
    - 台灣麥當勞 McDonald's藜麥沙拉
    - 台灣麥當勞 McDonald's 藜麥沙拉
revision:
  revision_id: google-sheet-2026-08-22-nut-00048
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:200323
  existing_title: 麥當勞 藜麥沙拉(大)
  existing_concept: /menu-items/mcdonalds/200323.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 96.2
        official_value: 96.2
        delta: 0
        tolerance: 1
      - &a2
      ...
      - &a8
        field: sodium_mg
        candidate_value: 172.9
        official_value: 172.9
        delta: 0
        tolerance: 5
    matched:
      - *a1
...
此文件保存試算表記錄 NUT-00048 的營養觀測。[^sheet-source-170fcc78d889] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[麥當勞 藜麥沙拉(大)](/menu-items/mcdonalds/200323.md)。
