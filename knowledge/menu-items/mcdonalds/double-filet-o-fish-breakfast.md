...
type: Food Product
title: 麥當勞 早餐雙層麥香魚
description: 麥當勞台灣官方品項「早餐雙層麥香魚」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/double-filet-o-fish-breakfast.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/double-filet-o-fish-breakfast.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200340&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:double-filet-o-fish-breakfast
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 早餐雙層麥香魚
  aliases:
    ...
    - 麥當勞 早餐雙層麥香魚
    - McDonald's 早餐雙層麥香魚
    - double-filet-o-fish-breakfast
revision:
  revision_id: official-api-200340-2026-08-01
  source_product_id: "200340"
serving:
  description: 官方每份 194.14 公克
  amount: 194.14
  unit: g
nutrition:
  - basis: per_serving
