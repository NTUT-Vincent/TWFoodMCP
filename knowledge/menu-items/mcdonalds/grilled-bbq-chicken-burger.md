...
type: Food Product
title: 麥當勞 嫩煎鷄腿堡
description: 麥當勞台灣官方品項「嫩煎鷄腿堡」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/grilled-bbq-chicken-burger.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200158&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:grilled-bbq-chicken-burger
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 嫩煎鷄腿堡
...
revision:
  revision_id: official-api-200158-2026-08-01
  source_product_id: '200158'
serving:
  description: 官方每份 201.97 公克
  amount: 201.97
  unit: g
nutrition:
- basis: per_serving
