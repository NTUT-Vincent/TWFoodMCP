...
type: Food Product
title: 麥當勞 鬆餅(3片)
description: 麥當勞台灣官方品項「鬆餅(3片)」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/hotcakes-3-pieces.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200036&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:hotcakes-3-pieces
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 鬆餅(3片)
  ...
  - hotcakes-3-pieces
revision:
  revision_id: official-api-200036-2026-08-01
  source_product_id: '200036'
serving:
  description: 官方每份 142.56 公克
  amount: 142.56
  unit: g
nutrition:
- basis: per_serving
