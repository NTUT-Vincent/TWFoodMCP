...
food:
  id: food:tw:menu:mcdonalds:mcdonalds_金選那堤熱
  kind: menu_item
  market: TW
  ...
  aliases:
    - 金選那堤(熱)
    - 台灣麥當勞 McDonald's金選那堤(熱)
    - 台灣麥當勞 McDonald's 金選那堤(熱)
revision:
  revision_id: google-sheet-2026-08-22-nut-00032
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:200333
  existing_title: 麥當勞 金選那堤(熱)
  existing_concept: /menu-items/mcdonalds/200333.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 123.52
        official_value: 123.52
        delta: 0
        tolerance: 1.2352
      - &a2
        field: protein_g
...
此文件保存試算表記錄 NUT-00032 的營養觀測。[^sheet-source-170fcc78d889] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[麥當勞 金選那堤(熱)](/menu-items/mcdonalds/200333.md)。
