...
food:
  id: food:tw:menu:mcdonalds:mcdonalds_藜麥鱈魚沙拉
  kind: menu_item
  market: TW
  ...
  aliases:
    - 藜麥鱈魚沙拉
    - 台灣麥當勞 McDonald's藜麥鱈魚沙拉
    - 台灣麥當勞 McDonald's 藜麥鱈魚沙拉
revision:
  revision_id: google-sheet-2026-08-22-nut-00051
serving:
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:200324
  existing_title: 麥當勞 藜麥鱈魚沙拉
  existing_concept: /menu-items/mcdonalds/200324.md
  comparison:
    corroborated: true
    compared:
      - &a1
        field: energy_kcal
        candidate_value: 218.3
        official_value: 218.3
        delta: 0
      ...
      - &a8
        field: sodium_mg
        candidate_value: 301.4
        official_value: 301.4
        delta: 0
        tolerance: 6.028
    matched:
      - *a1
...
此文件保存試算表記錄 NUT-00051 的營養觀測。[^sheet-source-170fcc78d889] 它是未驗證 draft，不能直接用於營養計算。
...
數值可交叉支持：[麥當勞 藜麥鱈魚沙拉](/menu-items/mcdonalds/200324.md)。
