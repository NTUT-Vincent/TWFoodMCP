...
type: Food Product
title: 麥當勞 豬肉蛋堡
description: 麥當勞台灣官方品項「豬肉蛋堡」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/egg-burger-with-sausage.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200041&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:egg-burger-with-sausage
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 豬肉蛋堡
...
revision:
  revision_id: official-api-200041-2026-08-01
  source_product_id: '200041'
serving:
  description: 官方每份 181.67 公克
  amount: 181.67
  unit: g
nutrition:
- basis: per_serving
