...
type: Food Product
title: 麥當勞 蕈菇安格斯牛肉堡
description: 麥當勞台灣官方品項「蕈菇安格斯牛肉堡」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/mushroom-angus-beef-burger.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200010&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:mushroom-angus-beef-burger
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 蕈菇安格斯牛肉堡
...
revision:
  revision_id: official-api-200010-2026-08-01
  source_product_id: '200010'
serving:
  description: 官方每份 228.73 公克
  amount: 228.73
  unit: g
nutrition:
- basis: per_serving
