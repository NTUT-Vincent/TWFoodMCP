...
type: Food Product
title: 麥當勞 蘋果派
description: 麥當勞台灣官方品項「蘋果派」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/apple-pie.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200080&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:apple-pie
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 蘋果派
  ...
  - apple-pie
revision:
  revision_id: official-api-200080-2026-08-01
  source_product_id: '200080'
serving:
