...
type: Food Product
title: 麥當勞 四盎司牛肉堡(辣味)
description: 麥當勞台灣官方品項「四盎司牛肉堡(辣味)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/spicy-classic-angus-beef-burger.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/spicy-classic-angus-beef-burger.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200342&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:spicy-classic-angus-beef-burger
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 四盎司牛肉堡(辣味)
  aliases:
    ...
    - 麥當勞四盎司牛肉堡(辣味)
    - 麥當勞 四盎司牛肉堡(辣味)
    - McDonald's 四盎司牛肉堡(辣味)
    - spicy-classic-angus-beef-burger
revision:
  revision_id: official-api-200342-2026-08-01
  source_product_id: "200342"
serving:
  description: 官方每份 209.57 公克
  amount: 209.57
  unit: g
nutrition:
  - basis: per_serving
