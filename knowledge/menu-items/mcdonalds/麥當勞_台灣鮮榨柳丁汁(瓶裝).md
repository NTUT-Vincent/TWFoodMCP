---
type: Food Product
title: 麥當勞 台灣鮮榨柳丁汁(瓶裝)
description: 麥當勞台灣官方品項「台灣鮮榨柳丁汁(瓶裝)」的每份營養資料，來源為官方 itemDetails API。
resource: https://www.mcdonalds.com/tw/zh-tw/product/taiwan-fresh-orange-juice.html
tags:
  - 麥當勞
  - McDonald's
  - 官方營養
...
sources:
  - id: mcdonalds-tw-nutrition-2026-08-01
    resource: https://www.mcdonalds.com/tw/zh-tw/product/taiwan-fresh-orange-juice.html
    api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200273&compType=core&returnType=json
    title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:taiwan-fresh-orange-juice
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 台灣鮮榨柳丁汁(瓶裝)
  aliases:
    ...
    - 麥當勞台灣鮮榨柳丁汁(瓶裝)
    - 麥當勞 台灣鮮榨柳丁汁(瓶裝)
    - McDonald's 台灣鮮榨柳丁汁(瓶裝)
    - taiwan-fresh-orange-juice
revision:
  revision_id: official-api-200273-2026-08-01
  source_product_id: "200273"
serving:
  description: 官方每份 265 公克
  amount: 265
  unit: g
nutrition:
  - basis: per_serving
