...
type: Food Product
title: 麥當勞 四季沙拉
description: 麥當勞台灣官方品項「四季沙拉」的每份營養資料，來源為官方 itemDetails API。
status: draft
...
- id: mcdonalds-tw-nutrition-2026-08-01
  resource: https://www.mcdonalds.com/tw/zh-tw/product/salad-large.html
  api_resource: https://www.mcdonalds.com/dnaapp/itemDetails?country=TW&language=zh&showLiveData=true&item=200025&compType=core&returnType=json
  title: 麥當勞台灣官方營養資料
...
food:
  id: food:tw:menu:mcdonalds:salad-large
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 四季沙拉
  ...
  - salad-large
revision:
  revision_id: official-api-200025-2026-08-01
  source_product_id: '200025'
serving:
  description: 官方每份 75.46 公克
  amount: 75.46
  unit: g
nutrition:
- basis: per_serving
