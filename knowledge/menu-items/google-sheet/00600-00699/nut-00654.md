...
food:
  id: food:tw:menu:google-sheet:nut-00654
  kind: menu_item
  market: TW
  brand: 麻古茶坊
  name: 鐵觀音奶茶瓶裝
  aliases:
    ...
    - 麻古茶坊 鐵觀音奶茶瓶裝
revision:
  revision_id: google-sheet-2026-08-22-nut-00654
serving:
...
此文件保存試算表記錄 NUT-00654 的營養觀測。[^sheet-source-466715605c89] 它是未驗證 draft，不能直接用於營養計算。
