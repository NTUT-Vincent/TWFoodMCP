...
food:
  id: food:tw:menu:google-sheet:nut-00638
  kind: menu_item
  market: TW
  brand: 麻古茶坊
  name: 芋泥波波鮮奶2.0
  aliases:
    ...
    - 麻古茶坊 芋泥波波鮮奶2.0
revision:
  revision_id: google-sheet-2026-08-22-nut-00638
serving:
...
此文件保存試算表記錄 NUT-00638 的營養觀測。[^sheet-source-466715605c89] 它是未驗證 draft，不能直接用於營養計算。
