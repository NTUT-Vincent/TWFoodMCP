...
resource: https://www.instagram.com/reel/DP6NxRmjAjP/
tags:
  - 萊爾富 Hi-Life
  - 餐盒
  - TWFood 共筆
...
sources:
  - id: sheet-source-7d6e7dc27528
    resource: https://www.instagram.com/reel/DP6NxRmjAjP/
    title: 你會吃便利商店的健康便當嗎？四大超商健康餐盒比較
    source_class: community_submission
    retrieved_at: 2026-08-05T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-00212
  kind: menu_item
  market: TW
  brand: 萊爾富 Hi-Life
  name: 雞肉多多蛋白餐盒
...
revision:
  revision_id: google-sheet-2026-08-22-nut-00212
serving:
  description: 1盒（文章未列重量）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: Instagram
    source_author: null
    source_title: 你會吃便利商店的健康便當嗎？四大超商健康餐盒比較
    source_url: https://www.instagram.com/reel/DP6NxRmjAjP/
    article_updated_at: null
    accessed_at: 46239
    primary_source_url: null
    usage_note: 社群文章轉錄；非萊爾富官方頁面，需以實際包裝核對。
source_observation:
  usage_note: 社群文章轉錄；非萊爾富官方頁面，需以實際包裝核對。
...
此文件保存試算表記錄 NUT-00212 的營養觀測。[^sheet-source-7d6e7dc27528] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-7d6e7dc27528]: 你會吃便利商店的健康便當嗎？四大超商健康餐盒比較
