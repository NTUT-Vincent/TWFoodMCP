...
food:
  id: food:tw:menu:google-sheet:nut-00215
  kind: menu_item
  market: TW
  brand: OKmart
  name: 醬燒烤雞
  aliases:
    ...
    - OKmart 醬燒烤雞
revision:
  revision_id: google-sheet-2026-08-22-nut-00215
serving:
  description: 1份（文章約值）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00215 的營養觀測。[^sheet-source-b83cb8ef5146] 它是未驗證 draft，不能直接用於營養計算。
