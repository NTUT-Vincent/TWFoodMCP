...
food:
  id: food:tw:menu:google-sheet:nut-01204
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 握便當-豪華秘製雙拼
  aliases:
    ...
    - 7-ELEVEN 握便當-豪華秘製雙拼
revision:
  revision_id: google-sheet-2026-08-22-nut-01204
serving:
  description: 1份（官方商品頁）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    record_id: NUT-01204
    food_name: 握便當-豪華秘製雙拼
    brand_or_context: 7-ELEVEN
    category: 便當
    serving_basis: 1份（官方商品頁）
    calories_kcal: 428
    protein_g: null
    fat_g: null
...
此文件保存試算表記錄 NUT-01204 的營養觀測。[^sheet-source-fa50557cb1f4] 它是未驗證 draft，不能直接用於營養計算。
