...
food:
  id: food:tw:menu:google-sheet:nut-01202
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 鮪魚肉鬆雙手卷
  aliases:
    ...
    - 7-ELEVEN 鮪魚肉鬆雙手卷
revision:
  revision_id: google-sheet-2026-08-22-nut-01202
serving:
  description: 1份（雙手卷）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-01202 的營養觀測。[^sheet-source-fa50557cb1f4] 它是未驗證 draft，不能直接用於營養計算。
