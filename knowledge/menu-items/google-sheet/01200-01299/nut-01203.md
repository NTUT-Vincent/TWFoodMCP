...
food:
  id: food:tw:menu:google-sheet:nut-01203
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 北海道秋鮭鮪魚雙手卷
  aliases:
    ...
    - 7-ELEVEN 北海道秋鮭鮪魚雙手卷
revision:
  revision_id: google-sheet-2026-08-22-nut-01203
serving:
  description: 1份（雙手卷）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    record_id: NUT-01203
    food_name: 北海道秋鮭鮪魚雙手卷
    brand_or_context: 7-ELEVEN
    category: 手卷
    serving_basis: 1份（雙手卷）
    calories_kcal: 364
    protein_g: null
    fat_g: null
...
此文件保存試算表記錄 NUT-01203 的營養觀測。[^sheet-source-fa50557cb1f4] 它是未驗證 draft，不能直接用於營養計算。
