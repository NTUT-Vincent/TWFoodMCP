---
type: Food Product
title: 全家 FamilyMart 美味蟹煲
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.threads.com/@ningning_dietitian/post/DFucyiqyqto
tags:
  - 全家 FamilyMart
  - 餐盒／鍋物
  - TWFood 共筆
...
sources:
  - id: sheet-source-a1bfecda9b38
    resource: https://www.threads.com/@ningning_dietitian/post/DFucyiqyqto
    title: 全家美味蟹煲營養標示抽查
    source_class: community_submission
    last_modified: 2025-02-06T00:00:00+08:00
    retrieved_at: 2026-08-19T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-01190
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 美味蟹煲
  aliases:
    ...
    - 全家 FamilyMart 美味蟹煲
revision:
  revision_id: google-sheet-2026-08-22-nut-01190
serving:
  description: 1份（完整包裝）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: Threads
    source_author: 寧寧營養師
    source_title: 全家美味蟹煲營養標示抽查
    source_url: https://www.threads.com/@ningning_dietitian/post/DFucyiqyqto
    article_updated_at: 45694
    accessed_at: 46253
...
此文件保存試算表記錄 NUT-01190 的營養觀測。[^sheet-source-a1bfecda9b38] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-a1bfecda9b38]: 全家美味蟹煲營養標示抽查
