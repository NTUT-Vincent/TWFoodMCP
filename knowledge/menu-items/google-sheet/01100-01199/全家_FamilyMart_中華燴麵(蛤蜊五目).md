---
type: Food Product
title: 全家 FamilyMart 中華燴麵（蛤蜊五目）
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.threads.com/@ningning_dietitian/post/DRI2siTimRI
tags:
  - 全家 FamilyMart
  - 麵食
  - TWFood 共筆
...
sources:
  - id: sheet-source-474e8abf25e4
    resource: https://www.threads.com/@ningning_dietitian/post/DRI2siTimRI
    title: 全家中華燴麵（蛤蜊五目）營養標示抽查
    source_class: community_submission
    last_modified: 2025-11-16T00:00:00+08:00
    retrieved_at: 2026-08-19T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-01188
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 中華燴麵（蛤蜊五目）
  aliases:
    - 中華燴麵（蛤蜊五目）
    - 全家 FamilyMart中華燴麵（蛤蜊五目）
    - 全家 FamilyMart 中華燴麵（蛤蜊五目）
revision:
  revision_id: google-sheet-2026-08-22-nut-01188
serving:
  description: 1份（完整包裝）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: Threads
    source_author: 寧寧營養師
    source_title: 全家中華燴麵（蛤蜊五目）營養標示抽查
    source_url: https://www.threads.com/@ningning_dietitian/post/DRI2siTimRI
    article_updated_at: 45977
    accessed_at: 46253
...
此文件保存試算表記錄 NUT-01188 的營養觀測。[^sheet-source-474e8abf25e4] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-474e8abf25e4]: 全家中華燴麵（蛤蜊五目）營養標示抽查
