---
type: Food Product
title: 萊爾富 Hi-Life 抹茶紅豆吐司
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.facebook.com/foodiejun/posts/1730491935747102/
tags:
  - 萊爾富 Hi-Life
  - 烘焙麵包
  - TWFood 共筆
...
sources:
  - id: sheet-source-bf4ad4f5d06c
    resource: https://www.facebook.com/foodiejun/posts/1730491935747102/
    title: 7-ELEVEN 與萊爾富抹茶紅豆吐司比較
    source_class: community_submission
    retrieved_at: 2026-08-13T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-01112
  kind: menu_item
  market: TW
  brand: 萊爾富 Hi-Life
  name: 抹茶紅豆吐司
  aliases:
    ...
    - 萊爾富 Hi-Life 抹茶紅豆吐司
revision:
  revision_id: google-sheet-2026-08-22-nut-01112
serving:
  description: 1片（80 g）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_author: foodiejun
  source_row:
    record_id: NUT-01112
    food_name: 抹茶紅豆吐司
    brand_or_context: 萊爾富 Hi-Life
    category: 烘焙麵包
    serving_basis: 1片（80 g）
    calories_kcal: 278.5
    protein_g: null
    fat_g: null
    ...
    source_publisher: Facebook
    source_author: foodiejun
    source_title: 7-ELEVEN 與萊爾富抹茶紅豆吐司比較
    source_url: https://www.facebook.com/foodiejun/posts/1730491935747102/
    article_updated_at: null
    accessed_at: 46247
    primary_source_url: null
    usage_note: 一般美食社群比較文；同篇同品名依品牌拆列，僅提供重量、價格與熱量。
source_observation:
  price_twd: 38
  usage_note: 一般美食社群比較文；同篇同品名依品牌拆列，僅提供重量、價格與熱量。
...
此文件保存試算表記錄 NUT-01112 的營養觀測。[^sheet-source-bf4ad4f5d06c] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-bf4ad4f5d06c]: 7-ELEVEN 與萊爾富抹茶紅豆吐司比較
