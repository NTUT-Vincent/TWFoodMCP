...
resource: https://foodtracer.health.ntpc.gov.tw/w/foodtracer/FoodPublicInfo?areaId=21120615314152601&infoId=35272
tags:
  - OKmart
  - 關東煮／熱食
  - TWFood 共筆
...
food:
  id: food:tw:menu:google-sheet:nut-01147
  kind: menu_item
  market: TW
  brand: OKmart
  name: 台灣黑輪
  aliases:
    ...
    - OKmart 台灣黑輪
revision:
  revision_id: google-sheet-2026-08-22-nut-01147
serving:
  description: 1份（50g）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 新北市食材登錄平台
    source_author: 新北市政府衛生局／業者登錄
    source_title: 台灣黑輪食品揭露
    source_url: https://foodtracer.health.ntpc.gov.tw/w/foodtracer/FoodPublicInfo?areaId=21120615314152601&infoId=35272
    article_updated_at: null
    accessed_at: 46250
    primary_source_url: https://foodtracer.health.ntpc.gov.tw/w/foodtracer/FoodPublicInfo?areaId=21120615314152601&infoId=35272
    usage_note: 政府食材登錄完整營養標示；以登錄規格50g為一份，門市實際批次仍以現場標示為準。
source_observation:
  usage_note: 政府食材登錄完整營養標示；以登錄規格50g為一份，門市實際批次仍以現場標示為準。
...
此文件保存試算表記錄 NUT-01147 的營養觀測。[^sheet-source-6111b92305ae] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-6111b92305ae]: 台灣黑輪食品揭露
