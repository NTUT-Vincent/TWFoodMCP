...
food:
  id: food:tw:menu:google-sheet:nut-00734
  kind: menu_item
  market: TW
  brand: 八方雲集
  name: 紹辣乾麵
  aliases:
    ...
    - 八方雲集 紹辣乾麵
revision:
  revision_id: google-sheet-2026-08-22-nut-00734
serving:
  description: 1碗（文章以300g估算）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
此文件保存試算表記錄 NUT-00734 的營養觀測。[^sheet-source-d916121be823] 它是未驗證 draft，不能直接用於營養計算。
