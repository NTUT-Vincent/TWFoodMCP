...
food:
  id: food:tw:menu:google-sheet:nut-00754
  kind: menu_item
  market: TW
  brand: 八方雲集
  name: 紅油菜肉大抄手
  aliases:
    ...
    - 八方雲集 紅油菜肉大抄手
revision:
  revision_id: google-sheet-2026-08-22-nut-00754
serving:
  description: 1份（大顆6顆；每顆約35g）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
此文件保存試算表記錄 NUT-00754 的營養觀測。[^sheet-source-d916121be823] 它是未驗證 draft，不能直接用於營養計算。
