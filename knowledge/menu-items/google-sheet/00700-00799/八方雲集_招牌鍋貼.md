...
food:
  id: food:tw:menu:google-sheet:nut-00718
  kind: menu_item
  market: TW
  brand: 八方雲集
  name: 招牌鍋貼
  aliases:
    ...
    - 八方雲集 招牌鍋貼
revision:
  revision_id: google-sheet-2026-08-22-nut-00718
serving:
...
此文件保存試算表記錄 NUT-00718 的營養觀測。[^sheet-source-d916121be823] 它是未驗證 draft，不能直接用於營養計算。
