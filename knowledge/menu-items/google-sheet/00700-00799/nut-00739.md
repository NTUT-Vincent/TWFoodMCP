...
food:
  id: food:tw:menu:google-sheet:nut-00739
  kind: menu_item
  market: TW
  brand: 八方雲集
  name: 榨菜肉絲麵
  aliases:
    ...
    - 八方雲集 榨菜肉絲麵
revision:
  revision_id: google-sheet-2026-08-22-nut-00739
serving:
...
此文件保存試算表記錄 NUT-00739 的營養觀測。[^sheet-source-d916121be823] 它是未驗證 draft，不能直接用於營養計算。
