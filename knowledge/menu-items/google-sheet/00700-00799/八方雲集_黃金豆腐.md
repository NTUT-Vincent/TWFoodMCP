...
food:
  id: food:tw:menu:google-sheet:nut-00773
  kind: menu_item
  market: TW
  brand: 八方雲集
  name: 黃金豆腐
  aliases:
    ...
    - 八方雲集 黃金豆腐
revision:
  revision_id: google-sheet-2026-08-22-nut-00773
nutrition:
  - basis: per_100g
    values:
      energy_kcal: 116
...
此文件保存試算表記錄 NUT-00773 的營養觀測。[^sheet-source-d916121be823] 它是未驗證 draft，不能直接用於營養計算。
