...
food:
  id: food:tw:menu:google-sheet:nut-00748
  kind: menu_item
  market: TW
  brand: 八方雲集
  name: 酸辣湯餃
  aliases:
    ...
    - 八方雲集 酸辣湯餃
revision:
  revision_id: google-sheet-2026-08-22-nut-00748
serving:
  description: 1份（含8顆招牌水餃）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
此文件保存試算表記錄 NUT-00748 的營養觀測。[^sheet-source-d916121be823] 它是未驗證 draft，不能直接用於營養計算。
