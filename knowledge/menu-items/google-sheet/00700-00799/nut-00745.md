...
food:
  id: food:tw:menu:google-sheet:nut-00745
  kind: menu_item
  market: TW
  brand: 八方雲集
  name: 紅燒牛肉冬粉
  aliases:
    ...
    - 八方雲集 紅燒牛肉冬粉
revision:
  revision_id: google-sheet-2026-08-22-nut-00745
serving:
...
此文件保存試算表記錄 NUT-00745 的營養觀測。[^sheet-source-d916121be823] 它是未驗證 draft，不能直接用於營養計算。
