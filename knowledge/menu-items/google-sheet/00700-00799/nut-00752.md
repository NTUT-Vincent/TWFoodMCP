...
food:
  id: food:tw:menu:google-sheet:nut-00752
  kind: menu_item
  market: TW
  brand: 八方雲集
  name: 紅油珍珠抄手
  aliases:
    ...
    - 八方雲集 紅油珍珠抄手
revision:
  revision_id: google-sheet-2026-08-22-nut-00752
serving:
  description: 1份（小顆8顆；每顆約21g）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    category: 抄手
    serving_basis: 1份（小顆8顆；每顆約21g）
    calories_kcal: 304.08
    protein_g: null
    fat_g: null
    ...
    usage_note: 文章營養師依標示顆數或整碗重量估算；實際門市份量可能不同。
source_observation:
  usage_note: 文章營養師依標示顆數或整碗重量估算；實際門市份量可能不同。
...
此文件保存試算表記錄 NUT-00752 的營養觀測。[^sheet-source-d916121be823] 它是未驗證 draft，不能直接用於營養計算。
