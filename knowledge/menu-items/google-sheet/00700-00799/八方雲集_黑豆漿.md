...
food:
  id: food:tw:menu:google-sheet:nut-00769
  kind: menu_item
  market: TW
  brand: 八方雲集
  name: 黑豆漿
  aliases:
    ...
    - 八方雲集 黑豆漿
revision:
  revision_id: google-sheet-2026-08-22-nut-00769
serving:
  description: 1份（文章未列容量）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
此文件保存試算表記錄 NUT-00769 的營養觀測。[^sheet-source-d916121be823] 它是未驗證 draft，不能直接用於營養計算。
