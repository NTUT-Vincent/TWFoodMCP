...
food:
  id: food:tw:menu:google-sheet:nut-00187
  kind: menu_item
  market: TW
  brand: 非品牌食譜
  name: 蒜香辣味蝦
  aliases:
    ...
    - 非品牌食譜 蒜香辣味蝦
revision:
  revision_id: google-sheet-2026-08-22-nut-00187
serving:
...
此文件保存試算表記錄 NUT-00187 的營養觀測。[^sheet-source-1c2dd838b708] 它是未驗證 draft，不能直接用於營養計算。
