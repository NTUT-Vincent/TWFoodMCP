...
food:
  id: food:tw:menu:google-sheet:nut-00192
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 帕泰家沙嗲烤豬肉飯糰
  aliases:
    ...
    - 7-ELEVEN 帕泰家沙嗲烤豬肉飯糰
revision:
  revision_id: google-sheet-2026-08-22-nut-00192
serving:
...
此文件保存試算表記錄 NUT-00192 的營養觀測。[^sheet-source-43e12c98986e] 它是未驗證 draft，不能直接用於營養計算。
