...
food:
  id: food:tw:menu:google-sheet:nut-00184
  kind: menu_item
  market: TW
  brand: 非品牌食譜
  name: 法式紙包魚
  aliases:
    ...
    - 非品牌食譜 法式紙包魚
revision:
  revision_id: google-sheet-2026-08-22-nut-00184
serving:
  description: 文章未明示（材料為2人份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
此文件保存試算表記錄 NUT-00184 的營養觀測。[^sheet-source-1c2dd838b708] 它是未驗證 draft，不能直接用於營養計算。
