...
food:
  id: food:tw:menu:google-sheet:nut-00193
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 頌丹樂－泰式打拋豬飯糰
...
revision:
  revision_id: google-sheet-2026-08-22-nut-00193
serving:
  description: 1個（官網商品頁）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
此文件保存試算表記錄 NUT-00193 的營養觀測。[^sheet-source-43e12c98986e] 它是未驗證 draft，不能直接用於營養計算。
