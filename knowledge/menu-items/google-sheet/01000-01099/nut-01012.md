...
food:
  id: food:tw:menu:google-sheet:nut-01012
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 牛角-炙燒雙拼便當
  aliases:
    ...
    - 7-ELEVEN 牛角-炙燒雙拼便當
revision:
  revision_id: google-sheet-2026-08-22-nut-01012
serving:
...
此文件保存試算表記錄 NUT-01012 的營養觀測。[^sheet-source-d659239144a6] 它是未驗證 draft，不能直接用於營養計算。
