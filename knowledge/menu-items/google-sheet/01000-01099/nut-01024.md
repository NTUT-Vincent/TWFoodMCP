...
food:
  id: food:tw:menu:google-sheet:nut-01024
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 蔥鹽增雞蛋白麵
  aliases:
    ...
    - 7-ELEVEN 蔥鹽增雞蛋白麵
revision:
  revision_id: google-sheet-2026-08-22-nut-01024
serving:
...
此文件保存試算表記錄 NUT-01024 的營養觀測。[^sheet-source-1bc8021b9d42] 它是未驗證 draft，不能直接用於營養計算。
