---
type: Food Product
title: 7-ELEVEN (熱壓土司)八棟花生麻糬
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.7-11.com.tw/freshfoods/16_sandwich/index.aspx
tags:
  - 7-ELEVEN
  - 熱壓吐司
  - TWFood 共筆
...
sources:
  - id: sheet-source-65eb971a22a7
    resource: https://www.7-11.com.tw/freshfoods/16_sandwich/index.aspx
    title: 7-ELEVEN 小七食堂｜原賞
    source_class: primary_official
    retrieved_at: 2026-08-09T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-01009
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: (熱壓土司)八棟花生麻糬
  aliases:
    - (熱壓土司)八棟花生麻糬
    - 7-ELEVEN(熱壓土司)八棟花生麻糬
    - 7-ELEVEN (熱壓土司)八棟花生麻糬
revision:
  revision_id: google-sheet-2026-08-22-nut-01009
serving:
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 7-ELEVEN Taiwan
    source_author: null
    source_title: 7-ELEVEN 小七食堂｜原賞
    source_url: https://www.7-11.com.tw/freshfoods/16_sandwich/index.aspx
...
此文件保存試算表記錄 NUT-01009 的營養觀測。[^sheet-source-65eb971a22a7] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-65eb971a22a7]: 7-ELEVEN 小七食堂｜原賞
