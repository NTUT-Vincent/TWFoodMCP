...
food:
  id: food:tw:menu:google-sheet:nut-01014
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 奶油蛋黃醬培根義大利麵
  aliases:
    - 奶油蛋黃醬培根義大利麵
    - 7-ELEVEN奶油蛋黃醬培根義大利麵
    - 7-ELEVEN 奶油蛋黃醬培根義大利麵
revision:
  revision_id: google-sheet-2026-08-22-nut-01014
serving:
...
此文件保存試算表記錄 NUT-01014 的營養觀測。[^sheet-source-cc8ff9d8a4ca] 它是未驗證 draft，不能直接用於營養計算。
