...
food:
  id: food:tw:menu:google-sheet:nut-01051
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 塔香杏鮑菇飯糰
  aliases:
    ...
    - 7-ELEVEN 塔香杏鮑菇飯糰
revision:
  revision_id: google-sheet-2026-08-22-nut-01051
serving:
...
此文件保存試算表記錄 NUT-01051 的營養觀測。[^sheet-source-11ccb5a910a7] 它是未驗證 draft，不能直接用於營養計算。
