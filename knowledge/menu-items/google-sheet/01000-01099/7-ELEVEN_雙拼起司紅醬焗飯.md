...
food:
  id: food:tw:menu:google-sheet:nut-01016
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 雙拼起司紅醬焗飯
  aliases:
    ...
    - 7-ELEVEN 雙拼起司紅醬焗飯
revision:
  revision_id: google-sheet-2026-08-22-nut-01016
serving:
...
此文件保存試算表記錄 NUT-01016 的營養觀測。[^sheet-source-fdf7b79d1c92] 它是未驗證 draft，不能直接用於營養計算。
