...
food:
  id: food:tw:menu:google-sheet:nut-01073
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 凱薩風味嫩雞鮮蔬捲餅
  aliases:
    ...
    - 7-ELEVEN 凱薩風味嫩雞鮮蔬捲餅
revision:
  revision_id: google-sheet-2026-08-22-nut-01073
serving:
...
此文件保存試算表記錄 NUT-01073 的營養觀測。[^sheet-source-0bdfeb34901d] 它是未驗證 draft，不能直接用於營養計算。
