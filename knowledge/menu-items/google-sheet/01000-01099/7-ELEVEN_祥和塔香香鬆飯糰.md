...
food:
  id: food:tw:menu:google-sheet:nut-01050
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 祥和塔香香鬆飯糰
  aliases:
    ...
    - 7-ELEVEN 祥和塔香香鬆飯糰
revision:
  revision_id: google-sheet-2026-08-22-nut-01050
serving:
...
此文件保存試算表記錄 NUT-01050 的營養觀測。[^sheet-source-11ccb5a910a7] 它是未驗證 draft，不能直接用於營養計算。
