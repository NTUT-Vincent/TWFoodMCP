---
type: Food Product
title: OKmart 炭焙烏龍茶葉蛋
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.facebook.com/okmart.tw/posts/1507616931400764/
tags:
  - OKmart
  - 茶葉蛋
  - TWFood 共筆
...
food:
  id: food:tw:menu:google-sheet:nut-01045
  kind: menu_item
  market: TW
  brand: OKmart
  name: 炭焙烏龍茶葉蛋
  aliases:
    ...
    - OKmart 炭焙烏龍茶葉蛋
revision:
  revision_id: google-sheet-2026-08-22-nut-01045
serving:
  description: 1顆
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: OKmart
    source_author: null
    source_title: OKmart 炭焙烏龍茶葉蛋
    source_url: https://www.facebook.com/okmart.tw/posts/1507616931400764/
    article_updated_at: null
    accessed_at: 46243
    primary_source_url: null
    usage_note: OKmart 官方社群明列每顆83大卡；未提供完整營養標示。貼文另列2顆22元期間優惠，未換算為單顆價格。
source_observation:
  usage_note: OKmart 官方社群明列每顆83大卡；未提供完整營養標示。貼文另列2顆22元期間優惠，未換算為單顆價格。
...
此文件保存試算表記錄 NUT-01045 的營養觀測。[^sheet-source-b45be3bf7fde] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-b45be3bf7fde]: OKmart 炭焙烏龍茶葉蛋
