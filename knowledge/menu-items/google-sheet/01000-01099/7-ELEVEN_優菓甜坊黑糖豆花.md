...
sources:
  - id: sheet-source-1b8ccbb0410d
    resource: https://www.7-11.com.tw/freshfoods/11_bread/index.aspx
    title: 7-ELEVEN 小七食堂｜麵包甜點
    source_class: primary_official
    retrieved_at: 2026-08-09T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-01002
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 優菓甜坊黑糖豆花
  aliases:
    ...
    - 7-ELEVEN 優菓甜坊黑糖豆花
revision:
  revision_id: google-sheet-2026-08-22-nut-01002
serving:
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 7-ELEVEN Taiwan
    source_author: null
    source_title: 7-ELEVEN 小七食堂｜麵包甜點
...
此文件保存試算表記錄 NUT-01002 的營養觀測。[^sheet-source-1b8ccbb0410d] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-1b8ccbb0410d]: 7-ELEVEN 小七食堂｜麵包甜點
