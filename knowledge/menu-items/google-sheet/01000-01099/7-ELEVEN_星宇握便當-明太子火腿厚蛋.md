...
food:
  id: food:tw:menu:google-sheet:nut-01020
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 星宇握便當-明太子火腿厚蛋
  aliases:
    - 星宇握便當-明太子火腿厚蛋
    - 7-ELEVEN星宇握便當-明太子火腿厚蛋
    - 7-ELEVEN 星宇握便當-明太子火腿厚蛋
revision:
  revision_id: google-sheet-2026-08-22-nut-01020
serving:
...
此文件保存試算表記錄 NUT-01020 的營養觀測。[^sheet-source-1bc8021b9d42] 它是未驗證 draft，不能直接用於營養計算。
