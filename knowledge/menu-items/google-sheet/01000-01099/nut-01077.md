...
food:
  id: food:tw:menu:google-sheet:nut-01077
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 雞肉蛋白棒-黑胡椒風味
  aliases:
    - 雞肉蛋白棒-黑胡椒風味
    - 7-ELEVEN雞肉蛋白棒-黑胡椒風味
    - 7-ELEVEN 雞肉蛋白棒-黑胡椒風味
revision:
  revision_id: google-sheet-2026-08-22-nut-01077
serving:
...
此文件保存試算表記錄 NUT-01077 的營養觀測。[^sheet-source-0bdfeb34901d] 它是未驗證 draft，不能直接用於營養計算。
