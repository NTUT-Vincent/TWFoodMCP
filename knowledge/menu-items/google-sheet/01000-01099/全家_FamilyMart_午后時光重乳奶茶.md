---
type: Food Product
title: 全家 FamilyMart 午后時光重乳奶茶
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2960180
tags:
  - 全家 FamilyMart
  - 奶茶
  - TWFood 共筆
...
sources:
  - id: sheet-source-f6c8d3b46c2a
    resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2960180
    title: 午后時光重乳奶茶－全家食在購安心
    source_class: primary_official
    retrieved_at: 2026-08-09T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-01035
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 午后時光重乳奶茶
  aliases:
    - 午后時光重乳奶茶
    - 全家 FamilyMart午后時光重乳奶茶
    - 全家 FamilyMart 午后時光重乳奶茶
revision:
  revision_id: google-sheet-2026-08-22-nut-01035
serving:
  description: 400毫升（本包裝含1份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 午后時光重乳奶茶－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/2960180
...
此文件保存試算表記錄 NUT-01035 的營養觀測。[^sheet-source-f6c8d3b46c2a] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-f6c8d3b46c2a]: 午后時光重乳奶茶－全家食在購安心
