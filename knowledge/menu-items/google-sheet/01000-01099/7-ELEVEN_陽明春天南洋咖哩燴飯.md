...
food:
  id: food:tw:menu:google-sheet:nut-01005
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 陽明春天南洋咖哩燴飯
  aliases:
    ...
    - 7-ELEVEN 陽明春天南洋咖哩燴飯
revision:
  revision_id: google-sheet-2026-08-22-nut-01005
serving:
...
此文件保存試算表記錄 NUT-01005 的營養觀測。[^sheet-source-11ccb5a910a7] 它是未驗證 draft，不能直接用於營養計算。
