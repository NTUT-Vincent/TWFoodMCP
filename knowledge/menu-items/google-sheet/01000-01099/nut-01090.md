...
food:
  id: food:tw:menu:google-sheet:nut-01090
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 頌丹樂-遇見泰式打拋雞拌麵
  aliases:
    - 頌丹樂-遇見泰式打拋雞拌麵
    - 7-ELEVEN頌丹樂-遇見泰式打拋雞拌麵
    - 7-ELEVEN 頌丹樂-遇見泰式打拋雞拌麵
revision:
  revision_id: google-sheet-2026-08-22-nut-01090
serving:
...
此文件保存試算表記錄 NUT-01090 的營養觀測。[^sheet-source-e4e00369bf2d] 它是未驗證 draft，不能直接用於營養計算。
