...
food:
  id: food:tw:menu:google-sheet:nut-01048
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 奮起湖秘製雙拼握便當
  aliases:
    ...
    - 7-ELEVEN 奮起湖秘製雙拼握便當
revision:
  revision_id: google-sheet-2026-08-22-nut-01048
serving:
...
此文件保存試算表記錄 NUT-01048 的營養觀測。[^sheet-source-fa50557cb1f4] 它是未驗證 draft，不能直接用於營養計算。
