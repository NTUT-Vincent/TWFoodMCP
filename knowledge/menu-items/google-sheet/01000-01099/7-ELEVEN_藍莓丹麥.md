...
food:
  id: food:tw:menu:google-sheet:nut-01001
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 藍莓丹麥
  aliases:
    ...
    - 7-ELEVEN 藍莓丹麥
revision:
  revision_id: google-sheet-2026-08-22-nut-01001
serving:
...
此文件保存試算表記錄 NUT-01001 的營養觀測。[^sheet-source-1b8ccbb0410d] 它是未驗證 draft，不能直接用於營養計算。
