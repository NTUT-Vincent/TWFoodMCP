...
food:
  id: food:tw:menu:google-sheet:nut-01068
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: (盒)玉米起司蛋餅
  aliases:
    ...
    - 7-ELEVEN (盒)玉米起司蛋餅
revision:
  revision_id: google-sheet-2026-08-22-nut-01068
serving:
...
此文件保存試算表記錄 NUT-01068 的營養觀測。[^sheet-source-0bdfeb34901d] 它是未驗證 draft，不能直接用於營養計算。
