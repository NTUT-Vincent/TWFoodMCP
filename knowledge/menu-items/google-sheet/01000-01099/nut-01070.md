...
food:
  id: food:tw:menu:google-sheet:nut-01070
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 粥天子-廣式皮蛋瘦肉煲粥
  aliases:
    - 粥天子-廣式皮蛋瘦肉煲粥
    - 7-ELEVEN粥天子-廣式皮蛋瘦肉煲粥
    - 7-ELEVEN 粥天子-廣式皮蛋瘦肉煲粥
revision:
  revision_id: google-sheet-2026-08-22-nut-01070
serving:
...
此文件保存試算表記錄 NUT-01070 的營養觀測。[^sheet-source-0bdfeb34901d] 它是未驗證 draft，不能直接用於營養計算。
