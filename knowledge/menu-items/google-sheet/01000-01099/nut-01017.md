...
food:
  id: food:tw:menu:google-sheet:nut-01017
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 米香-蟹黃豆腐煲燴飯
  aliases:
    ...
    - 7-ELEVEN 米香-蟹黃豆腐煲燴飯
revision:
  revision_id: google-sheet-2026-08-22-nut-01017
serving:
...
此文件保存試算表記錄 NUT-01017 的營養觀測。[^sheet-source-1bc8021b9d42] 它是未驗證 draft，不能直接用於營養計算。
