---
type: Food Product
title: 7-ELEVEN 陽明春天香辣豆腐拌麵
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.7-11.com.tw/freshfoods/18_veg/index.aspx
tags:
  - 7-ELEVEN
  - 蔬食麵食
  - TWFood 共筆
...
sources:
  - id: sheet-source-11ccb5a910a7
    resource: https://www.7-11.com.tw/freshfoods/18_veg/index.aspx
    title: 7-ELEVEN 小七食堂｜天素地蔬
    source_class: primary_official
    retrieved_at: 2026-08-09T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-01003
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 陽明春天香辣豆腐拌麵
  aliases:
    ...
    - 7-ELEVEN 陽明春天香辣豆腐拌麵
revision:
  revision_id: google-sheet-2026-08-22-nut-01003
serving:
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 7-ELEVEN Taiwan
    source_author: null
    source_title: 7-ELEVEN 小七食堂｜天素地蔬
    source_url: https://www.7-11.com.tw/freshfoods/18_veg/index.aspx
...
此文件保存試算表記錄 NUT-01003 的營養觀測。[^sheet-source-11ccb5a910a7] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-11ccb5a910a7]: 7-ELEVEN 小七食堂｜天素地蔬
