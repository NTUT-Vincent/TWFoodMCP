...
food:
  id: food:tw:menu:google-sheet:nut-00841
  kind: menu_item
  market: TW
  brand: 丸龜製麵
  name: 玉米筍
  aliases:
    ...
    - 丸龜製麵 玉米筍
revision:
  revision_id: google-sheet-2026-08-22-nut-00841
serving:
  description: 1份（4個）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00841 的營養觀測。[^sheet-source-87dbffd46be8] 它是未驗證 draft，不能直接用於營養計算。
