...
food:
  id: food:tw:menu:google-sheet:nut-00840
  kind: menu_item
  market: TW
  brand: 丸龜製麵
  name: 黑蒟蒻
  aliases:
    ...
    - 丸龜製麵 黑蒟蒻
revision:
  revision_id: google-sheet-2026-08-22-nut-00840
serving:
  description: 1份
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00840 的營養觀測。[^sheet-source-87dbffd46be8] 它是未驗證 draft，不能直接用於營養計算。
