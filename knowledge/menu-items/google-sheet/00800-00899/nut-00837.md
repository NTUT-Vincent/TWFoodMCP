...
food:
  id: food:tw:menu:google-sheet:nut-00837
  kind: menu_item
  market: TW
  brand: 丸龜製麵
  name: 白蘿蔔
  aliases:
    ...
    - 丸龜製麵 白蘿蔔
revision:
  revision_id: google-sheet-2026-08-22-nut-00837
serving:
  description: 1份（2塊）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00837 的營養觀測。[^sheet-source-87dbffd46be8] 它是未驗證 draft，不能直接用於營養計算。
