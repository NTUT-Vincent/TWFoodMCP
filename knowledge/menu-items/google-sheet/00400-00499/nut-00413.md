...
food:
  id: food:tw:menu:google-sheet:nut-00413
  kind: menu_item
  market: TW
  brand: 肯德基 KFC
  name: 墨西哥莎莎霸王捲
  aliases:
    ...
    - 肯德基 KFC 墨西哥莎莎霸王捲
revision:
  revision_id: google-sheet-2026-08-22-nut-00413
serving:
  description: 1份
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00413 的營養觀測。[^sheet-source-874192fb5eb8] 它是未驗證 draft，不能直接用於營養計算。
