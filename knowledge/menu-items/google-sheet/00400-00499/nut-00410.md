...
sources:
  ...
  - id: sheet-primary-005bf7d5d29b
    resource: https://www.hongya88.com.tw
    title: 試算表列出的原始／官方來源
...
food:
  id: food:tw:menu:google-sheet:nut-00410
  kind: menu_item
  market: TW
  brand: 弘爺漢堡
  name: 鮪魚蛋堡
  aliases:
    ...
    - 弘爺漢堡 鮪魚蛋堡
revision:
  revision_id: google-sheet-2026-08-22-nut-00410
serving:
  description: 1個（文章表格）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    accessed_at: 46239
    primary_source_url: https://www.hongya88.com.tw
...
此文件保存試算表記錄 NUT-00410 的營養觀測。[^sheet-source-6294e4799298] 它是未驗證 draft，不能直接用於營養計算。
