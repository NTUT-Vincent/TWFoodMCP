...
food:
  id: food:tw:menu:google-sheet:nut-00404
  kind: menu_item
  market: TW
  brand: 弘爺漢堡
  name: 咔滋雞腿蛋堡
  aliases:
    ...
    - 弘爺漢堡 咔滋雞腿蛋堡
revision:
  revision_id: google-sheet-2026-08-22-nut-00404
serving:
  description: 1個（文章表格）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00404 的營養觀測。[^sheet-source-6294e4799298] 它是未驗證 draft，不能直接用於營養計算。
