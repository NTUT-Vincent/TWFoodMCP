...
food:
  id: food:tw:menu:google-sheet:nut-00417
  kind: menu_item
  market: TW
  brand: 星巴克 Starbucks
  name: 塔香雞腿三明治
  aliases:
    - 塔香雞腿三明治
    - 星巴克 Starbucks塔香雞腿三明治
    - 星巴克 Starbucks 塔香雞腿三明治
revision:
  revision_id: google-sheet-2026-08-22-nut-00417
serving:
  description: 1份（160g）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00417 的營養觀測。[^sheet-source-874192fb5eb8] 它是未驗證 draft，不能直接用於營養計算。
