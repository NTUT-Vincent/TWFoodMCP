...
food:
  id: food:tw:menu:google-sheet:nut-00331
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 油香椒麻蒟蒻
  aliases:
    ...
    - 7-ELEVEN 油香椒麻蒟蒻
revision:
  revision_id: google-sheet-2026-08-22-nut-00331
serving:
  description: 每包150g
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00331 的營養觀測。[^sheet-source-babd95e54f1a] 它是未驗證 draft，不能直接用於營養計算。
