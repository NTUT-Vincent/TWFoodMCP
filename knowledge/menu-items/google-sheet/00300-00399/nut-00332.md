...
food:
  id: food:tw:menu:google-sheet:nut-00332
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 冰烤地瓜
  aliases:
    ...
    - 7-ELEVEN 冰烤地瓜
revision:
  revision_id: google-sheet-2026-08-22-nut-00332
serving:
  description: 每包140g
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00332 的營養觀測。[^sheet-source-babd95e54f1a] 它是未驗證 draft，不能直接用於營養計算。
