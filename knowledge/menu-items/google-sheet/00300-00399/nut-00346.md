...
food:
  id: food:tw:menu:google-sheet:nut-00346
  kind: menu_item
  market: TW
  brand: 全家
  name: 健身G肉餐＋蘋果
  aliases:
    ...
    - 全家 健身G肉餐＋蘋果
revision:
  revision_id: google-sheet-2026-08-22-nut-00346
serving:
...
extraction:
  ...
  source_row:
    ...
    usage_note: 採文章表格總熱量；文章敘述與表格的少數總值不一致，因此以表格為準並降級。文中另稱主餐蛋白質 29g，但未提供完整組合蛋白質總值。 商品可能已更新或停產。
source_observation:
  usage_note: 採文章表格總熱量；文章敘述與表格的少數總值不一致，因此以表格為準並降級。文中另稱主餐蛋白質 29g，但未提供完整組合蛋白質總值。 商品可能已更新或停產。
...
此文件保存試算表記錄 NUT-00346 的營養觀測。[^sheet-source-5ec1a1247e42] 它是未驗證 draft，不能直接用於營養計算。
