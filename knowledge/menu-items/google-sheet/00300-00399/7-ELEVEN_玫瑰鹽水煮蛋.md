...
food:
  id: food:tw:menu:google-sheet:nut-00335
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 玫瑰鹽水煮蛋
  aliases:
    ...
    - 7-ELEVEN 玫瑰鹽水煮蛋
revision:
  revision_id: google-sheet-2026-08-22-nut-00335
serving:
  description: 1包（2顆）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00335 的營養觀測。[^sheet-source-babd95e54f1a] 它是未驗證 draft，不能直接用於營養計算。
