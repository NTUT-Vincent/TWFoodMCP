...
food:
  id: food:tw:menu:google-sheet:nut-00326
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 田園烤菇雞肉堡＋卡布奇諾
  aliases:
    - 田園烤菇雞肉堡＋卡布奇諾
    - 7-ELEVEN田園烤菇雞肉堡＋卡布奇諾
    - 7-ELEVEN 田園烤菇雞肉堡＋卡布奇諾
revision:
  revision_id: google-sheet-2026-08-22-nut-00326
serving:
...
此文件保存試算表記錄 NUT-00326 的營養觀測。[^sheet-source-4e6824f638cd] 它是未驗證 draft，不能直接用於營養計算。
