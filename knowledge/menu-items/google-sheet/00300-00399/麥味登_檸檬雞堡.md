...
food:
  id: food:tw:menu:google-sheet:nut-00369
  kind: menu_item
  market: TW
  brand: 麥味登
  name: 檸檬雞堡
  aliases:
    ...
    - 麥味登 檸檬雞堡
revision:
  revision_id: google-sheet-2026-08-22-nut-00369
serving:
  description: 1個（文章表格）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00369 的營養觀測。[^sheet-source-6294e4799298] 它是未驗證 draft，不能直接用於營養計算。
