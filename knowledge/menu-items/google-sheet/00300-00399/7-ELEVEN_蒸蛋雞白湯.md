...
food:
  id: food:tw:menu:google-sheet:nut-00338
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 蒸蛋雞白湯
  aliases:
    ...
    - 7-ELEVEN 蒸蛋雞白湯
revision:
  revision_id: google-sheet-2026-08-22-nut-00338
serving:
  description: 1碗
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00338 的營養觀測。[^sheet-source-babd95e54f1a] 它是未驗證 draft，不能直接用於營養計算。
