...
food:
  id: food:tw:menu:google-sheet:nut-00390
  kind: menu_item
  market: TW
  brand: 拉亞漢堡
  name: 烙烤雞腿漢堡
  aliases:
    ...
    - 拉亞漢堡 烙烤雞腿漢堡
revision:
  revision_id: google-sheet-2026-08-22-nut-00390
serving:
  description: 1個（文章表格）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00390 的營養觀測。[^sheet-source-6294e4799298] 它是未驗證 draft，不能直接用於營養計算。
