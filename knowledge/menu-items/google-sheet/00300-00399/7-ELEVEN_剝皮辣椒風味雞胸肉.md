...
food:
  id: food:tw:menu:google-sheet:nut-00333
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 剝皮辣椒風味雞胸肉
  aliases:
    ...
    - 7-ELEVEN 剝皮辣椒風味雞胸肉
revision:
  revision_id: google-sheet-2026-08-22-nut-00333
nutrition:
  - basis: per_100g
    values:
      energy_kcal: 115.7
...
此文件保存試算表記錄 NUT-00333 的營養觀測。[^sheet-source-babd95e54f1a] 它是未驗證 draft，不能直接用於營養計算。
