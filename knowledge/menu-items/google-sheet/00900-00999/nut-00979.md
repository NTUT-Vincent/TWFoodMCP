...
food:
  id: food:tw:menu:google-sheet:nut-00979
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 虱目魚丸
  aliases:
    ...
    - 7-ELEVEN 虱目魚丸
revision:
  revision_id: google-sheet-2026-08-22-nut-00979
serving:
  description: 1個
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00979 的營養觀測。[^sheet-source-5712e0ba5815] 它是未驗證 draft，不能直接用於營養計算。
