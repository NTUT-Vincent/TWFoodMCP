...
food:
  id: food:tw:menu:google-sheet:nut-00973
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 滷味香蔥肉丸
  aliases:
    ...
    - 7-ELEVEN 滷味香蔥肉丸
revision:
  revision_id: google-sheet-2026-08-22-nut-00973
serving:
  description: 1個
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    usage_note: 7-ELEVEN 品牌官方商品頁直接列出單件熱量與價格；頁面未提供的營養素保持空白，實際包裝／門市公告優先。 本次官方頁顯示84 kcal；2026-08-05同來源舊觀測為70.9 kcal，判定為營養值變更版本並保留舊列。
source_observation:
  price_twd: 20
  usage_note: 7-ELEVEN 品牌官方商品頁直接列出單件熱量與價格；頁面未提供的營養素保持空白，實際包裝／門市公告優先。 本次官方頁顯示84 kcal；2026-08-05同來源舊觀測為70.9 kcal，判定為營養值變更版本並保留舊列。
...
此文件保存試算表記錄 NUT-00973 的營養觀測。[^sheet-source-5712e0ba5815] 它是未驗證 draft，不能直接用於營養計算。
