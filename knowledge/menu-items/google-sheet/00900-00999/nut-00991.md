...
food:
  id: food:tw:menu:google-sheet:nut-00991
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 吉士豬肉堡加蛋
  aliases:
    ...
    - 7-ELEVEN 吉士豬肉堡加蛋
revision:
  revision_id: google-sheet-2026-08-22-nut-00991
serving:
  description: 1份（官方頁）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00991 的營養觀測。[^sheet-source-65eb971a22a7] 它是未驗證 draft，不能直接用於營養計算。
