...
food:
  id: food:tw:menu:google-sheet:nut-00993
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 海鮮蛋白棒
  aliases:
    ...
    - 7-ELEVEN 海鮮蛋白棒
revision:
  revision_id: google-sheet-2026-08-22-nut-00993
serving:
  description: 1個
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00993 的營養觀測。[^sheet-source-2ef63d020c6d] 它是未驗證 draft，不能直接用於營養計算。
