...
food:
  id: food:tw:menu:marugame-seimen:明太蛋拌烏龍麵中
  kind: menu_item
  market: TW
  brand: 丸龜製麵
  name: 明太蛋拌烏龍麵（中）
  aliases:
    ...
    - 丸龜製麵 明太蛋拌烏龍麵（中）
revision:
  revision_id: google-sheet-2026-08-22-nut-00819
serving:
  description: 1份（中）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00819 的營養觀測。[^sheet-source-87dbffd46be8] 它是未驗證 draft，不能直接用於營養計算。
