---
type: Food Product
title: 萊爾富 Hi-Life 秘製烤雞蛋白餐
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.instagram.com/p/DXzGB1BIFbj/
tags:
  - 萊爾富 Hi-Life
  - 餐盒
  - TWFood 共筆
...
sources:
  - id: sheet-source-64fb71e643e6
    resource: https://www.instagram.com/p/DXzGB1BIFbj/
    title: 萊爾富秘製烤雞蛋白餐實拍
    source_class: community_submission
    last_modified: 2026-05-01T00:00:00+08:00
    retrieved_at: 2026-08-08T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-00996
  kind: menu_item
  market: TW
  brand: 萊爾富 Hi-Life
  name: 秘製烤雞蛋白餐
  aliases:
    ...
    - 萊爾富 Hi-Life 秘製烤雞蛋白餐
revision:
  revision_id: google-sheet-2026-08-22-nut-00996
serving:
...
extraction:
  ...
  source_row:
    ...
    source_publisher: Instagram
    source_author: "@foodie__tzu"
    source_title: 萊爾富秘製烤雞蛋白餐實拍
    source_url: https://www.instagram.com/p/DXzGB1BIFbj/
    article_updated_at: 46143
    accessed_at: 46242
    primary_source_url: null
    usage_note: 可追溯社群實拍／OCR列出商品名、熱量、蛋白質與價格；未核對萊爾富官方或現行包裝，列待驗證。
source_observation:
  price_twd: 99
  usage_note: 可追溯社群實拍／OCR列出商品名、熱量、蛋白質與價格；未核對萊爾富官方或現行包裝，列待驗證。
...
此文件保存試算表記錄 NUT-00996 的營養觀測。[^sheet-source-64fb71e643e6] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-64fb71e643e6]: 萊爾富秘製烤雞蛋白餐實拍
