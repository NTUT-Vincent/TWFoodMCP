...
food:
  id: food:tw:menu:google-sheet:nut-00982
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 關東煮科學麵
  aliases:
    ...
    - 7-ELEVEN 關東煮科學麵
revision:
  revision_id: google-sheet-2026-08-22-nut-00982
serving:
  description: 1包
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00982 的營養觀測。[^sheet-source-5712e0ba5815] 它是未驗證 draft，不能直接用於營養計算。
