...
food:
  id: food:tw:menu:google-sheet:nut-00984
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 獨饗三起司蔥抓餅
  aliases:
    ...
    - 7-ELEVEN 獨饗三起司蔥抓餅
revision:
  revision_id: google-sheet-2026-08-22-nut-00984
serving:
  description: 1份（官方頁）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00984 的營養觀測。[^sheet-source-0bdfeb34901d] 它是未驗證 draft，不能直接用於營養計算。
