---
type: Food Product
title: 7-ELEVEN 日式豆皮蕎麥風味冷麵
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.threads.com/@ningning_dietitian/post/DLqp8F1ylg_
tags:
  - 7-ELEVEN
  - 麵食／冷麵
  - TWFood 共筆
...
sources:
  - id: sheet-source-0e2be1316a82
    resource: https://www.threads.com/@ningning_dietitian/post/DLqp8F1ylg_
    title: 7-ELEVEN 日式豆皮蕎麥風味冷麵營養標示抽查
    source_class: community_submission
    last_modified: 2025-07-03T00:00:00+08:00
    retrieved_at: 2026-08-18T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-01160
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 日式豆皮蕎麥風味冷麵
  aliases:
    ...
    - 7-ELEVEN 日式豆皮蕎麥風味冷麵
revision:
  revision_id: google-sheet-2026-08-22-nut-01160
serving:
  description: 1份（完整包裝）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: Threads
    source_author: 寧寧營養師
    source_title: 7-ELEVEN 日式豆皮蕎麥風味冷麵營養標示抽查
    source_url: https://www.threads.com/@ningning_dietitian/post/DLqp8F1ylg_
    article_updated_at: 45841
    accessed_at: 46252
    primary_source_url: null
    usage_note: 2025年營養師社群貼文轉錄包裝營養標示；非品牌官方值，現行品項與配方待核對。
source_observation:
  usage_note: 2025年營養師社群貼文轉錄包裝營養標示；非品牌官方值，現行品項與配方待核對。
...
此文件保存試算表記錄 NUT-01160 的營養觀測。[^sheet-source-0e2be1316a82] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-0e2be1316a82]: 7-ELEVEN 日式豆皮蕎麥風味冷麵營養標示抽查
