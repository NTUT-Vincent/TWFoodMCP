---
type: Food Product
title: 7-ELEVEN 鮪魚雞蛋蔬菜捲餅
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.threads.com/@ningning_dietitian/post/DLBjIMFSyv9
tags:
  - 7-ELEVEN
  - 捲餅
  - TWFood 共筆
...
sources:
  - id: sheet-source-49aa268e1cbe
    resource: https://www.threads.com/@ningning_dietitian/post/DLBjIMFSyv9
    title: 7-ELEVEN 鮪魚雞蛋蔬菜捲餅營養標示抽查
    source_class: community_submission
    last_modified: 2025-06-17T00:00:00+08:00
    retrieved_at: 2026-08-14T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-01120
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 鮪魚雞蛋蔬菜捲餅
  aliases:
    ...
    - 7-ELEVEN 鮪魚雞蛋蔬菜捲餅
revision:
  revision_id: google-sheet-2026-08-22-nut-01120
serving:
  description: 1份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: Threads
    source_author: "@ningning_dietitian"
    source_title: 7-ELEVEN 鮪魚雞蛋蔬菜捲餅營養標示抽查
    source_url: https://www.threads.com/@ningning_dietitian/post/DLBjIMFSyv9
    article_updated_at: 45825
    accessed_at: 46248
...
此文件保存試算表記錄 NUT-01120 的營養觀測。[^sheet-source-49aa268e1cbe] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-49aa268e1cbe]: 7-ELEVEN 鮪魚雞蛋蔬菜捲餅營養標示抽查
