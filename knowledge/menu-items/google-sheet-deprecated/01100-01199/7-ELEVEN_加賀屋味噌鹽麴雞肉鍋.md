---
type: Food Product
title: 7-ELEVEN 加賀屋味噌鹽麴雞肉鍋
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.threads.com/@ningning_dietitian/post/DEzlIxazGLm
tags:
  - 7-ELEVEN
  - 湯品／鍋物
  - TWFood 共筆
...
sources:
  - id: sheet-source-419f16b3ef43
    resource: https://www.threads.com/@ningning_dietitian/post/DEzlIxazGLm
    title: 7-ELEVEN 加賀屋味噌鹽麴雞肉鍋營養標示抽查
    source_class: community_submission
    last_modified: 2025-01-14T00:00:00+08:00
    retrieved_at: 2026-08-19T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-01185
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 加賀屋味噌鹽麴雞肉鍋
  aliases:
    ...
    - 7-ELEVEN 加賀屋味噌鹽麴雞肉鍋
revision:
  revision_id: google-sheet-2026-08-22-nut-01185
serving:
  description: 1份（完整包裝）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: Threads
    source_author: 寧寧營養師
    source_title: 7-ELEVEN 加賀屋味噌鹽麴雞肉鍋營養標示抽查
    source_url: https://www.threads.com/@ningning_dietitian/post/DEzlIxazGLm
    article_updated_at: 45671
    accessed_at: 46253
...
此文件保存試算表記錄 NUT-01185 的營養觀測。[^sheet-source-419f16b3ef43] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-419f16b3ef43]: 7-ELEVEN 加賀屋味噌鹽麴雞肉鍋營養標示抽查
