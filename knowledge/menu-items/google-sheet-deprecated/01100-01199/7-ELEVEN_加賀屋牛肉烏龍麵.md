---
type: Food Product
title: 7-ELEVEN 加賀屋牛肉烏龍麵
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.threads.com/@ningning_dietitian/post/DUURjHakbRO
tags:
  - 7-ELEVEN
  - 麵食
  - TWFood 共筆
...
sources:
  - id: sheet-source-1a56312f16bd
    resource: https://www.threads.com/@ningning_dietitian/post/DUURjHakbRO
    title: 7-ELEVEN 加賀屋牛肉烏龍麵營養標示抽查
    source_class: community_submission
    last_modified: 2026-02-03T00:00:00+08:00
    retrieved_at: 2026-08-19T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-01180
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 加賀屋牛肉烏龍麵
  aliases:
    ...
    - 7-ELEVEN 加賀屋牛肉烏龍麵
revision:
  revision_id: google-sheet-2026-08-22-nut-01180
serving:
  description: 1份（完整包裝）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: Threads
    source_author: 寧寧營養師
    source_title: 7-ELEVEN 加賀屋牛肉烏龍麵營養標示抽查
    source_url: https://www.threads.com/@ningning_dietitian/post/DUURjHakbRO
    article_updated_at: 46056
    accessed_at: 46253
...
此文件保存試算表記錄 NUT-01180 的營養觀測。[^sheet-source-1a56312f16bd] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-1a56312f16bd]: 7-ELEVEN 加賀屋牛肉烏龍麵營養標示抽查
