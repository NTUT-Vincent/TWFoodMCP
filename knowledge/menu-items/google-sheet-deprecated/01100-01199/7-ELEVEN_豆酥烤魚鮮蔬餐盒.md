---
type: Food Product
title: 7-ELEVEN 豆酥烤魚鮮蔬餐盒
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.threads.com/@ningning_dietitian/post/DOXKl-7EgkP
tags:
  - 7-ELEVEN
  - 餐盒
  - TWFood 共筆
...
sources:
  - id: sheet-source-6d6f9e42654f
    resource: https://www.threads.com/@ningning_dietitian/post/DOXKl-7EgkP
    title: 7-ELEVEN 豆酥烤魚鮮蔬餐盒營養標示抽查
    source_class: community_submission
    last_modified: 2025-09-08T00:00:00+08:00
    retrieved_at: 2026-08-19T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-01184
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 豆酥烤魚鮮蔬餐盒
  aliases:
    ...
    - 7-ELEVEN 豆酥烤魚鮮蔬餐盒
revision:
  revision_id: google-sheet-2026-08-22-nut-01184
serving:
  description: 1份（完整包裝）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: Threads
    source_author: 寧寧營養師
    source_title: 7-ELEVEN 豆酥烤魚鮮蔬餐盒營養標示抽查
    source_url: https://www.threads.com/@ningning_dietitian/post/DOXKl-7EgkP
    article_updated_at: 45908
    accessed_at: 46253
...
此文件保存試算表記錄 NUT-01184 的營養觀測。[^sheet-source-6d6f9e42654f] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-6d6f9e42654f]: 7-ELEVEN 豆酥烤魚鮮蔬餐盒營養標示抽查
