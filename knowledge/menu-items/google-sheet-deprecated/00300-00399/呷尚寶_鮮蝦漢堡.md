...
sources:
  ...
  - id: sheet-primary-fbcdd3eae7a1
    resource: https://www.twjsp.com.tw
    title: 試算表列出的原始／官方來源
...
food:
  id: food:tw:menu:google-sheet:nut-00398
  kind: menu_item
  market: TW
  brand: 呷尚寶
  name: 鮮蝦漢堡
  aliases:
    ...
    - 呷尚寶 鮮蝦漢堡
revision:
  revision_id: google-sheet-2026-08-22-nut-00398
serving:
  description: 1個（文章表格）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    accessed_at: 46239
    primary_source_url: https://www.twjsp.com.tw
...
此文件保存試算表記錄 NUT-00398 的營養觀測。[^sheet-source-6294e4799298] 它是未驗證 draft，不能直接用於營養計算。
