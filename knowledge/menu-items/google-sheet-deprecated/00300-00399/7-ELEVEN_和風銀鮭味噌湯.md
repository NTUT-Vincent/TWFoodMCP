...
food:
  id: food:tw:menu:google-sheet:nut-00337
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 和風銀鮭味噌湯
  aliases:
    ...
    - 7-ELEVEN 和風銀鮭味噌湯
revision:
  revision_id: google-sheet-2026-08-22-nut-00337
serving:
  description: 1碗
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00337 的營養觀測。[^sheet-source-babd95e54f1a] 它是未驗證 draft，不能直接用於營養計算。
