...
food:
  id: food:tw:menu:google-sheet:nut-00349
  kind: menu_item
  market: TW
  brand: 全家
  name: 美式雞丁餐盒
  aliases:
    ...
    - 全家 美式雞丁餐盒
revision:
  revision_id: google-sheet-2026-08-22-nut-00349
serving:
...
此文件保存試算表記錄 NUT-00349 的營養觀測。[^sheet-source-5ec1a1247e42] 它是未驗證 draft，不能直接用於營養計算。
