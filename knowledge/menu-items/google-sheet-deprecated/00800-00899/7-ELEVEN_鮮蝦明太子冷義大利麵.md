...
food:
  id: food:tw:menu:google-sheet:nut-00890
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 鮮蝦明太子冷義大利麵
  aliases:
    ...
    - 7-ELEVEN 鮮蝦明太子冷義大利麵
revision:
  revision_id: google-sheet-2026-08-22-nut-00890
serving:
  description: 1份（官方頁）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00890 的營養觀測。[^sheet-source-cc8ff9d8a4ca] 它是未驗證 draft，不能直接用於營養計算。
