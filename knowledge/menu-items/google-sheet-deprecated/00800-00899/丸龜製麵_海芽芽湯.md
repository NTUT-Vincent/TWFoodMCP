...
food:
  id: food:tw:menu:google-sheet:nut-00828
  kind: menu_item
  market: TW
  brand: 丸龜製麵
  name: 海芽芽湯
  aliases:
    ...
    - 丸龜製麵 海芽芽湯
revision:
  revision_id: google-sheet-2026-08-22-nut-00828
serving:
  description: 1份
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00828 的營養觀測。[^sheet-source-87dbffd46be8] 它是未驗證 draft，不能直接用於營養計算。
