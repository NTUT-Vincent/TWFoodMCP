...
food:
  id: food:tw:menu:google-sheet:nut-00851
  kind: menu_item
  market: TW
  brand: 台灣熱門泡麵
  name: 維力炸醬麵
  aliases:
    ...
    - 台灣熱門泡麵 維力炸醬麵
revision:
  revision_id: google-sheet-2026-08-22-nut-00851
serving:
  description: 1包（90g）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00851 的營養觀測。[^sheet-source-49626023e68c] 它是未驗證 draft，不能直接用於營養計算。
