...
food:
  id: food:tw:menu:google-sheet:nut-01088
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 肉鬆火腿蛋三明治
  aliases:
    ...
    - 7-ELEVEN 肉鬆火腿蛋三明治
revision:
  revision_id: google-sheet-2026-08-22-nut-01088
serving:
...
此文件保存試算表記錄 NUT-01088 的營養觀測。[^sheet-source-65eb971a22a7] 它是未驗證 draft，不能直接用於營養計算。
