...
food:
  id: food:tw:menu:google-sheet:nut-01069
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: (蔬)酸辣湯
  aliases:
    ...
    - 7-ELEVEN (蔬)酸辣湯
revision:
  revision_id: google-sheet-2026-08-22-nut-01069
serving:
...
此文件保存試算表記錄 NUT-01069 的營養觀測。[^sheet-source-0bdfeb34901d] 它是未驗證 draft，不能直接用於營養計算。
