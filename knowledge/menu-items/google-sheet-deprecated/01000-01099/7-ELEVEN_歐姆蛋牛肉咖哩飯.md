...
food:
  id: food:tw:menu:google-sheet:nut-01013
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 歐姆蛋牛肉咖哩飯
  aliases:
    ...
    - 7-ELEVEN 歐姆蛋牛肉咖哩飯
revision:
  revision_id: google-sheet-2026-08-22-nut-01013
serving:
...
此文件保存試算表記錄 NUT-01013 的營養觀測。[^sheet-source-d659239144a6] 它是未驗證 draft，不能直接用於營養計算。
