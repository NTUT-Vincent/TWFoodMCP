...
food:
  id: food:tw:menu:google-sheet:nut-01010
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 吉士雞肉蛋堡
  aliases:
    ...
    - 7-ELEVEN 吉士雞肉蛋堡
revision:
  revision_id: google-sheet-2026-08-22-nut-01010
serving:
...
此文件保存試算表記錄 NUT-01010 的營養觀測。[^sheet-source-65eb971a22a7] 它是未驗證 draft，不能直接用於營養計算。
