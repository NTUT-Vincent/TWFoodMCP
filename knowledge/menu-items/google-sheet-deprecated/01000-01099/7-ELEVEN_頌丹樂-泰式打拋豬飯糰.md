...
food:
  id: food:tw:menu:google-sheet:nut-01008
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 頌丹樂-泰式打拋豬飯糰
  aliases:
    - 頌丹樂-泰式打拋豬飯糰
    - 7-ELEVEN頌丹樂-泰式打拋豬飯糰
    - 7-ELEVEN 頌丹樂-泰式打拋豬飯糰
revision:
  revision_id: google-sheet-2026-08-22-nut-01008
serving:
...
此文件保存試算表記錄 NUT-01008 的營養觀測。[^sheet-source-43e12c98986e] 它是未驗證 draft，不能直接用於營養計算。
