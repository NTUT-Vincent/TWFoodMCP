...
food:
  id: food:tw:menu:google-sheet:nut-01065
  kind: menu_item
  market: TW
  brand: 萊爾富 Hi-Life
  name: 雞胸輕烤蛋白餐
  aliases:
    ...
    - 萊爾富 Hi-Life 雞胸輕烤蛋白餐
revision:
  revision_id: google-sheet-2026-08-22-nut-01065
serving:
  description: 1盒（文章列示）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-01065 的營養觀測。[^sheet-source-91e20b349fca] 它是未驗證 draft，不能直接用於營養計算。
