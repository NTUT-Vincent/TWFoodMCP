...
food:
  id: food:tw:menu:google-sheet:nut-01004
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 日式豆皮蕎麥風味冷麵
  aliases:
    ...
    - 7-ELEVEN 日式豆皮蕎麥風味冷麵
revision:
  revision_id: google-sheet-2026-08-22-nut-01004
serving:
...
此文件保存試算表記錄 NUT-01004 的營養觀測。[^sheet-source-11ccb5a910a7] 它是未驗證 draft，不能直接用於營養計算。
