...
food:
  id: food:tw:menu:google-sheet:nut-00201
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 蜂蜜柚子霜淇淋
  aliases:
    ...
    - 7-ELEVEN 蜂蜜柚子霜淇淋
revision:
  revision_id: google-sheet-2026-08-22-nut-00201
serving:
...
此文件保存試算表記錄 NUT-00201 的營養觀測。[^sheet-source-2ef63d020c6d] 它是未驗證 draft，不能直接用於營養計算。
