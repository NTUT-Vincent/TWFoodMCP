...
food:
  id: food:tw:menu:google-sheet:nut-00196
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 極饗－香腸雙拼便當
  aliases:
    ...
    - 7-ELEVEN 極饗－香腸雙拼便當
revision:
  revision_id: google-sheet-2026-08-22-nut-00196
serving:
...
此文件保存試算表記錄 NUT-00196 的營養觀測。[^sheet-source-d659239144a6] 它是未驗證 draft，不能直接用於營養計算。
