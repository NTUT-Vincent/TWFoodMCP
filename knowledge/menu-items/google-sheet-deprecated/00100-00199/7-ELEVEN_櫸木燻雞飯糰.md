...
food:
  id: food:tw:menu:google-sheet:nut-00198
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  name: 櫸木燻雞飯糰
  aliases:
    ...
    - 7-ELEVEN 櫸木燻雞飯糰
revision:
  revision_id: google-sheet-2026-08-22-nut-00198
serving:
...
此文件保存試算表記錄 NUT-00198 的營養觀測。[^sheet-source-fa50557cb1f4] 它是未驗證 draft，不能直接用於營養計算。
