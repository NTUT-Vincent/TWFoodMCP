...
food:
  id: food:tw:menu:google-sheet:nut-00415
  kind: menu_item
  market: TW
  brand: SUBWAY
  name: 照燒雞肉潛艇堡
  aliases:
    ...
    - SUBWAY 照燒雞肉潛艇堡
revision:
  revision_id: google-sheet-2026-08-22-nut-00415
serving:
  description: 1份（257g）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    record_id: NUT-00415
    food_name: 照燒雞肉潛艇堡
    brand_or_context: SUBWAY
    category: 潛艇堡
    serving_basis: 1份（257g）
    calories_kcal: 362
    protein_g: 27
    fat_g: 7.3
    saturated_fat_g: 2.6
...
此文件保存試算表記錄 NUT-00415 的營養觀測。[^sheet-source-874192fb5eb8] 它是未驗證 draft，不能直接用於營養計算。
