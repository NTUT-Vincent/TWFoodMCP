...
food:
  id: food:tw:menu:google-sheet:nut-00760
  kind: menu_item
  market: TW
  brand: 八方雲集
  name: 酸辣湯
  aliases:
    ...
    - 八方雲集 酸辣湯
revision:
  revision_id: google-sheet-2026-08-22-nut-00760
serving:
  description: 1碗（文章以360g估算）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    usage_note: 文章表格轉錄／估算熱量；份量與現行配方仍需品牌官方或門市標示核對。
source_observation:
  usage_note: 文章表格轉錄／估算熱量；份量與現行配方仍需品牌官方或門市標示核對。
...
此文件保存試算表記錄 NUT-00760 的營養觀測。[^sheet-source-d916121be823] 它是未驗證 draft，不能直接用於營養計算。
