...
food:
  id: food:tw:menu:google-sheet:nut-00757
  kind: menu_item
  market: TW
  brand: 八方雲集
  name: 麻辣牛湯珍珠餛飩
  aliases:
    ...
    - 八方雲集 麻辣牛湯珍珠餛飩
revision:
  revision_id: google-sheet-2026-08-22-nut-00757
serving:
...
此文件保存試算表記錄 NUT-00757 的營養觀測。[^sheet-source-d916121be823] 它是未驗證 draft，不能直接用於營養計算。
