...
food:
  id: food:tw:menu:google-sheet:nut-00743
  kind: menu_item
  market: TW
  brand: 八方雲集
  name: 紅燒牛肉麵
  aliases:
    ...
    - 八方雲集 紅燒牛肉麵
revision:
  revision_id: google-sheet-2026-08-22-nut-00743
serving:
  description: 1碗（文章以665g估算）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    usage_note: 文章營養師依指定碗重估算熱量；實際門市份量、湯汁與配方可能不同。
source_observation:
  usage_note: 文章營養師依指定碗重估算熱量；實際門市份量、湯汁與配方可能不同。
...
此文件保存試算表記錄 NUT-00743 的營養觀測。[^sheet-source-d916121be823] 它是未驗證 draft，不能直接用於營養計算。
