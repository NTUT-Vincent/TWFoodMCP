...
food:
  id: food:tw:menu:google-sheet:nut-00648
  kind: menu_item
  market: TW
  brand: 麻古茶坊
  name: 芝芝錫蘭紅茶
  aliases:
    ...
    - 麻古茶坊 芝芝錫蘭紅茶
revision:
  revision_id: google-sheet-2026-08-22-nut-00648
serving:
...
此文件保存試算表記錄 NUT-00648 的營養觀測。[^sheet-source-466715605c89] 它是未驗證 draft，不能直接用於營養計算。
