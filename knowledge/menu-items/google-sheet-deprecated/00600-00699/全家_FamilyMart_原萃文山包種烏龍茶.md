---
type: Food Product
title: 全家 FamilyMart 原萃文山包種烏龍茶
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/3130211
tags:
  - 全家 FamilyMart
  - 茶飲
  - TWFood 共筆
...
sources:
  - id: sheet-source-76806bfc72c4
    resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/3130211
    title: 原萃文山包種烏龍茶－全家食在購安心
    source_class: primary_official
    retrieved_at: 2026-08-06T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:google-sheet:nut-00603
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 原萃文山包種烏龍茶
  aliases:
    - 原萃文山包種烏龍茶
    - 全家 FamilyMart原萃文山包種烏龍茶
    - 全家 FamilyMart 原萃文山包種烏龍茶
revision:
  revision_id: google-sheet-2026-08-22-nut-00603
serving:
  description: 每份290毫升（本包裝含2份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 原萃文山包種烏龍茶－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/3130211
...
此文件保存試算表記錄 NUT-00603 的營養觀測。[^sheet-source-76806bfc72c4] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-76806bfc72c4]: 原萃文山包種烏龍茶－全家食在購安心
