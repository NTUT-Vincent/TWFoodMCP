...
food:
  id: food:tw:menu:dailydietitian:8a7eb396ddd566876613
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 無糖紅茶 (冰) (M)
  aliases:
    ...
    - 麥當勞 無糖紅茶 (冰) (M)
revision:
  revision_id: dailydietitian-2026-08-02-8a7eb396ddd5
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 0
...
extraction:
  ...
  candidate_id: dd:8a7eb396ddd566876613
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:iced-black-tea-sugar-free
  existing_title: 麥當勞 無糖紅茶 (冰)
  existing_file_path: knowledge/menu-items/mcdonalds/iced-black-tea-sugar-free.md
  comparison:
    corroborated: true
    compared:
      - &a1
