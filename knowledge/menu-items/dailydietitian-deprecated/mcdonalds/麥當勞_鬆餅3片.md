...
food:
  id: food:tw:menu:dailydietitian:e5af7c9d7ccd7c47217c
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 鬆餅3片
  aliases:
    ...
    - 麥當勞 鬆餅3片
revision:
  revision_id: dailydietitian-2026-08-02-e5af7c9d7ccd
serving:
  amount: 3
  unit: piece
  description: 鬆餅3片
...
extraction:
  ...
  candidate_id: dd:e5af7c9d7ccd7c47217c
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:hotcakes-3-pieces
  existing_title: 麥當勞 鬆餅(3片)
  existing_file_path: knowledge/menu-items/mcdonalds/hotcakes-3-pieces.md
  comparison:
    corroborated: true
    compared:
      - &a1
      ...
      - &a8
        field: sodium_mg
        candidate_value: 711.4
        official_value: 711.4
        delta: 0
        tolerance: 14.228
    matched:
      - *a1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 鬆餅3片 | 59 | 319 | 8 | 8.6 | 1.7 | 0.1 | 53 | 11 | 711.4 |
