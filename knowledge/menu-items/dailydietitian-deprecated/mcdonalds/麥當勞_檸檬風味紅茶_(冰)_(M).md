...
food:
  id: food:tw:menu:dailydietitian:c983d5c9e26d82887cc7
  kind: menu_item
  market: TW
  brand: 麥當勞
  name: 檸檬風味紅茶 (冰) (M)
  aliases:
    ...
    - 麥當勞 檸檬風味紅茶 (冰) (M)
revision:
  revision_id: dailydietitian-2026-08-02-c983d5c9e26d
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 163.88
...
extraction:
  ...
  candidate_id: dd:c983d5c9e26d82887cc7
...
official_review_hint:
  ...
  existing_food_id: food:tw:menu:mcdonalds:iced-black-tea-lemon-flavor
  existing_title: 麥當勞 檸檬風味紅茶(冰)(小)
  existing_file_path: knowledge/menu-items/mcdonalds/iced-black-tea-lemon-flavor.md
  comparison:
    corroborated: false
    compared:
      - &a6
        field: energy_kcal
        candidate_value: 163.88
        official_value: 122.99
        delta: 40.89
        tolerance: 1.2299
      - &a1
        field: protein_g
      ...
      - &a5
        field: sodium_mg
        candidate_value: 19.9
        official_value: 14.9
        delta: 4.999999999999998
        tolerance: 5
    matched:
      - *a1
      - *a2
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 檸檬風味紅茶 (冰) (M) | 38 | 163.88 | 0 | 0 | 0 | 0 | 41 | 40 | 19.9 |
