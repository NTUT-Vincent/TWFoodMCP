---
type: Food Product
title: 7-ELEVEN HERSHEY’S好時經典可可 (大冰)
...
food:
  id: food:tw:menu:dailydietitian:f0203fd1570860de26d2
  kind: menu_item
  market: TW
  brand: 7-ELEVEN
  ...
  aliases:
    - HERSHEY’S好時經典可可 (大冰)
    - 7-ELEVENHERSHEY’S好時經典可可 (大冰)
    - 7-ELEVEN HERSHEY’S好時經典可可 (大冰)
revision:
  revision_id: dailydietitian-2026-08-02-f0203fd15708
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 455.7
...
extraction:
  ...
  candidate_id: dd:f0203fd1570860de26d2
...
| --- | --- | --- | --- |
| HERSHEY’S好時經典可可 (大冰) | 455.7 | 41.6 | 44.7 |
