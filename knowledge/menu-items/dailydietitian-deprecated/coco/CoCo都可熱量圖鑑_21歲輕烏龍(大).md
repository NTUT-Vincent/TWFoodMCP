...
food:
  id: food:tw:menu:dailydietitian:a571493cb1711a2070bc
  kind: menu_item
  market: TW
  brand: CoCo都可熱量圖鑑
  name: 21歲輕烏龍（大）
  aliases:
    ...
    - CoCo都可熱量圖鑑 21歲輕烏龍（大）
revision:
  revision_id: dailydietitian-2026-08-02-a571493cb171
nutrition:
  - basis: per_serving
    values:
      sugar_g: 33
...
extraction:
  ...
  candidate_id: dd:a571493cb1711a2070bc
