...
food:
  id: food:tw:menu:dailydietitian:34f1b7f3b3aaf4e1c2c1
  kind: menu_item
  market: TW
  brand: 路易莎咖啡
  name: 榛果風味拿鐵 (中/冰)
  aliases:
    ...
    - 路易莎咖啡 榛果風味拿鐵 (中/冰)
revision:
  revision_id: dailydietitian-2026-08-02-34f1b7f3b3aa
nutrition:
  - basis: per_serving
    values:
      sugar_g: 32.8
...
extraction:
  ...
  candidate_id: dd:34f1b7f3b3aaf4e1c2c1
