...
food:
  id: food:tw:menu:dailydietitian:1d8e09dfe04824476755
  kind: menu_item
  market: TW
  brand: 丸龜製麵
  name: 玉米筍（四個）
  aliases:
    ...
    - 丸龜製麵 玉米筍（四個）
revision:
  revision_id: dailydietitian-2026-08-02-1d8e09dfe048
nutrition:
  - basis: per_serving
    values:
      energy_kcal: 30
...
extraction:
  ...
  candidate_id: dd:1d8e09dfe04824476755
