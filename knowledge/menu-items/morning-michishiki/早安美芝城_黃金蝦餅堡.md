...
food:
  id: food:tw:menu:morning-michishiki:黃金蝦餅堡
  kind: menu_item
  market: TW
  brand: 早安美芝城
  name: 黃金蝦餅堡
  aliases:
    ...
    - 早安美芝城 黃金蝦餅堡
revision:
  revision_id: google-sheet-2026-08-22-nut-00355
serving:
  description: 1個（文章表格）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00355 的營養觀測。[^sheet-source-6294e4799298] 它是未驗證 draft，不能直接用於營養計算。
