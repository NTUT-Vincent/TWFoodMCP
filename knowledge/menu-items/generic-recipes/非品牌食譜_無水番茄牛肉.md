...
food:
  id: food:tw:menu:generic-recipes:無水番茄牛肉
  kind: menu_item
  market: TW
  brand: 非品牌食譜
  name: 無水番茄牛肉
  aliases:
    ...
    - 非品牌食譜 無水番茄牛肉
revision:
  revision_id: google-sheet-2026-08-22-nut-00186
serving:
  description: 文章未明示（材料為4人份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
此文件保存試算表記錄 NUT-00186 的營養觀測。[^sheet-source-1c2dd838b708] 它是未驗證 draft，不能直接用於營養計算。
