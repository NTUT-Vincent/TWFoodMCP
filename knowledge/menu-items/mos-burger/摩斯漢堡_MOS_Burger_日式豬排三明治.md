---
type: Food Product
title: 摩斯漢堡 MOS Burger 日式豬排三明治
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M000047
tags:
  - 摩斯漢堡 MOS Burger
  - 早餐三明治
  - TWFood 共筆
...
sources:
  - id: sheet-source-a45818150f5b
    resource: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M000047
    title: 日式豬排三明治｜官方營養標示
    source_class: primary_official
    retrieved_at: 2026-08-07T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:mos-burger:mos_burger_日式豬排三明治
  kind: menu_item
  market: TW
  ...
  aliases:
    - 日式豬排三明治
    - 摩斯漢堡 MOS Burger日式豬排三明治
    - 摩斯漢堡 MOS Burger 日式豬排三明治
revision:
  revision_id: google-sheet-2026-08-22-nut-00929
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 日式豬排三明治｜官方營養標示
    source_url: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M000047
...
此文件保存試算表記錄 NUT-00929 的營養觀測。[^sheet-source-a45818150f5b] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-a45818150f5b]: 日式豬排三明治｜官方營養標示
