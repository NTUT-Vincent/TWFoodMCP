---
type: Food Product
title: 摩斯漢堡 MOS Burger 摩斯貝果(附草莓醬)
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M001102
tags:
  - 摩斯漢堡 MOS Burger
  - 早餐
  - TWFood 共筆
...
sources:
  - id: sheet-source-494d9caad2e1
    resource: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M001102
    title: 摩斯貝果(附草莓醬)｜官方營養標示
    source_class: primary_official
    retrieved_at: 2026-08-07T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:mos-burger:mos_burger_摩斯貝果附草莓醬
  kind: menu_item
  market: TW
  ...
  aliases:
    - 摩斯貝果(附草莓醬)
    - 摩斯漢堡 MOS Burger摩斯貝果(附草莓醬)
    - 摩斯漢堡 MOS Burger 摩斯貝果(附草莓醬)
revision:
  revision_id: google-sheet-2026-08-22-nut-00925
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 摩斯貝果(附草莓醬)｜官方營養標示
    source_url: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M001102
...
此文件保存試算表記錄 NUT-00925 的營養觀測。[^sheet-source-494d9caad2e1] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-494d9caad2e1]: 摩斯貝果(附草莓醬)｜官方營養標示
