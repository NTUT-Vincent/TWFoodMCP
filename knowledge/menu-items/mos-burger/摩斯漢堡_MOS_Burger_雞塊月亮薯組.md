---
type: Food Product
title: 摩斯漢堡 MOS Burger 雞塊月亮薯組
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/Detail.aspx?id=M001186
tags:
  - 摩斯漢堡 MOS Burger
  - 點心組
  - TWFood 共筆
...
food:
  id: food:tw:menu:mos-burger:mos_burger_雞塊月亮薯組
  kind: menu_item
  market: TW
  ...
  aliases:
    - 雞塊月亮薯組
    - 摩斯漢堡 MOS Burger雞塊月亮薯組
    - 摩斯漢堡 MOS Burger 雞塊月亮薯組
revision:
  revision_id: google-sheet-2026-08-22-nut-00915
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 雞塊月亮薯組｜官方營養標示
    source_url: https://www.mos.com.tw/menu/Detail.aspx?id=M001186
...
此文件保存試算表記錄 NUT-00915 的營養觀測。[^sheet-source-abd3e4b2e0e5] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-abd3e4b2e0e5]: 雞塊月亮薯組｜官方營養標示
