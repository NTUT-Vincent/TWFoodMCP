---
type: Food Product
title: 摩斯漢堡 MOS Burger 耶加雪菲(冰)(M)
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/Detail.aspx?id=M001066
tags:
  - 摩斯漢堡 MOS Burger
  - 咖啡
  - TWFood 共筆
...
sources:
  - id: sheet-source-d092729ccbcb
    resource: https://www.mos.com.tw/menu/Detail.aspx?id=M001066
    title: 耶加雪菲(冰)(M)｜官方營養標示
    source_class: primary_official
    retrieved_at: 2026-08-07T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:mos-burger:mos_burger_耶加雪菲冰m
  kind: menu_item
  market: TW
  ...
  aliases:
    - 耶加雪菲(冰)(M)
    - 摩斯漢堡 MOS Burger耶加雪菲(冰)(M)
    - 摩斯漢堡 MOS Burger 耶加雪菲(冰)(M)
revision:
  revision_id: google-sheet-2026-08-22-nut-00916
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 耶加雪菲(冰)(M)｜官方營養標示
    source_url: https://www.mos.com.tw/menu/Detail.aspx?id=M001066
...
此文件保存試算表記錄 NUT-00916 的營養觀測。[^sheet-source-d092729ccbcb] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-d092729ccbcb]: 耶加雪菲(冰)(M)｜官方營養標示
