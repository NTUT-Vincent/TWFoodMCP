---
type: Food Product
title: 摩斯漢堡 MOS Burger 耶加雪菲(熱)(M)
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/Detail.aspx?id=M001065
tags:
  - 摩斯漢堡 MOS Burger
  - 咖啡
  - TWFood 共筆
...
sources:
  - id: sheet-source-28e815e4f957
    resource: https://www.mos.com.tw/menu/Detail.aspx?id=M001065
    title: 耶加雪菲(熱)(M)｜官方營養標示
    source_class: primary_official
    retrieved_at: 2026-08-07T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:mos-burger:mos_burger_耶加雪菲熱m
  kind: menu_item
  market: TW
  ...
  aliases:
    - 耶加雪菲(熱)(M)
    - 摩斯漢堡 MOS Burger耶加雪菲(熱)(M)
    - 摩斯漢堡 MOS Burger 耶加雪菲(熱)(M)
revision:
  revision_id: google-sheet-2026-08-22-nut-00914
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 耶加雪菲(熱)(M)｜官方營養標示
    source_url: https://www.mos.com.tw/menu/Detail.aspx?id=M001065
...
此文件保存試算表記錄 NUT-00914 的營養觀測。[^sheet-source-28e815e4f957] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-28e815e4f957]: 耶加雪菲(熱)(M)｜官方營養標示
