---
type: Food Product
title: 摩斯漢堡 MOS Burger 凱薩嫩雞三明治(亞麻玄米)
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M001253
tags:
  - 摩斯漢堡 MOS Burger
  - 早餐三明治
  - TWFood 共筆
...
sources:
  - id: sheet-source-2a23b4593959
    resource: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M001253
    title: 凱薩嫩雞三明治(亞麻玄米)｜官方營養標示
    source_class: primary_official
    retrieved_at: 2026-08-07T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:mos-burger:mos_burger_凱薩嫩雞三明治亞麻玄米
  kind: menu_item
  market: TW
  ...
  aliases:
    - 凱薩嫩雞三明治(亞麻玄米)
    - 摩斯漢堡 MOS Burger凱薩嫩雞三明治(亞麻玄米)
    - 摩斯漢堡 MOS Burger 凱薩嫩雞三明治(亞麻玄米)
revision:
  revision_id: google-sheet-2026-08-22-nut-00940
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 凱薩嫩雞三明治(亞麻玄米)｜官方營養標示
    source_url: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M001253
...
此文件保存試算表記錄 NUT-00940 的營養觀測。[^sheet-source-2a23b4593959] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-2a23b4593959]: 凱薩嫩雞三明治(亞麻玄米)｜官方營養標示
