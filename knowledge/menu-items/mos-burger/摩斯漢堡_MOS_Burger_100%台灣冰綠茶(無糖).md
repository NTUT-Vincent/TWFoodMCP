---
type: Food Product
title: 摩斯漢堡 MOS Burger 100%台灣冰綠茶(無糖)
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/Detail.aspx?id=M000398
tags:
  - 摩斯漢堡 MOS Burger
  - 茶飲
  - TWFood 共筆
...
sources:
  - id: sheet-source-038acba303c2
    resource: https://www.mos.com.tw/menu/Detail.aspx?id=M000398
    title: 100%台灣冰綠茶(無糖)｜官方營養標示
    source_class: primary_official
    retrieved_at: 2026-08-07T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:mos-burger:mos_burger_100台灣冰綠茶無糖
  kind: menu_item
  market: TW
  ...
  aliases:
    - 100%台灣冰綠茶(無糖)
    - 摩斯漢堡 MOS Burger100%台灣冰綠茶(無糖)
    - 摩斯漢堡 MOS Burger 100%台灣冰綠茶(無糖)
revision:
  revision_id: google-sheet-2026-08-22-nut-00909
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 100%台灣冰綠茶(無糖)｜官方營養標示
    source_url: https://www.mos.com.tw/menu/Detail.aspx?id=M000398
...
此文件保存試算表記錄 NUT-00909 的營養觀測。[^sheet-source-038acba303c2] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-038acba303c2]: 100%台灣冰綠茶(無糖)｜官方營養標示
