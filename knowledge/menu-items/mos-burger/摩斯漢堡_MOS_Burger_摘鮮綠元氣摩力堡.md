---
type: Food Product
title: 摩斯漢堡 MOS Burger 摘鮮綠元氣摩力堡
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/set_detail.aspx?id=M000985
tags:
  - 摩斯漢堡 MOS Burger
  - 漢堡
  - TWFood 共筆
...
sources:
  - id: sheet-source-0648c7b0c44e
    resource: https://www.mos.com.tw/menu/set_detail.aspx?id=M000985
    title: 摘鮮綠元氣摩力堡｜官方營養標示
    source_class: primary_official
    retrieved_at: 2026-08-07T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:mos-burger:mos_burger_摘鮮綠元氣摩力堡
  kind: menu_item
  market: TW
  ...
  aliases:
    - 摘鮮綠元氣摩力堡
    - 摩斯漢堡 MOS Burger摘鮮綠元氣摩力堡
    - 摩斯漢堡 MOS Burger 摘鮮綠元氣摩力堡
revision:
  revision_id: google-sheet-2026-08-22-nut-00905
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 摘鮮綠元氣摩力堡｜官方營養標示
    source_url: https://www.mos.com.tw/menu/set_detail.aspx?id=M000985
...
此文件保存試算表記錄 NUT-00905 的營養觀測。[^sheet-source-0648c7b0c44e] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-0648c7b0c44e]: 摘鮮綠元氣摩力堡｜官方營養標示
