---
type: Food Product
title: 摩斯漢堡 MOS Burger 摩斯經典奶茶(冰)(L)
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/Detail.aspx?id=M000924
tags:
  - 摩斯漢堡 MOS Burger
  - 奶茶
  - TWFood 共筆
...
sources:
  - id: sheet-source-5370d33a7603
    resource: https://www.mos.com.tw/menu/Detail.aspx?id=M000924
    title: 摩斯經典奶茶(冰)(L)｜官方營養標示
    source_class: primary_official
    retrieved_at: 2026-08-07T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:mos-burger:mos_burger_摩斯經典奶茶冰l
  kind: menu_item
  market: TW
  ...
  aliases:
    - 摩斯經典奶茶(冰)(L)
    - 摩斯漢堡 MOS Burger摩斯經典奶茶(冰)(L)
    - 摩斯漢堡 MOS Burger 摩斯經典奶茶(冰)(L)
revision:
  revision_id: google-sheet-2026-08-22-nut-00912
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 摩斯經典奶茶(冰)(L)｜官方營養標示
    source_url: https://www.mos.com.tw/menu/Detail.aspx?id=M000924
...
此文件保存試算表記錄 NUT-00912 的營養觀測。[^sheet-source-5370d33a7603] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-5370d33a7603]: 摩斯經典奶茶(冰)(L)｜官方營養標示
