---
type: Food Product
title: 摩斯漢堡 MOS Burger 牛蒡培根珍珠堡
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/set_detail.aspx?id=M001211
tags:
  - 摩斯漢堡 MOS Burger
  - 米漢堡
  - TWFood 共筆
...
sources:
  - id: sheet-source-12992cd8ea23
    resource: https://www.mos.com.tw/menu/set_detail.aspx?id=M001211
    title: 牛蒡培根珍珠堡｜官方營養標示
    source_class: primary_official
    retrieved_at: 2026-08-07T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:mos-burger:mos_burger_牛蒡培根珍珠堡
  kind: menu_item
  market: TW
  ...
  aliases:
    - 牛蒡培根珍珠堡
    - 摩斯漢堡 MOS Burger牛蒡培根珍珠堡
    - 摩斯漢堡 MOS Burger 牛蒡培根珍珠堡
revision:
  revision_id: google-sheet-2026-08-22-nut-00939
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 牛蒡培根珍珠堡｜官方營養標示
    source_url: https://www.mos.com.tw/menu/set_detail.aspx?id=M001211
...
此文件保存試算表記錄 NUT-00939 的營養觀測。[^sheet-source-12992cd8ea23] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-12992cd8ea23]: 牛蒡培根珍珠堡｜官方營養標示
