---
type: Food Product
title: 摩斯漢堡 MOS Burger 總匯沙拉(雞肉)
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/Detail.aspx?id=M001244
tags:
  - 摩斯漢堡 MOS Burger
  - 沙拉
  - TWFood 共筆
...
sources:
  - id: sheet-source-edc99c3a0760
    resource: https://www.mos.com.tw/menu/Detail.aspx?id=M001244
    title: 總匯沙拉(雞肉)｜官方營養標示
    source_class: primary_official
    retrieved_at: 2026-08-07T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:mos-burger:mos_burger_總匯沙拉雞肉
  kind: menu_item
  market: TW
  ...
  aliases:
    - 總匯沙拉(雞肉)
    - 摩斯漢堡 MOS Burger總匯沙拉(雞肉)
    - 摩斯漢堡 MOS Burger 總匯沙拉(雞肉)
revision:
  revision_id: google-sheet-2026-08-22-nut-00920
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 總匯沙拉(雞肉)｜官方營養標示
    source_url: https://www.mos.com.tw/menu/Detail.aspx?id=M001244
...
此文件保存試算表記錄 NUT-00920 的營養觀測。[^sheet-source-edc99c3a0760] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-edc99c3a0760]: 總匯沙拉(雞肉)｜官方營養標示
