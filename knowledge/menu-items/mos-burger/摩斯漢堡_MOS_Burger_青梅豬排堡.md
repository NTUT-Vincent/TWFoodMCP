---
type: Food Product
title: 摩斯漢堡 MOS Burger 青梅豬排堡
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M001203
tags:
  - 摩斯漢堡 MOS Burger
  - 早餐漢堡
  - TWFood 共筆
...
food:
  id: food:tw:menu:mos-burger:mos_burger_青梅豬排堡
  kind: menu_item
  market: TW
  ...
  aliases:
    - 青梅豬排堡
    - 摩斯漢堡 MOS Burger青梅豬排堡
    - 摩斯漢堡 MOS Burger 青梅豬排堡
revision:
  revision_id: google-sheet-2026-08-22-nut-00924
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 青梅豬排堡｜官方營養標示
    source_url: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M001203
...
此文件保存試算表記錄 NUT-00924 的營養觀測。[^sheet-source-ad006fa4de1a] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-ad006fa4de1a]: 青梅豬排堡｜官方營養標示
