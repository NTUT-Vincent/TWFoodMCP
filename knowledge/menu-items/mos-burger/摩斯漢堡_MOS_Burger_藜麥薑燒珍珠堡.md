...
food:
  id: food:tw:menu:mos-burger:mos_burger_藜麥薑燒珍珠堡
  kind: menu_item
  market: TW
  ...
  aliases:
    - 藜麥薑燒珍珠堡
    - 摩斯漢堡 MOS Burger藜麥薑燒珍珠堡
    - 摩斯漢堡 MOS Burger 藜麥薑燒珍珠堡
revision:
  revision_id: google-sheet-2026-08-22-nut-00414
serving:
  description: 1個
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00414 的營養觀測。[^sheet-source-874192fb5eb8] 它是未驗證 draft，不能直接用於營養計算。
