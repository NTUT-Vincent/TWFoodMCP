---
type: Food Product
title: 摩斯漢堡 MOS Burger 摩斯熱紅茶
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/Detail.aspx?id=M000400
tags:
  - 摩斯漢堡 MOS Burger
  - 茶飲
  - TWFood 共筆
...
food:
  id: food:tw:menu:mos-burger:mos_burger_摩斯熱紅茶
  kind: menu_item
  market: TW
  ...
  aliases:
    - 摩斯熱紅茶
    - 摩斯漢堡 MOS Burger摩斯熱紅茶
    - 摩斯漢堡 MOS Burger 摩斯熱紅茶
revision:
  revision_id: google-sheet-2026-08-22-nut-00910
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 摩斯熱紅茶｜官方營養標示
    source_url: https://www.mos.com.tw/menu/Detail.aspx?id=M000400
...
此文件保存試算表記錄 NUT-00910 的營養觀測。[^sheet-source-97acc5acae0c] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-97acc5acae0c]: 摩斯熱紅茶｜官方營養標示
