---
type: Food Product
title: 摩斯漢堡 MOS Burger 雞肉三明治
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M000045
tags:
  - 摩斯漢堡 MOS Burger
  - 早餐三明治
  - TWFood 共筆
...
food:
  id: food:tw:menu:mos-burger:mos_burger_雞肉三明治
  kind: menu_item
  market: TW
  ...
  aliases:
    - 雞肉三明治
    - 摩斯漢堡 MOS Burger雞肉三明治
    - 摩斯漢堡 MOS Burger 雞肉三明治
revision:
  revision_id: google-sheet-2026-08-22-nut-00933
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 雞肉三明治｜官方營養標示
    source_url: https://www.mos.com.tw/menu/breakfast_detail.aspx?id=M000045
...
此文件保存試算表記錄 NUT-00933 的營養觀測。[^sheet-source-2c1d9d0f60f3] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-2c1d9d0f60f3]: 雞肉三明治｜官方營養標示
