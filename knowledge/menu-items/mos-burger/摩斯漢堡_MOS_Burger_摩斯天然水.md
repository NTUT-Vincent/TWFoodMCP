---
type: Food Product
title: 摩斯漢堡 MOS Burger 摩斯天然水
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.mos.com.tw/menu/Detail.aspx?id=M000096
tags:
  - 摩斯漢堡 MOS Burger
  - 水
  - TWFood 共筆
...
food:
  id: food:tw:menu:mos-burger:mos_burger_摩斯天然水
  kind: menu_item
  market: TW
  ...
  aliases:
    - 摩斯天然水
    - 摩斯漢堡 MOS Burger摩斯天然水
    - 摩斯漢堡 MOS Burger 摩斯天然水
revision:
  revision_id: google-sheet-2026-08-22-nut-00911
serving:
  description: 單份
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 摩斯漢堡 MOS Burger
    source_author: null
    source_title: 摩斯天然水｜官方營養標示
    source_url: https://www.mos.com.tw/menu/Detail.aspx?id=M000096
...
此文件保存試算表記錄 NUT-00911 的營養觀測。[^sheet-source-5ca0babaec59] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-5ca0babaec59]: 摩斯天然水｜官方營養標示
