...
food:
  id: food:tw:menu:21st-century-flavor-factory:原味小棒腿2入
  kind: menu_item
  market: TW
  brand: 21世紀風味館
  name: 原味小棒腿2入
  aliases:
    ...
    - 21世紀風味館 原味小棒腿2入
revision:
  revision_id: google-sheet-2026-08-22-nut-00010
serving:
  description: 2入
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00010 的營養觀測。[^sheet-source-fa57eb33e18e] 它是未驗證 draft，不能直接用於營養計算。
