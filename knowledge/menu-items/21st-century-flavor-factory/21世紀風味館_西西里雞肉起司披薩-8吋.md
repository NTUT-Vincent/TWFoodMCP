...
food:
  id: food:tw:menu:21st-century-flavor-factory:西西里雞肉起司披薩-8吋
  kind: menu_item
  market: TW
  brand: 21世紀風味館
  name: 西西里雞肉起司披薩-8吋
  aliases:
    - 西西里雞肉起司披薩-8吋
    - 21世紀風味館西西里雞肉起司披薩-8吋
    - 21世紀風味館 西西里雞肉起司披薩-8吋
revision:
  revision_id: google-sheet-2026-08-22-nut-00008
serving:
  description: 1個（8吋）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00008 的營養觀測。[^sheet-source-fa57eb33e18e] 它是未驗證 draft，不能直接用於營養計算。
