...
food:
  id: food:tw:menu:21st-century-flavor-factory:香脆炸雞棒
  kind: menu_item
  market: TW
  brand: 21世紀風味館
  name: 香脆炸雞(棒)
  aliases:
    ...
    - 21世紀風味館 香脆炸雞(棒)
revision:
  revision_id: google-sheet-2026-08-22-nut-00009
serving:
...
此文件保存試算表記錄 NUT-00009 的營養觀測。[^sheet-source-fa57eb33e18e] 它是未驗證 draft，不能直接用於營養計算。
