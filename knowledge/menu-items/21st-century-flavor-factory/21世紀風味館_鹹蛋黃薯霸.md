...
food:
  id: food:tw:menu:21st-century-flavor-factory:鹹蛋黃薯霸
  kind: menu_item
  market: TW
  brand: 21世紀風味館
  name: 鹹蛋黃薯霸
  aliases:
    ...
    - 21世紀風味館 鹹蛋黃薯霸
revision:
  revision_id: google-sheet-2026-08-22-nut-00024
serving:
...
此文件保存試算表記錄 NUT-00024 的營養觀測。[^sheet-source-fa57eb33e18e] 它是未驗證 draft，不能直接用於營養計算。
