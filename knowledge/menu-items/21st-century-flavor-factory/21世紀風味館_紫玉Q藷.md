...
food:
  id: food:tw:menu:21st-century-flavor-factory:紫玉q藷
  kind: menu_item
  market: TW
  brand: 21世紀風味館
  name: 紫玉Q藷
  aliases:
    ...
    - 21世紀風味館 紫玉Q藷
revision:
  revision_id: google-sheet-2026-08-22-nut-00018
serving:
...
此文件保存試算表記錄 NUT-00018 的營養觀測。[^sheet-source-fa57eb33e18e] 它是未驗證 draft，不能直接用於營養計算。
