---
type: Food Product
title: 全家 FamilyMart 自然零藍莓優酪
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2620079
tags:
  - 全家 FamilyMart
  - 優酪乳
  - TWFood 共筆
...
sources:
  - id: sheet-source-91e64930f230
    resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2620079
    title: 自然零藍莓優酪－全家食在購安心
    source_class: primary_official
    retrieved_at: 2026-08-09T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:familymart:familymart_自然零藍莓優酪
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 自然零藍莓優酪
  aliases:
    - 自然零藍莓優酪
    - 全家 FamilyMart自然零藍莓優酪
    - 全家 FamilyMart 自然零藍莓優酪
revision:
  revision_id: google-sheet-2026-08-22-nut-01034
serving:
  description: 180公克（本包裝含1份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 自然零藍莓優酪－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/2620079
...
此文件保存試算表記錄 NUT-01034 的營養觀測。[^sheet-source-91e64930f230] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-91e64930f230]: 自然零藍莓優酪－全家食在購安心
