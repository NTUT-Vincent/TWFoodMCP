---
type: Food Product
title: 全家 FamilyMart 紫拿鐵綜合果蔬汁
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2920582
tags:
  - 全家 FamilyMart
  - 果蔬汁
  - TWFood 共筆
...
sources:
  - id: sheet-source-74d42cac0261
    resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2920582
    title: 紫拿鐵綜合果蔬汁－全家食在購安心
    source_class: primary_official
    retrieved_at: 2026-08-06T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:familymart:familymart_紫拿鐵綜合果蔬汁
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 紫拿鐵綜合果蔬汁
  aliases:
    - 紫拿鐵綜合果蔬汁
    - 全家 FamilyMart紫拿鐵綜合果蔬汁
    - 全家 FamilyMart 紫拿鐵綜合果蔬汁
revision:
  revision_id: google-sheet-2026-08-22-nut-00590
serving:
  description: 每份265毫升（本包裝含1份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 紫拿鐵綜合果蔬汁－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/2920582
...
此文件保存試算表記錄 NUT-00590 的營養觀測。[^sheet-source-74d42cac0261] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-74d42cac0261]: 紫拿鐵綜合果蔬汁－全家食在購安心
