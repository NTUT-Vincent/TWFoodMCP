---
type: Food Product
title: 全家 FamilyMart 芭樂檸檬青茶
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2910149
tags:
  - 全家 FamilyMart
  - 茶飲
  - TWFood 共筆
...
sources:
  - id: sheet-source-4465e6edebc6
    resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2910149
    title: 芭樂檸檬青茶－全家食在購安心
    source_class: primary_official
    retrieved_at: 2026-08-10T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:familymart:familymart_芭樂檸檬青茶
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 芭樂檸檬青茶
  aliases:
    - 芭樂檸檬青茶
    - 全家 FamilyMart芭樂檸檬青茶
    - 全家 FamilyMart 芭樂檸檬青茶
revision:
  revision_id: google-sheet-2026-08-22-nut-01055
serving:
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 芭樂檸檬青茶－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/2910149
...
此文件保存試算表記錄 NUT-01055 的營養觀測。[^sheet-source-4465e6edebc6] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-4465e6edebc6]: 芭樂檸檬青茶－全家食在購安心
