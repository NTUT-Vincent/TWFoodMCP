---
type: Food Product
title: 全家 FamilyMart 大鮮筍包
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/0395903
tags:
  - 全家 FamilyMart
  - 包子
  - TWFood 共筆
...
food:
  id: food:tw:menu:familymart:familymart_大鮮筍包
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 大鮮筍包
  aliases:
    ...
    - 全家 FamilyMart 大鮮筍包
revision:
  revision_id: google-sheet-2026-08-22-nut-00210
serving:
  description: 每份120公克（本包裝1份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 大鮮筍包－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/0395903
...
此文件保存試算表記錄 NUT-00210 的營養觀測。[^sheet-source-bd5b5332c50c] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-bd5b5332c50c]: 大鮮筍包－全家食在購安心
