---
type: Food Product
title: 全家 FamilyMart 韓式泡菜豆腐握沙拉
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://www.threads.com/@ningning_dietitian/post/DPfSGcfAdQV
tags:
  - 全家 FamilyMart
  - 握沙拉／輕食
  - TWFood 共筆
...
sources:
  - id: sheet-source-2130a0a8a1dc
    resource: https://www.threads.com/@ningning_dietitian/post/DPfSGcfAdQV
    title: 全家韓式泡菜豆腐握沙拉營養標示抽查
    source_class: community_submission
    last_modified: 2025-10-06T00:00:00+08:00
    retrieved_at: 2026-08-19T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:familymart:familymart_韓式泡菜豆腐握沙拉
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 韓式泡菜豆腐握沙拉
  aliases:
    - 韓式泡菜豆腐握沙拉
    - 全家 FamilyMart韓式泡菜豆腐握沙拉
    - 全家 FamilyMart 韓式泡菜豆腐握沙拉
revision:
  revision_id: google-sheet-2026-08-22-nut-01187
serving:
  description: 1份（完整包裝）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: Threads
    source_author: 寧寧營養師
    source_title: 全家韓式泡菜豆腐握沙拉營養標示抽查
    source_url: https://www.threads.com/@ningning_dietitian/post/DPfSGcfAdQV
    article_updated_at: 45936
    accessed_at: 46253
...
此文件保存試算表記錄 NUT-01187 的營養觀測。[^sheet-source-2130a0a8a1dc] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-2130a0a8a1dc]: 全家韓式泡菜豆腐握沙拉營養標示抽查
