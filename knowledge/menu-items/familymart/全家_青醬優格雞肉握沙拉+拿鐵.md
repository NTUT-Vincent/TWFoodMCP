...
food:
  id: food:tw:menu:familymart:青醬優格雞肉握沙拉拿鐵
  kind: menu_item
  market: TW
  brand: 全家
  name: 青醬優格雞肉握沙拉＋拿鐵
  aliases:
    ...
    - 全家 青醬優格雞肉握沙拉＋拿鐵
revision:
  revision_id: google-sheet-2026-08-22-nut-00342
serving:
...
此文件保存試算表記錄 NUT-00342 的營養觀測。[^sheet-source-5ec1a1247e42] 它是未驗證 draft，不能直接用於營養計算。
