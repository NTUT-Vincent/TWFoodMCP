...
food:
  id: food:tw:menu:familymart:familymart_益活雞胸補力餐盒
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 益活雞胸補力餐盒
  aliases:
    - 益活雞胸補力餐盒
    - 全家 FamilyMart益活雞胸補力餐盒
    - 全家 FamilyMart 益活雞胸補力餐盒
revision:
  revision_id: google-sheet-2026-08-22-nut-01206
serving:
  description: 1份（完整商品）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    ...
    usage_note: 品牌官方新品頁明示整份商品蛋白質達35g；未提供熱量與其他營養素，保持空白，B級待驗證。
source_observation:
  price_twd: 119
  usage_note: 品牌官方新品頁明示整份商品蛋白質達35g；未提供熱量與其他營養素，保持空白，B級待驗證。
...
此文件保存試算表記錄 NUT-01206 的營養觀測。[^sheet-source-ef98466ee646] 它是未驗證 draft，不能直接用於營養計算。
