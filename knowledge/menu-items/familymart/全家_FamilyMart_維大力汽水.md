---
type: Food Product
title: 全家 FamilyMart 維大力汽水
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/3320747
tags:
  - 全家 FamilyMart
  - 飲品
  - TWFood 共筆
...
food:
  id: food:tw:menu:familymart:familymart_維大力汽水
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 維大力汽水
  aliases:
    ...
    - 全家 FamilyMart 維大力汽水
revision:
  revision_id: google-sheet-2026-08-22-nut-00597
serving:
  description: 每份330毫升（本包裝含1份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 維大力汽水－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/3320747
...
此文件保存試算表記錄 NUT-00597 的營養觀測。[^sheet-source-0d6e7a7a7bb4] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-0d6e7a7a7bb4]: 維大力汽水－全家食在購安心
