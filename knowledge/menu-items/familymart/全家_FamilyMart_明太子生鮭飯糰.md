...
food:
  id: food:tw:menu:familymart:familymart_明太子生鮭飯糰
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 明太子生鮭飯糰
  aliases:
    - 明太子生鮭飯糰
    - 全家 FamilyMart明太子生鮭飯糰
    - 全家 FamilyMart 明太子生鮭飯糰
revision:
  revision_id: google-sheet-2026-08-22-nut-00857
serving:
  description: 1個（官方頁）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00857 的營養觀測。[^sheet-source-ef98466ee646] 它是未驗證 draft，不能直接用於營養計算。
