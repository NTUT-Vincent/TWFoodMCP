---
type: Food Product
title: 全家 FamilyMart 農搾檸檬飲
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2920273
tags:
  - 全家 FamilyMart
  - 果汁飲品
  - TWFood 共筆
...
food:
  id: food:tw:menu:familymart:familymart_農搾檸檬飲
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 農搾檸檬飲
  aliases:
    ...
    - 全家 FamilyMart 農搾檸檬飲
revision:
  revision_id: google-sheet-2026-08-22-nut-01091
serving:
  description: 375毫升（本包裝含1份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 農搾檸檬飲－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/2920273
...
此文件保存試算表記錄 NUT-01091 的營養觀測。[^sheet-source-77e2f3ab3061] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-77e2f3ab3061]: 農搾檸檬飲－全家食在購安心
