...
food:
  id: food:tw:menu:familymart:familymart_福記-雞蓉玉米粥
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 福記-雞蓉玉米粥
  aliases:
    - 福記-雞蓉玉米粥
    - 全家 FamilyMart福記-雞蓉玉米粥
    - 全家 FamilyMart 福記-雞蓉玉米粥
revision:
  revision_id: google-sheet-2026-08-22-nut-00861
serving:
  description: 1個（官方頁）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00861 的營養觀測。[^sheet-source-ef98466ee646] 它是未驗證 draft，不能直接用於營養計算。
