...
food:
  id: food:tw:menu:familymart:豬肉起司蛋堡自然零無加糖優酪
  kind: menu_item
  market: TW
  brand: 全家
  name: 豬肉起司蛋堡＋自然零無加糖優酪
  aliases:
    - 豬肉起司蛋堡＋自然零無加糖優酪
    - 全家豬肉起司蛋堡＋自然零無加糖優酪
    - 全家 豬肉起司蛋堡＋自然零無加糖優酪
revision:
  revision_id: google-sheet-2026-08-22-nut-00322
serving:
...
此文件保存試算表記錄 NUT-00322 的營養觀測。[^sheet-source-4e6824f638cd] 它是未驗證 draft，不能直接用於營養計算。
