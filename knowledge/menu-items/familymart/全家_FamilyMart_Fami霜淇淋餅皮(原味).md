---
type: Food Product
title: 全家 FamilyMart Fami霜淇淋餅皮（原味）
...
food:
  id: food:tw:menu:familymart:familymart_fami霜淇淋餅皮原味
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: Fami霜淇淋餅皮（原味）
  aliases:
    - Fami霜淇淋餅皮（原味）
    - 全家 FamilyMartFami霜淇淋餅皮（原味）
    - 全家 FamilyMart Fami霜淇淋餅皮（原味）
revision:
  revision_id: google-sheet-2026-08-22-nut-00207
serving:
  description: 每份15公克
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00207 的營養觀測。[^sheet-source-3990d80eff40] 它是未驗證 draft，不能直接用於營養計算。
