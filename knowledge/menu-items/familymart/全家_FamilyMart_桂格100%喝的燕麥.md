---
type: Food Product
title: 全家 FamilyMart 桂格100%喝的燕麥
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2820916
tags:
  - 全家 FamilyMart
  - 燕麥飲
  - TWFood 共筆
...
sources:
  - id: sheet-source-888e0f98aedd
    resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2820916
    title: 桂格100%喝的燕麥－全家食在購安心
    source_class: primary_official
    retrieved_at: 2026-08-06T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:familymart:familymart_桂格100喝的燕麥
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 桂格100%喝的燕麥
  aliases:
    - 桂格100%喝的燕麥
    - 全家 FamilyMart桂格100%喝的燕麥
    - 全家 FamilyMart 桂格100%喝的燕麥
revision:
  revision_id: google-sheet-2026-08-22-nut-00604
serving:
  description: 每份290毫升（本包裝含1份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    record_id: NUT-00604
    food_name: 桂格100%喝的燕麥
    brand_or_context: 全家 FamilyMart
    category: 燕麥飲
    serving_basis: 每份290毫升（本包裝含1份）
    calories_kcal: 126.5
    protein_g: 3.8
    fat_g: 2.9
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 桂格100%喝的燕麥－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/2820916
...
此文件保存試算表記錄 NUT-00604 的營養觀測。[^sheet-source-888e0f98aedd] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-888e0f98aedd]: 桂格100%喝的燕麥－全家食在購安心
