---
type: Food Product
title: 全家 FamilyMart 林鳳營低脂鮮乳338ml
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2750014
tags:
  - 全家 FamilyMart
  - 鮮乳
  - TWFood 共筆
...
sources:
  - id: sheet-source-effe8a25d02b
    resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2750014
    title: 林鳳營低脂鮮乳338ml－全家食在購安心
    source_class: primary_official
    retrieved_at: 2026-08-06T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:familymart:familymart_林鳳營低脂鮮乳338ml
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 林鳳營低脂鮮乳338ml
  aliases:
    - 林鳳營低脂鮮乳338ml
    - 全家 FamilyMart林鳳營低脂鮮乳338ml
    - 全家 FamilyMart 林鳳營低脂鮮乳338ml
revision:
  revision_id: google-sheet-2026-08-22-nut-00600
serving:
  description: 每份240毫升（本包裝含1.4份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    record_id: NUT-00600
    food_name: 林鳳營低脂鮮乳338ml
    brand_or_context: 全家 FamilyMart
    category: 鮮乳
    serving_basis: 每份240毫升（本包裝含1.4份）
    calories_kcal: 107
    protein_g: 7.7
    fat_g: 3.4
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 林鳳營低脂鮮乳338ml－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/2750014
    article_updated_at: null
    accessed_at: 46240
    primary_source_url: null
    usage_note: 全家官方食安頁之每份營養數值；頁面提醒相關標示以實際商品包裝為準。未於搜尋摘要明列的營養素保持空白，未進行推算。
source_observation:
  usage_note: 全家官方食安頁之每份營養數值；頁面提醒相關標示以實際商品包裝為準。未於搜尋摘要明列的營養素保持空白，未進行推算。
...
此文件保存試算表記錄 NUT-00600 的營養觀測。[^sheet-source-effe8a25d02b] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-effe8a25d02b]: 林鳳營低脂鮮乳338ml－全家食在購安心
