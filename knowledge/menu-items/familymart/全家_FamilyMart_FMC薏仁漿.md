---
type: Food Product
title: 全家 FamilyMart FMC薏仁漿
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2946005
tags:
  - 全家 FamilyMart
  - 穀物飲
  - TWFood 共筆
...
sources:
  - id: sheet-source-8dbc9cbcb23c
    resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/2946005
    title: FMC薏仁漿－全家食在購安心
    source_class: primary_official
    retrieved_at: 2026-08-12T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:familymart:familymart_fmc薏仁漿
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: FMC薏仁漿
  aliases:
    - FMC薏仁漿
    - 全家 FamilyMartFMC薏仁漿
    - 全家 FamilyMart FMC薏仁漿
revision:
  revision_id: google-sheet-2026-08-22-nut-01093
serving:
  description: 320毫升（本包裝含1份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: FMC薏仁漿－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/2946005
...
此文件保存試算表記錄 NUT-01093 的營養觀測。[^sheet-source-8dbc9cbcb23c] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-8dbc9cbcb23c]: FMC薏仁漿－全家食在購安心
