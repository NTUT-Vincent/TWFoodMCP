---
type: Food Product
title: 全家 FamilyMart 里肌豬排可可咖哩歐姆蛋飯
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/0925720
tags:
  - 全家 FamilyMart
  - 咖哩飯
  - TWFood 共筆
...
sources:
  - id: sheet-source-e86390653a17
    resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/0925720
    title: 里肌豬排可可咖哩歐姆蛋飯－全家食在購安心
    source_class: primary_official
    retrieved_at: 2026-08-10T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:familymart:familymart_里肌豬排可可咖哩歐姆蛋飯
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 里肌豬排可可咖哩歐姆蛋飯
  aliases:
    - 里肌豬排可可咖哩歐姆蛋飯
    - 全家 FamilyMart里肌豬排可可咖哩歐姆蛋飯
    - 全家 FamilyMart 里肌豬排可可咖哩歐姆蛋飯
revision:
  revision_id: google-sheet-2026-08-22-nut-01057
serving:
  description: 474公克（本包裝含1份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    record_id: NUT-01057
    food_name: 里肌豬排可可咖哩歐姆蛋飯
    brand_or_context: 全家 FamilyMart
    category: 咖哩飯
    serving_basis: 474公克（本包裝含1份）
    calories_kcal: 735
    protein_g: 24.2
    fat_g: 25.1
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 里肌豬排可可咖哩歐姆蛋飯－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/0925720
...
此文件保存試算表記錄 NUT-01057 的營養觀測。[^sheet-source-e86390653a17] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-e86390653a17]: 里肌豬排可可咖哩歐姆蛋飯－全家食在購安心
