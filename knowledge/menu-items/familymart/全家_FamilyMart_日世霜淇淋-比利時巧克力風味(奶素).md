---
type: Food Product
title: 全家 FamilyMart 日世霜淇淋－比利時巧克力風味（奶素）
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://nevent.family.com.tw/ice_cream/products.html
tags:
  - 全家 FamilyMart
  - 霜淇淋
  - TWFood 共筆
...
sources:
  - id: sheet-source-3990d80eff40
    resource: https://nevent.family.com.tw/ice_cream/products.html
    title: 全家 Fami!ce 霜淇淋商品介紹與營養標示
    source_class: primary_official
    retrieved_at: 2026-08-05T00:00:00+08:00
access:
  classification: public
food:
  id: food:tw:menu:familymart:familymart_日世霜淇淋-比利時巧克力風味奶素
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 日世霜淇淋－比利時巧克力風味（奶素）
  aliases:
    - 日世霜淇淋－比利時巧克力風味（奶素）
    - 全家 FamilyMart日世霜淇淋－比利時巧克力風味（奶素）
    - 全家 FamilyMart 日世霜淇淋－比利時巧克力風味（奶素）
revision:
  revision_id: google-sheet-2026-08-22-nut-00205
serving:
  description: 每份110公克
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    record_id: NUT-00205
    food_name: 日世霜淇淋－比利時巧克力風味（奶素）
    brand_or_context: 全家 FamilyMart
    category: 霜淇淋
    serving_basis: 每份110公克
    calories_kcal: 156
    protein_g: 4.1
    fat_g: 4.1
    saturated_fat_g: 2.5
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 全家 Fami!ce 霜淇淋商品介紹與營養標示
    source_url: https://nevent.family.com.tw/ice_cream/products.html
    article_updated_at: null
    accessed_at: 46239
    primary_source_url: null
    usage_note: 全家官方營養頁；商品資訊與現行標示仍以實際包裝為準。
source_observation:
  usage_note: 全家官方營養頁；商品資訊與現行標示仍以實際包裝為準。
...
此文件保存試算表記錄 NUT-00205 的營養觀測。[^sheet-source-3990d80eff40] 它是未驗證 draft，不能直接用於營養計算。

# Observation

| 欄位 | 值 |
| --- | --- |
| 食品 | 日世霜淇淋－比利時巧克力風味（奶素） |
| 品牌／情境 | 全家 FamilyMart |
| 分類 | 霜淇淋 |
| 份量基準 | 每份110公克 |
| energy_kcal | 156 |
...
[^sheet-source-3990d80eff40]: 全家 Fami!ce 霜淇淋商品介紹與營養標示
