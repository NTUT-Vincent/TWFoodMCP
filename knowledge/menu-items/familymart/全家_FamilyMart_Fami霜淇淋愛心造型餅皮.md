---
type: Food Product
title: 全家 FamilyMart Fami霜淇淋愛心造型餅皮
...
food:
  id: food:tw:menu:familymart:familymart_fami霜淇淋愛心造型餅皮
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: Fami霜淇淋愛心造型餅皮
  aliases:
    - Fami霜淇淋愛心造型餅皮
    - 全家 FamilyMartFami霜淇淋愛心造型餅皮
    - 全家 FamilyMart Fami霜淇淋愛心造型餅皮
revision:
  revision_id: google-sheet-2026-08-22-nut-00208
serving:
  description: 每份15公克
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    record_id: NUT-00208
    food_name: Fami霜淇淋愛心造型餅皮
    brand_or_context: 全家 FamilyMart
    category: 餅皮
    serving_basis: 每份15公克
    calories_kcal: 55.4
    protein_g: 0.9
    fat_g: 0.6
    saturated_fat_g: 0.4
...
此文件保存試算表記錄 NUT-00208 的營養觀測。[^sheet-source-3990d80eff40] 它是未驗證 draft，不能直接用於營養計算。
