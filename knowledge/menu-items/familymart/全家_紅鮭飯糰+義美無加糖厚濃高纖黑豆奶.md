...
food:
  id: food:tw:menu:familymart:紅鮭飯糰義美無加糖厚濃高纖黑豆奶
  kind: menu_item
  market: TW
  brand: 全家
  name: 紅鮭飯糰＋義美無加糖厚濃高纖黑豆奶
  aliases:
    - 紅鮭飯糰＋義美無加糖厚濃高纖黑豆奶
    - 全家紅鮭飯糰＋義美無加糖厚濃高纖黑豆奶
    - 全家 紅鮭飯糰＋義美無加糖厚濃高纖黑豆奶
revision:
  revision_id: google-sheet-2026-08-22-nut-00320
serving:
...
此文件保存試算表記錄 NUT-00320 的營養觀測。[^sheet-source-4e6824f638cd] 它是未驗證 draft，不能直接用於營養計算。

# Observation

| 欄位 | 值 |
| --- | --- |
| 食品 | 紅鮭飯糰＋義美無加糖厚濃高纖黑豆奶 |
| 品牌／情境 | 全家 |
| 分類 | 營養師早餐組合 |
| 份量基準 | 1組（文章表格完整搭配） |
| energy_kcal | 372 |
