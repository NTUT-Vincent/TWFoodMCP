...
food:
  id: food:tw:menu:familymart:familymart_鮪魚昆布細卷
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 鮪魚昆布細卷
  aliases:
    - 鮪魚昆布細卷
    - 全家 FamilyMart鮪魚昆布細卷
    - 全家 FamilyMart 鮪魚昆布細卷
revision:
  revision_id: google-sheet-2026-08-22-nut-00873
serving:
  description: 1個（官方頁）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00873 的營養觀測。[^sheet-source-ef98466ee646] 它是未驗證 draft，不能直接用於營養計算。
