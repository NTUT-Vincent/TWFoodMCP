...
food:
  id: food:tw:menu:familymart:豬肉起司蛋堡中杯熱拿鐵
  kind: menu_item
  market: TW
  brand: 全家
  name: 豬肉起司蛋堡＋中杯熱拿鐵
  aliases:
    ...
    - 全家 豬肉起司蛋堡＋中杯熱拿鐵
revision:
  revision_id: google-sheet-2026-08-22-nut-00323
serving:
...
此文件保存試算表記錄 NUT-00323 的營養觀測。[^sheet-source-4e6824f638cd] 它是未驗證 draft，不能直接用於營養計算。
