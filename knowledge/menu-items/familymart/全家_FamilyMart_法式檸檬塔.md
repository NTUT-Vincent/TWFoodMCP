---
type: Food Product
title: 全家 FamilyMart 法式檸檬塔
description: 從 TWFood 共筆試算表匯入的可追溯營養觀測 draft。
resource: https://foodsafety.family.com.tw/Web_FFD_2022/product/0415773
tags:
  - 全家 FamilyMart
  - 甜點
  - TWFood 共筆
...
food:
  id: food:tw:menu:familymart:familymart_法式檸檬塔
  kind: menu_item
  market: TW
  brand: 全家 FamilyMart
  name: 法式檸檬塔
  aliases:
    ...
    - 全家 FamilyMart 法式檸檬塔
revision:
  revision_id: google-sheet-2026-08-22-nut-00596
serving:
  description: 每份72公克（本包裝含1份）
  amount: 1
  unit: serving
nutrition:
  - basis: per_serving
...
extraction:
  ...
  source_row:
    ...
    source_publisher: 全家便利商店
    source_author: null
    source_title: 法式檸檬塔－全家食在購安心
    source_url: https://foodsafety.family.com.tw/Web_FFD_2022/product/0415773
...
此文件保存試算表記錄 NUT-00596 的營養觀測。[^sheet-source-22ce23fe09fb] 它是未驗證 draft，不能直接用於營養計算。
...
[^sheet-source-22ce23fe09fb]: 法式檸檬塔－全家食在購安心
