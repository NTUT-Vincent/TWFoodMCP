...
food:
  id: food:tw:menu:familymart:大麥蛋白豬肉堡黑咖啡芭樂
  kind: menu_item
  market: TW
  brand: 全家
  name: 大麥蛋白豬肉堡＋黑咖啡＋芭樂
  aliases:
    ...
    - 全家 大麥蛋白豬肉堡＋黑咖啡＋芭樂
revision:
  revision_id: google-sheet-2026-08-22-nut-00341
serving:
...
此文件保存試算表記錄 NUT-00341 的營養觀測。[^sheet-source-5ec1a1247e42] 它是未驗證 draft，不能直接用於營養計算。
