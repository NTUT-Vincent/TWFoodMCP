...
food:
  id: food:tw:menu:dezheng:焙烏龍茶凍-8999921b3dd4
  kind: menu_item
  market: TW
  brand: 得正
  name: 焙烏龍茶凍
  aliases:
    ...
    - 得正 焙烏龍茶凍
revision:
  revision_id: google-sheet-2026-08-22-nut-00585
serving:
  description: 大杯加料份量
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00585 的營養觀測。[^sheet-source-4c2f05ad720f] 它是未驗證 draft，不能直接用於營養計算。
