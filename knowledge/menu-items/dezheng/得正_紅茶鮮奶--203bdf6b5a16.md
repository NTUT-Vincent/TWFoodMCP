...
food:
  id: food:tw:menu:dezheng:紅茶鮮奶-203bdf6b5a16
  kind: menu_item
  market: TW
  brand: 得正
  name: 紅茶鮮奶
  aliases:
    ...
    - 得正 紅茶鮮奶
revision:
  revision_id: google-sheet-2026-08-22-nut-00553
serving:
  description: 大杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00553 的營養觀測。[^sheet-source-4c2f05ad720f] 它是未驗證 draft，不能直接用於營養計算。
