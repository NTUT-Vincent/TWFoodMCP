...
food:
  id: food:tw:menu:dezheng:酸莓綠烏龍-58af8ed2b39d
  kind: menu_item
  market: TW
  brand: 得正
  name: 酸莓綠烏龍
  aliases:
    ...
    - 得正 酸莓綠烏龍
revision:
  revision_id: google-sheet-2026-08-22-nut-00569
serving:
  description: 大杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00569 的營養觀測。[^sheet-source-4c2f05ad720f] 它是未驗證 draft，不能直接用於營養計算。
