...
food:
  id: food:tw:menu:dezheng:緋烏龍-f8d4a1362fea
  kind: menu_item
  market: TW
  brand: 得正
  name: 緋烏龍
  aliases:
    ...
    - 得正 緋烏龍
revision:
  revision_id: google-sheet-2026-08-22-nut-00567
serving:
  description: 大杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00567 的營養觀測。[^sheet-source-4c2f05ad720f] 它是未驗證 draft，不能直接用於營養計算。
