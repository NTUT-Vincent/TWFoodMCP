...
food:
  id: food:tw:menu:dezheng:輕烏龍鮮奶-75c329c128d5
  kind: menu_item
  market: TW
  brand: 得正
  name: 輕烏龍鮮奶
  aliases:
    ...
    - 得正 輕烏龍鮮奶
revision:
  revision_id: google-sheet-2026-08-22-nut-00554
serving:
  description: 中杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00554 的營養觀測。[^sheet-source-4c2f05ad720f] 它是未驗證 draft，不能直接用於營養計算。
