...
food:
  id: food:tw:menu:dezheng:緋烏龍奶茶-bf66257b5369
  kind: menu_item
  market: TW
  brand: 得正
  name: 緋烏龍奶茶
  aliases:
    ...
    - 得正 緋烏龍奶茶
revision:
  revision_id: google-sheet-2026-08-22-nut-00570
serving:
  description: 中杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00570 的營養觀測。[^sheet-source-4c2f05ad720f] 它是未驗證 draft，不能直接用於營養計算。
