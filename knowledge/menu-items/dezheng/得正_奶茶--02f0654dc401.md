...
food:
  id: food:tw:menu:dezheng:奶茶-02f0654dc401
  kind: menu_item
  market: TW
  brand: 得正
  name: 奶茶
  aliases:
    ...
    - 得正 奶茶
revision:
  revision_id: google-sheet-2026-08-22-nut-00544
serving:
  description: 中杯（全糖）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00544 的營養觀測。[^sheet-source-4c2f05ad720f] 它是未驗證 draft，不能直接用於營養計算。
