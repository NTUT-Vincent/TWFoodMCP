...
food:
  id: food:tw:menu:instant-noodles:滿漢大餐蔥燒牛肉麵
  kind: menu_item
  market: TW
  brand: 台灣熱門泡麵
  name: 滿漢大餐蔥燒牛肉麵
  aliases:
    ...
    - 台灣熱門泡麵 滿漢大餐蔥燒牛肉麵
revision:
  revision_id: google-sheet-2026-08-22-nut-00849
serving:
  description: 1包（187g）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00849 的營養觀測。[^sheet-source-49626023e68c] 它是未驗證 draft，不能直接用於營養計算。
