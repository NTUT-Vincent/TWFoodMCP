...
food:
  id: food:tw:menu:instant-noodles:台酒花雕雞麵
  kind: menu_item
  market: TW
  brand: 台灣熱門泡麵
  name: 台酒花雕雞麵
  aliases:
    ...
    - 台灣熱門泡麵 台酒花雕雞麵
revision:
  revision_id: google-sheet-2026-08-22-nut-00852
serving:
  description: 1碗（200g）
  amount: 1
  unit: serving
...
此文件保存試算表記錄 NUT-00852 的營養觀測。[^sheet-source-49626023e68c] 它是未驗證 draft，不能直接用於營養計算。
