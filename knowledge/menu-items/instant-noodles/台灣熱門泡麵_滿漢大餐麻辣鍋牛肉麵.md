...
food:
  id: food:tw:menu:instant-noodles:滿漢大餐麻辣鍋牛肉麵
  kind: menu_item
  market: TW
  brand: 台灣熱門泡麵
  name: 滿漢大餐麻辣鍋牛肉麵
  aliases:
    ...
    - 台灣熱門泡麵 滿漢大餐麻辣鍋牛肉麵
revision:
  revision_id: google-sheet-2026-08-22-nut-00855
serving:
  description: 1份（200g）
  amount: 1
  unit: serving
...
extraction:
  ...
  source_row:
    record_id: NUT-00855
    food_name: 滿漢大餐麻辣鍋牛肉麵
    brand_or_context: 台灣熱門泡麵
    category: 泡麵
    serving_basis: 1份（200g）
    calories_kcal: 624
    protein_g: 17
    fat_g: 31.8
...
此文件保存試算表記錄 NUT-00855 的營養觀測。[^sheet-source-49626023e68c] 它是未驗證 draft，不能直接用於營養計算。
